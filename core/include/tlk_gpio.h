...
#define TLK_DECLARE_GPIO_PORT_IF_ENABLED(num)                                                      \
    TLK_IF_ENABLED(CONFIG_TLK_GPIO_PORT_##num##_ENABLED, (TLK_DECLARE_GPIO_PORT(num)))

enum tlk_gpio_port
{
    TLK_FOR_CALL(UNISDK_GPIO_PORT_COUNT, TLK_DECLARE_GPIO_PORT_IF_ENABLED)
};
...
#define TLK_DECLARE_GPIO_PULL_UP(number)                                                           \
    _TLK_DECLARE_GPIO_PULL_UP(UNISDK_GPIO_PULL_UP_OPTIONS_##number##_NAME,                         \
                              UNISDK_GPIO_PULL_UP_OPTIONS_##number##_VALUE)
...
#define TLK_DECLARE_GPIO_PULL_DOWN(number)                                                         \
    _TLK_DECLARE_GPIO_PULL_DOWN(UNISDK_GPIO_PULL_DOWN_OPTIONS_##number##_NAME,                     \
                                UNISDK_GPIO_PULL_DOWN_OPTIONS_##number##_VALUE)
...
enum tlk_gpio_mode
{
    ...
    TLK_FOR_CALL(UNISDK_GPIO_PULL_UP_OPTIONS_COUNT, TLK_DECLARE_GPIO_PULL_UP)
        TLK_FOR_CALL(UNISDK_GPIO_PULL_DOWN_OPTIONS_COUNT, TLK_DECLARE_GPIO_PULL_DOWN)
...
#define __DECLARE_GPIO_MUX_FUNCTION(name, reg_value) TLK_GPIO_MUX_##name = reg_value,

#define _DECLARE_GPIO_MUX_FUNCTION(name, reg_value) __DECLARE_GPIO_MUX_FUNCTION(name, reg_value)

#define DECLARE_GPIO_MUX_FUNCTION(num)                                                             \
    _DECLARE_GPIO_MUX_FUNCTION(UNISDK_GPIO_FUNCTION_##num##_NAME,                                  \
                               UNISDK_GPIO_FUNCTION_##num##_REG_VALUE)

enum tlk_gpio_mux
{
    TLK_FOR_CALL(UNISDK_GPIO_FUNCTION_COUNT, DECLARE_GPIO_MUX_FUNCTION)
};
