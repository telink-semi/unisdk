...
enum tlk_power_cap
{
    TLK_POWER_INTERNAL_CAP_XTAL24M = 0, /**<    Use the chip's internal crystal capacitors,
                                 <p>  hardware boards can not have 24M crystal matching capacitors */
    TLK_POWER_EXTERNAL_CAP_XTAL24M = 1, /**<    Use an external crystal capacitor,
...
enum tlk_power_vbat
{
    TLK_POWER_VBAT_MAX_VALUE_GREATER_THAN_3V6 = 0,   /*  VBAT must be greater than 2.2V. VBAT may be greater than 3.6V. */
    TLK_POWER_VBAT_MAX_VALUE_LESS_THAN_3V6    = TLK_BIT(3), /*  VBAT must be below 3.6V. VBAT may be below 2.2V. */
};
