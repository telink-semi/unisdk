...
static void tlk_uart_rx_set_timeout(enum tlk_uart_module uart_num, uint8_t bwpc, uint8_t bit_cnt,
...
void tlk_uart_configure(enum tlk_uart_module uart_num, struct tlk_uart_config* config)
{
    ...
    tlk_uart_rx_set_timeout(uart_num, bwpc, frame_bits, config->rx_timeout_mul);
