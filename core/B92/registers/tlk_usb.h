...
typedef enum tlk_usb_edp0_status_e {
    ...
    TLK_USB_EDP0_STATUS_IRQ_250US_SOF = TLK_BIT(1),
...
typedef enum tlk_usb_control_e {
    TLK_USB_CONTROL_R_CLK_SEL_0 = TLK_BIT(0),
    TLK_USB_CONTROL_LOW_SPEED   = TLK_BIT(1),
    TLK_USB_CONTROL_R_CLK_SEL_2 = TLK_BIT(2),
    TLK_USB_CONTROL_TEST_MODE   = TLK_BIT(3),
} tlk_usb_control_e;
...
typedef enum tlk_usb_endpoint0_sie_e {
    TLK_USB_ENDPOINT0_SIE_R_CONFIG = TLK_BIT(7),
} tlk_usb_endpoint0_sie_e;

typedef enum tlk_usb_suspend_cyc_e {
    TLK_USB_SUSPEND_CYC_R_ENDPOINT0_STALL = TLK_BIT(5),
} tlk_usb_suspend_cyc_e;

typedef enum tlk_usb_irq_mask_e {
    TLK_USB_IRQ_MASK_R_250US_SOF_SEL = TLK_BIT(5),
} tlk_usb_irq_mask_e;
...
typedef enum tlk_usb_edps_ct_e {
    ...
    TLK_USB_EDPS_CT_ENDPOINT_SPECIFIC0 = TLK_BIT(6),
    TLK_USB_EDPS_CT_ENDPOINT_SPECIFIC1 = TLK_BIT(7),
} tlk_usb_edps_ct_e;
...
typedef enum tlk_usb_usb_fifo_e {
    ...
    TLK_USB_USB_FIFO_ENDPOINT8_EOF = TLK_BIT(3),
    TLK_USB_USB_FIFO_R_MODE05      = TLK_BIT(7),
} tlk_usb_usb_fifo_e;
...
typedef enum tlk_usb_usb_min1_e {
    TLK_USB_USB_MIN1_HOLD2 = TLK_BIT(2),
} tlk_usb_usb_min1_e;
...
typedef struct __attribute__((packed)) {
    ...
    union {
        ...
        struct {
            enum tlk_usb_control_e __attribute__((packed)) control : 8;
    ...
    union {
        ...
        struct {
            enum tlk_usb_endpoint0_sie_e __attribute__((packed)) endpoint0_sie : 8;
        }; // address: 0x8010080b, offset: 0xb
    };
    union {
        struct {
    ...
    union {
        ...
        }; // address: 0x80100828, offset: 0x28
    };
    ...
    union {
        ...
        }; // address: 0x80100845, offset: 0x45
    };
    union {
        struct {
            unsigned max_in : 7;
    ...
    union {
        ...
        }; // address: 0x80100848, offset: 0x48
    };
    union {
        struct {
            unsigned blk1 : 2;
        ...
        }; // address: 0x80100849, offset: 0x49
    };
} tlk_usb_reg_t;
