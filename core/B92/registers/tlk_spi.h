...
typedef struct __attribute__((packed)) {
    ...
    uint8_t reserved7[0x3]; // address: 0x87ffff2c, offset: 0x2c
    union {
        struct {
    ...
    uint8_t reserved8[0x2]; // address: 0x87ffff3c, offset: 0x3c
    union {
        struct {
            unsigned cnt : 10;
            unsigned reserved : 6;
    ...
    uint8_t reserved9[0x10]; // address: 0x87ffff80, offset: 0x80
    union {
        struct {
    ...
    uint8_t reserved10; // address: 0x87ffff92, offset: 0x92
    ...
    uint8_t reserved11; // address: 0x87ffff96, offset: 0x96
...
typedef struct __attribute__((packed)) {
    ...
    uint8_t reserved0; // address: 0x8bffff06, offset: 0x6
    union {
        struct {
            unsigned cs2sclk : 3;
            unsigned csht : 5;
    ...
    uint8_t reserved1[0x2]; // address: 0x8bffff0a, offset: 0xa
    ...
    uint8_t reserved2; // address: 0x8bffff1b, offset: 0x1b
    union {
        struct {
            unsigned xip_page_mode_en : 1;
            unsigned xip_timeout_mode_en : 1;
    ...
    uint8_t reserved3[0x3]; // address: 0x8bffff1f, offset: 0x1f
    uint8_t xip_addr_offset; // address: 0x8bffff22, offset: 0x22
    uint8_t reserved4; // address: 0x8bffff23, offset: 0x23
    union {
        struct {
            unsigned txfifo_entries : 7;
            unsigned txfifo_full : 1;
    ...
    uint8_t reserved5[0x2]; // address: 0x8bffff26, offset: 0x26
    union {
        struct {
            unsigned set_slave_ready : 1;
            unsigned clr_slave_ready : 1;
    ...
    uint8_t reserved6; // address: 0x8bffff29, offset: 0x29
    union {
        struct {
            unsigned rxf_overrun_int_stus : 1;
            unsigned txf_underrun_int_stus : 1;
    ...
    uint8_t reserved7[0x65]; // address: 0x8bffff2b, offset: 0x2b
    struct {
        union {
            struct {
                unsigned data_dual : 1;
        ...
        uint8_t reserved8; // address: 0x8bffff92, offset: 0x92
        ...
        uint8_t reserved9; // address: 0x8bffff96, offset: 0x96
