...
typedef struct __attribute__((packed)) {
    ...
    union {
        ...
        }; // address: 0x87ffff1b, offset: 0x1b
    };
    union {
        struct {
...
typedef enum tlk_lspi_xip_read_fmt_e {
    TLK_LSPI_XIP_READ_FMT_ADDR_FMT = TLK_BIT(4),
    TLK_LSPI_XIP_READ_FMT_ADDR_EN  = TLK_BIT(5),
    TLK_LSPI_XIP_READ_FMT_CMD_FMT  = TLK_BIT(6),
    TLK_LSPI_XIP_READ_FMT_CMD_EN   = TLK_BIT(7),
} tlk_lspi_xip_read_fmt_e;

typedef enum tlk_lspi_xip_xip_read_control0_e {
    TLK_LSPI_XIP_XIP_READ_CONTROL0_CMD1_EN         = TLK_BIT(0),
    TLK_LSPI_XIP_XIP_READ_CONTROL0_TOKEN_VAL_SEL   = TLK_BIT(1),
    TLK_LSPI_XIP_XIP_READ_CONTROL0_TOKEN_EN        = TLK_BIT(2),
    TLK_LSPI_XIP_XIP_READ_CONTROL0_DUMMY_CNT_ADD   = TLK_BIT(3),
    TLK_LSPI_XIP_XIP_READ_CONTROL0_DDR_MODE        = TLK_BIT(4),
    TLK_LSPI_XIP_XIP_READ_CONTROL0_PAGE_MODE_EN    = TLK_BIT(5),
    TLK_LSPI_XIP_XIP_READ_CONTROL0_TIMEOUT_MODE_EN = TLK_BIT(6),
    TLK_LSPI_XIP_XIP_READ_CONTROL0_TCEM_MODE_EN    = TLK_BIT(7),
} tlk_lspi_xip_xip_read_control0_e;
...
typedef enum tlk_lspi_xip_xip_write_control0_e {
    TLK_LSPI_XIP_XIP_WRITE_CONTROL0_CMD1_EN = TLK_BIT(0),
} tlk_lspi_xip_xip_write_control0_e;
...
typedef struct __attribute__((packed)) {
    ...
    union {
        ...
        struct {
            enum tlk_lspi_xip_read_fmt_e __attribute__((packed)) read_fmt : 8;
    ...
    union {
        ...
        struct {
            enum tlk_lspi_xip_xip_read_control0_e __attribute__((packed)) xip_read_control0 : 8;
        }; // address: 0x87ffff92, offset: 0x92
    };
    ...
    union {
        ...
        struct {
            enum tlk_lspi_xip_xip_write_control0_e __attribute__((packed)) xip_write_control0 : 8;
        }; // address: 0x87ffff96, offset: 0x96
    };
...
typedef enum tlk_gspi_xip_xip_read_control0_e {
    TLK_GSPI_XIP_XIP_READ_CONTROL0_CMD1_EN         = TLK_BIT(0),
    TLK_GSPI_XIP_XIP_READ_CONTROL0_TOKEN_VAL_SEL   = TLK_BIT(1),
    TLK_GSPI_XIP_XIP_READ_CONTROL0_TOKEN_EN        = TLK_BIT(2),
    TLK_GSPI_XIP_XIP_READ_CONTROL0_DUMMY_CNT_ADD   = TLK_BIT(3),
    TLK_GSPI_XIP_XIP_READ_CONTROL0_DDR_MODE        = TLK_BIT(4),
    TLK_GSPI_XIP_XIP_READ_CONTROL0_PAGE_MODE_EN    = TLK_BIT(5),
    TLK_GSPI_XIP_XIP_READ_CONTROL0_TIMEOUT_MODE_EN = TLK_BIT(6),
    TLK_GSPI_XIP_XIP_READ_CONTROL0_TCEM_MODE_EN    = TLK_BIT(7),
} tlk_gspi_xip_xip_read_control0_e;
...
typedef enum tlk_gspi_xip_xip_write_control0_e {
    TLK_GSPI_XIP_XIP_WRITE_CONTROL0_CMD1_EN = TLK_BIT(0),
} tlk_gspi_xip_xip_write_control0_e;
...
typedef struct __attribute__((packed)) {
    ...
    struct {
        ...
        union {
            ...
            struct {
                enum tlk_gspi_xip_xip_read_control0_e __attribute__((packed)) read_control0 : 8;
        ...
        union {
            ...
            struct {
                enum tlk_gspi_xip_xip_write_control0_e __attribute__((packed)) write_control0 : 8;
    ...
    uint8_t reserved1[0x3]; // address: 0x8bffffb1, offset: 0xb1
    struct {
