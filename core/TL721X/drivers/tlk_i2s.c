...
struct tlk_dma_config audio_dma_rx_config[3] = {
    {
        .dst_req_sel    = 0,
...
struct tlk_dma_config audio_dma_tx_config[3] = {
    {
                                ...
                                uint16_t div_denominator)
{
    ...
    case 0:
        ...
        break;
    case 1:
        reg_i2s1_step = (div_numerator & FLD_I2S1_STEP) | FLD_I2S1_CLK_EN_0;
        reg_i2s1_mod  = div_denominator;
        break;
    case 2:
        reg_i2s2_step = (div_numerator & FLD_I2S2_STEP) | FLD_I2S2_CLK_EN_0;
...
static void tlk_i2s_enable_src_clk(struct tlk_i2s_device* dev)
{
    switch (dev->number)
    {
    case 0:
    ...
    case 1:
        ...
        case TLK_I2S_CHANNEL_LEFT:
            reg_mono_rxfifo_sel(dev_num) =
                (reg_mono_rxfifo_sel(dev_num) & (~FLD_I2S01_MONOL_RXFIFO_SEL)) |
                TLK_MASK_VAL(FLD_I2S01_MONOL_RXFIFO_SEL, fifo);
            break;
        case TLK_I2S_CHANNEL_RIGHT:
            reg_mono_rxfifo_sel(dev_num) =
                (reg_mono_rxfifo_sel(dev_num) & (~FLD_I2S01_MONOR_RXFIFO_SEL)) |
                TLK_MASK_VAL(FLD_I2S01_MONOR_RXFIFO_SEL, fifo);
            break;
        default:
            break;
        }
                                     ...
                                     enum tlk_i2s_data_width data_width)
{
    ...
    {
    case TLK_I2S_FIFO0:
        reg_i2s_ain_mode(dev_num) = (reg_i2s_ain_mode(dev_num) & (~FLD_I2S_AIN0_MODE)) |
                                    TLK_MASK_VAL(FLD_I2S_AIN0_MODE, reg_value);
        break;
    case TLK_I2S_FIFO1:
        reg_i2s_ain_mode(dev_num) = (reg_i2s_ain_mode(dev_num) & (~FLD_I2S_AIN1_MODE)) |
                                    TLK_MASK_VAL(FLD_I2S_AIN1_MODE, reg_value);
        break;
    case TLK_I2S_FIFO2:
        reg_i2s_ain_mode(dev_num) = (reg_i2s_ain_mode(dev_num) & (~FLD_I2S_AIN2_MODE)) |
                                    TLK_MASK_VAL(FLD_I2S_AIN2_MODE, reg_value);
        break;
    default:
        break;
    }
