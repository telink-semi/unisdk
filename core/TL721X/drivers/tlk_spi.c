...
/* --- config dependencies --- */
void tlk_lspi_set_pin_mux(struct tlk_gpio_port_pin port_pin, enum tlk_gpio_mux function)
{
...
static inline void tlk_spi_set_slave_irq_trigs(enum tlk_spi_module module)
{
    ...
    tlk_spi_tx_irq_trig_cnt(module, (module == TLK_SPI0) ? 8 : 4);
}
...
enum tlk_spi_status tlk_spi_master_configure(struct tlk_spi_device* dev, struct tlk_spi_config* cfg)
{
    ...
    tlk_spi_tx_irq_trig_cnt(dev->module, dev->module == TLK_SPI0 ? 16 : 4);
