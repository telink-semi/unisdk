...
_tlk_attribute_ram_code_sec_ static void tlk_usb_sof_irq_handle(void)
{
    tlk_usb_irq_clr_status(USB_IRQ_SOF_STATUS);
...
TLK_PLIC_ISR_REGISTER(tlk_usb_sof_irq_handle, UNISDK_PLIC_IRQ_NUM_USB_250US_SOF);
...
void tlk_usb_init(void)
{
    ...
    tlk_power_set_dig_modules_state(TLK_POWER_USB, true);
...
void tlk_usb_enable_manual_interrupt(int m)
{
    ...
    tlk_usb_irq_set_mask(USB_IRQ_RESET_MASK | USB_IRQ_SUSPEND_MASK | USB_IRQ_SETUP_MASK |
...
_tlk_attribute_ram_code_sec_ void tlk_usb_irq_clr_status(enum tlk_usb_irq_status status)
{
