...
tlk_power_dig_modules_set_state(enum tlk_power_dig_module modules, bool enable)
{
...
static _tlk_always_inline void tlk_power_update_internal_cap(unsigned char cap_value)
{
    TLK_ANALOG_MODIFY(TLK_AREG_XO_CTRL1, (value.bit.xo_cdac_ana = cap_value;));
}
