...
{
    tlk_spi_rx_set_irq_trig_cnt(module, 4); // default gspi burst1(N=1) ,rx_fifo trig_cnt=4*N=4.
    tlk_spi_tx_set_irq_trig_cnt(
...
_tlk_attribute_ram_code_sec_ bool tlk_spi_tx_fifo_is_num_word(enum tlk_spi_module module)
{
    return (20 - (tlk_spi_reg(module).txfifo_status_bit.txfifo_entries) < 4);
}

bool tlk_spi_tx_fifo_is_full(enum tlk_spi_module module)
{
...
_tlk_attribute_ram_code_sec_ bool tlk_spi_rx_fifo_is_num_word(enum tlk_spi_module module)
{
    return tlk_spi_reg(module).rxfifo_status_bit.rxfifo_entries < 4;
}

_tlk_attribute_ram_code_sec_ bool tlk_spi_rx_fifo_is_empty(enum tlk_spi_module module)
{
