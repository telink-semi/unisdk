...
static _tlk_always_inline void tlk_gpio_irq_en(enum tlk_gpio_port port, enum tlk_gpio_pin pin,
                                               int32_t irq)
{
...
void tlk_gpio_irq_trigger_configure(enum tlk_gpio_port port, enum tlk_gpio_pin pin,
