 ...
 * @return None.
 */
static void tlk_debug_jtag_enable(void)
{
 ...
 * @return None.
 */
static void tlk_debug_sdp_enable(void)
{
    tlk_gpio_configure(UNISDK_JTAG_TMS_PORT, UNISDK_JTAG_TMS_PIN, TLK_GPIO_INPUT_PULL_UP_10K);
    tlk_gpio_set_mux(UNISDK_JTAG_TMS_PORT, UNISDK_JTAG_TMS_PIN, 0);
    tlk_gpio_disable(UNISDK_JTAG_TMS_PORT, UNISDK_JTAG_TMS_PIN);
...
static void tlk_debug_enable_interface(void)
{
    ...
    {
        // true, 2 wire
        tlk_debug_sdp_enable();
    }
    else
    {
        // false, 4 wire
        tlk_debug_jtag_enable();
    }
    tlk_gpio_disable(TLK_GPIO_PORT_B, TLK_GPIO_PIN_0);
}

TLK_REGISTER_PRE_INIT(tlk_debug_enable_interface, TLK_INIT_LEVEL_DRIVER, TLK_INIT_PRIORITY_NORMAL)
#endif
 ...
 * @return None.
 */
static void tlk_debug_sws_enable(void)
{
    tlk_gpio_configure(UNISDK_SWS_PORT, UNISDK_SWS_PIN, TLK_GPIO_INPUT_NO_PULL);
}

TLK_REGISTER_PRE_INIT(tlk_debug_sws_enable, TLK_INIT_LEVEL_DRIVER, TLK_INIT_PRIORITY_NORMAL)
#endif
