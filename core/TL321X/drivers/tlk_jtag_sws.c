...
#if IS_ENABLED(CONFIG_TLK_DEBUG_JTAG)
...
#if IS_ENABLED(CONFIG_TLK_DEBUG_SWS)
/**
...
TLK_REGISTER_PRE_INIT(tlk_sws_enable, TLK_INIT_LEVEL_DRIVER, TLK_INIT_PRIORITY_NORMAL)
#endif
