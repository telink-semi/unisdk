...
typedef enum tlk_clock_mcu_control0_e {
    TLK_CLOCK_MCU_CONTROL0_MCU_REBOOT = TLK_BIT(7),
} tlk_clock_mcu_control0_e;
...
typedef enum tlk_clock_clock_en1_e {
    ...
    TLK_CLOCK_CLOCK_EN1_SSPI        = TLK_BIT(7),
...
typedef enum tlk_clock_clock_en3_e {
    ...
    TLK_CLOCK_CLOCK_EN3_EFUSE  = TLK_BIT(3),
    TLK_CLOCK_CLOCK_EN3_MSPI   = TLK_BIT(4),
    TLK_CLOCK_CLOCK_EN3_QDEC   = TLK_BIT(5),
    TLK_CLOCK_CLOCK_EN3_SARADC = TLK_BIT(6),
} tlk_clock_clock_en3_e;

typedef enum tlk_clock_dmic_step_l_e {
    TLK_CLOCK_DMIC_STEP_L_CLK_SEL = TLK_BIT(15),
} tlk_clock_dmic_step_l_e;
...
typedef enum tlk_clock_wakeupen_e {
    ...
    TLK_CLOCK_WAKEUPEN_KS_WAKEUP_I   = TLK_BIT(3),
...
typedef enum tlk_clock_clk_div_e {
    TLK_CLOCK_CLK_DIV_ISO7816_CLK_EN = TLK_BIT(7),
} tlk_clock_clk_div_e;

typedef enum tlk_clock_ram_crc_e {
    TLK_CLOCK_RAM_CRC_RAM_CRC_ERR         = TLK_BIT(1),
    TLK_CLOCK_RAM_CRC_RST_ALL_STATUS      = TLK_BIT(4),
    TLK_CLOCK_RAM_CRC_WATCHDOG_RST_STATUS = TLK_BIT(5),
    TLK_CLOCK_RAM_CRC_RST_MCU_STATUS      = TLK_BIT(6),
} tlk_clock_ram_crc_e;

typedef enum tlk_clock_sel_e {
    TLK_CLOCK_SEL_ADC_DIG_CLK_SEL = TLK_BIT(1),
} tlk_clock_sel_e;
...
typedef enum tlk_clock_t_clock_en5_e {
    ...
    TLK_CLOCK_T_CLOCK_EN5_KEYSCAN  = TLK_BIT(5),
...
typedef struct __attribute__((packed)) {
    ...
    uint8_t reserved0; // address: 0x80140801, offset: 0x1
    union {
        struct {
            unsigned gspi_mod : 8;
    ...
    uint8_t reserved1[0x2]; // address: 0x80140804, offset: 0x4
    union {
        struct {
            unsigned low : 8;
            unsigned high : 7;
    ...
    uint8_t reserved2[0x4]; // address: 0x8014080c, offset: 0xc
    union {
        struct {
            unsigned reserved : 6;
    ...
    uint8_t reserved3[0x3]; // address: 0x80140811, offset: 0x11
    union {
        struct {
            unsigned reserved : 7;
            unsigned mcu_reboot : 1;
        } __attribute__((packed)) mcu_control0_bit;
        struct {
            enum tlk_clock_mcu_control0_e __attribute__((packed)) mcu_control0 : 8;
    ...
    uint8_t reserved4; // address: 0x80140819, offset: 0x19
    union {
        struct {
            unsigned value : 5;
            unsigned reserved : 3;
    ...
    uint8_t reserved5[0x9]; // address: 0x8014081b, offset: 0x1b
    union {
        struct {
    ...
    union {
        struct {
            ...
            unsigned high : 7;
            unsigned clk_sel : 1;
        } __attribute__((packed)) dmic_step_l_bit;
        struct {
            enum tlk_clock_dmic_step_l_e __attribute__((packed)) dmic_step_l : 16;
    ...
    union {
        struct {
            unsigned reserved : 4;
            unsigned iso7816_mod : 3;
            unsigned iso7816_clk_en : 1;
    ...
    union {
        struct {
            ...
            unsigned rst_all_status : 1;
            unsigned watchdog_rst_status : 1;
            unsigned rst_mcu_status : 1;
    ...
    union {
        struct {
            unsigned reserved0 : 1;
            unsigned adc_dig_clk_sel : 1;
            unsigned reserved1 : 6;
        } __attribute__((packed)) sel_bit;
        struct {
            enum tlk_clock_sel_e __attribute__((packed)) sel : 8;
