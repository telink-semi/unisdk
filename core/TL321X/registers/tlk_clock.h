...
typedef struct __attribute__((packed)) {
    ...
    union {
        ...
        uint8_t mcu_control0; // address: 0x80140814, offset: 0x14
    };
    ...
    union {
        ...
        uint16_t dmic_step_l; // address: 0x8014082c, offset: 0x2c
    };
    union {
        struct {
    ...
    union {
        ...
        uint8_t sel; // address: 0x80140833, offset: 0x33
    };
