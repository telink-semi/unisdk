...
typedef struct __attribute__((packed)) {
    ...
    union {
        ...
        uint8_t edp0_control; // address: 0x80118002, offset: 0x2
    };
    union {
        struct {
        ...
        uint8_t edp0_status; // address: 0x80118003, offset: 0x3
    };
    union {
        struct {
        ...
        uint8_t edp0_mode; // address: 0x80118004, offset: 0x4
    };
    union {
        struct {
        ...
        uint8_t edp0_mode1; // address: 0x80118005, offset: 0x5
    };
    ...
    union {
        ...
        uint8_t edp0_size; // address: 0x80118009, offset: 0x9
    };
    union {
        struct {
            unsigned r_mdev : 1;
        ...
        uint8_t mdev; // address: 0x8011800a, offset: 0xa
    };
    union {
        struct {
        ...
        uint8_t edp0_sie; // address: 0x8011800b, offset: 0xb
    };
    union {
        struct {
        ...
        uint8_t suspend_cyc; // address: 0x8011800c, offset: 0xc
    };
    ...
    union {
        ...
        uint8_t irq_mask; // address: 0x8011800f, offset: 0xf
    };
    ...
    union {
        ...
        uint8_t edps_ct[8]; // address: 0x80118028, offset: 0x28
    };
    ...
    union {
        ...
        uint8_t usb_fifo; // address: 0x80118045, offset: 0x45
    };
    ...
    union {
        ...
        uint8_t usb_ram; // address: 0x80118048, offset: 0x48
    };
    union {
        struct {
            unsigned usb_blk1 : 3;
        ...
        uint8_t usb_min1; // address: 0x80118049, offset: 0x49
    };
    ...
    union {
        ...
        uint8_t edps_maxh0; // address: 0x80118050, offset: 0x50
    };
    union {
        struct {
            unsigned sie_edp : 4;
    ...
    union {
        ...
        uint8_t pem_control; // address: 0x8011805d, offset: 0x5d
    };
    ...
    union {
        ...
        uint8_t usb_ct; // address: 0x80118066, offset: 0x66
    };
} tlk_usb_reg_t;
