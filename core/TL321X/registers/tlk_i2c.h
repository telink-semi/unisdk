...
typedef enum tlk_i2c0_master_e {
    ...
    TLK_I2C0_MASTER_MASTER_SCS_N = TLK_BIT(1),
...
typedef enum tlk_i2c0_control2_e {
    ...
    TLK_I2C0_CONTROL2_MANUAL_TX_STOP_HIT   = TLK_BIT(2),
    TLK_I2C0_CONTROL2_MANUAL_RX_STOP_HIT   = TLK_BIT(3),
    ...
    TLK_I2C0_CONTROL2_R_STRETCH_POS_SEL    = TLK_BIT(7),
} tlk_i2c0_control2_e;

typedef enum tlk_i2c0_control3_e {
    TLK_I2C0_CONTROL3_SLAVE_CLK_STRETCH_EN = TLK_BIT(0),
    TLK_I2C0_CONTROL3_R_ID_NMATCH_STOP_EN  = TLK_BIT(1),
    ...
    TLK_I2C0_CONTROL3_AUTO_RXCLR_EN        = TLK_BIT(5),
    TLK_I2C0_CONTROL3_R_HS_MODE            = TLK_BIT(6),
    TLK_I2C0_CONTROL3_R_FAST_MODE          = TLK_BIT(7),
} tlk_i2c0_control3_e;

typedef enum tlk_i2c0_status_e {
    TLK_I2C0_STATUS_I2C_IRQ_O = TLK_BIT(3),
    TLK_I2C0_STATUS_RXDONE    = TLK_BIT(7),
} tlk_i2c0_status_e;

typedef enum tlk_i2c0_status1_e {
    TLK_I2C0_STATUS1_SLAVE_RW_STATUS = TLK_BIT(0),
    TLK_I2C0_STATUS1_SS_SCL          = TLK_BIT(1),
    TLK_I2C0_STATUS1_TX_EMPTY        = TLK_BIT(2),
    TLK_I2C0_STATUS1_RX_FULL         = TLK_BIT(3),
    TLK_I2C0_STATUS1_TRX_START       = TLK_BIT(4),
    TLK_I2C0_STATUS1_TRX_STOP        = TLK_BIT(5),
...
typedef enum tlk_i2c0_control1_e {
    TLK_I2C0_CONTROL1_PEM_EVENT_EN           = TLK_BIT(0),
    TLK_I2C0_CONTROL1_PEM_EVENT_SEL          = TLK_BIT(2),
    TLK_I2C0_CONTROL1_MASK_TRX_START         = TLK_BIT(4),
    TLK_I2C0_CONTROL1_MASK_TRX_STOP          = TLK_BIT(5),
    TLK_I2C0_CONTROL1_R_STRETCH_AUTO_CLR_DIS = TLK_BIT(6),
} tlk_i2c0_control1_e;

typedef enum tlk_i2c0_master_status_e {
    TLK_I2C0_MASTER_STATUS_SS_BUSY    = TLK_BIT(0),
    TLK_I2C0_MASTER_STATUS_SS_ID      = TLK_BIT(1),
    TLK_I2C0_MASTER_STATUS_SS_DATAW   = TLK_BIT(2),
    TLK_I2C0_MASTER_STATUS_SS_DATAR   = TLK_BIT(3),
    TLK_I2C0_MASTER_STATUS_ID_BUSY    = TLK_BIT(4),
    TLK_I2C0_MASTER_STATUS_ADDR_BUSY  = TLK_BIT(5),
    TLK_I2C0_MASTER_STATUS_DATAW_BUSY = TLK_BIT(6),
    TLK_I2C0_MASTER_STATUS_DATAR_BUSY = TLK_BIT(7),
} tlk_i2c0_master_status_e;
...
typedef struct __attribute__((packed)) {
    ...
    union {
        ...
        struct {
            enum tlk_i2c0_control1_e __attribute__((packed)) control1 : 8;
    ...
    union {
        ...
        struct {
            enum tlk_i2c0_master_status_e __attribute__((packed)) master_status : 8;
        }; // address: 0x80140294, offset: 0x14
    };
    union {
        struct {
...
typedef enum tlk_i2c1_master_e {
    ...
    TLK_I2C1_MASTER_MASTER_SCS_N = TLK_BIT(1),
