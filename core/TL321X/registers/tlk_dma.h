#ifndef TLK_DMA_REGISTERS_H_
#define TLK_DMA_REGISTERS_H_

#include <stdint.h>

typedef struct __attribute__((packed)) {
    uint8_t reserved0[0x29]; // address: 0x80100400, offset: 0x0
    uint8_t err_irq_en; // address: 0x80100429, offset: 0x29
    uint8_t abort_irq_en; // address: 0x8010042a, offset: 0x2a
    uint8_t reserved1[0x5]; // address: 0x8010042b, offset: 0x2b
    union {
        struct {
    ...
    struct {
        union {
            struct {
                ...
                unsigned dst_req_sel : 6;
                unsigned src_req_sel : 6;
            ...
            uint32_t control; // address: 0x80100444, offset: 0x44
        };
