...
typedef union tlk_areg_power3 {
    struct {
        unsigned captrim_xtal32k_3p3v : 6;
...
typedef union tlk_areg_power5 {
    struct {
        ...
        unsigned pd_cap_xtal32k_3p3v : 1;
    } __attribute__((packed)) bit;
    uint8_t raw;
} tlk_areg_0x0a;
...
typedef union tlk_areg_power10 {
    struct {
        ...
        unsigned pd_efuse_ldo : 1;
        unsigned dig_ldo_fb_trim_3v : 3;
        unsigned retram_pg_en : 1;
    } __attribute__((packed)) bit;
    uint8_t raw;
} tlk_areg_0x10;
...
typedef union tlk_areg_power12 {
    struct {
        unsigned bbpll_3p3v_ldo_trim : 3;
        unsigned reserved : 1;
...
// uint8_t reserved1[0x14]; // address: 0x21
...
// uint8_t reserved2; // address: 0x44
...
// uint8_t reserved3; // address: 0x4a
...
// uint8_t reserved4[0xd]; // address: 0x53
...
// uint8_t reserved5[0x3]; // address: 0x66
...
#define TLK_AREG_DBGEN_CTRL 0x6a
#define TLK_AREG_0x6a_SIZE 8

typedef union tlk_areg_dbgen_ctrl {
    struct {
        unsigned dbgen_en_w1s : 1;
        unsigned dbgen_dis_w1s : 1;
        unsigned reserved : 6;
    } __attribute__((packed)) bit;
    uint8_t raw;
} tlk_areg_0x6a;

// uint8_t reserved6[0xc]; // address: 0x6b
...
// uint8_t reserved7; // address: 0x78
...
typedef union tlk_areg_bbpll_ctrl0 {
    struct {
        unsigned pfdmux_bpll_1p05v : 3;
        unsigned cpsel_bpll_1p05v : 2;
        unsigned rtrim_bpll_1p05v : 1;
        unsigned lpfc1_bpll_1p05v : 1;
        unsigned lpfc2_bpll_1p05v : 1;
    } __attribute__((packed)) bit;
    uint8_t raw;
} tlk_areg_0x80;
...
typedef union tlk_areg_bbpll_ctrl1 {
    struct {
        unsigned vcobuf_bpll_1p05v : 2;
        unsigned kvco_bpll_1p05v : 3;
        unsigned enlockdet_bpll_1p05v : 1;
        unsigned selclkout_bpll_1p05v : 1;
        unsigned pd_bpll_1p05v : 1;
    } __attribute__((packed)) bit;
    uint8_t raw;
} tlk_areg_0x81;
...
typedef union tlk_areg_bbpll_ctrl2 {
    struct {
        unsigned div_bpll_1p05v : 5;
        unsigned en_clk24m_tosar_1p05v : 1;
        unsigned reserved : 2;
    } __attribute__((packed)) bit;
    uint8_t raw;
} tlk_areg_0x82;

// uint8_t reserved8[0x5]; // address: 0x83

#define TLK_AREG_BBPLL_CTRL3 0x88
...
// uint8_t reserved9; // address: 0x89
...
typedef union tlk_areg_xo_adc_pga_ctrl {
    struct {
        ...
        unsigned l_dem_en : 1;
        unsigned l_a_dither : 2;
        unsigned l_en_dither : 1;
        unsigned l_dither_in : 1;
        unsigned l_lv_en : 1;
    } __attribute__((packed)) bit;
    uint8_t raw;
} tlk_areg_0x8c;
...
typedef union tlk_areg_pga_ctrl1 {
    struct {
        unsigned l_filtcap_ctl : 2;
        unsigned l_vmidsel : 2;
        unsigned l_pd_pga : 1;
        unsigned l_pd_bias : 1;
        unsigned l_pd_adc : 1;
        unsigned l_pd_vmid : 1;
    } __attribute__((packed)) bit;
    uint8_t raw;
} tlk_areg_0x8e;
...
typedef union tlk_areg_pga_ctrl2 {
    struct {
        unsigned l_lp : 4;
        unsigned l_adc_test : 3;
        unsigned reserved : 1;
    } __attribute__((packed)) bit;
    uint8_t raw;
} tlk_areg_0x8f;

// uint8_t reserved10[0x2d]; // address: 0x90

#define TLK_AREG_PB_IE 0xbd
#define TLK_AREG_0xbd_SIZE 8

typedef union tlk_areg_pb_ie {
    struct {
        unsigned reserved : 4;
        unsigned pb_ie : 4;
    } __attribute__((packed)) bit;
...
// uint8_t reserved11; // address: 0xbe

#define TLK_AREG_PC_IE 0xbf

// uint8_t reserved12[0x6]; // address: 0xc0
...
// uint8_t reserved13[0x14]; // address: 0xd0
...
// uint8_t reserved14[0x2]; // address: 0xea
...
// uint8_t reserved15[0x5]; // address: 0xed
...
// uint8_t reserved16; // address: 0xf5
...
// uint8_t reserved17; // address: 0xf9
...
// uint8_t reserved18; // address: 0xfb
