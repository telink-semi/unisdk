...
#
# UniSDK Zephyr module — TL721X SoC drivers
#
# Mirrors soc/TL721X/CMakeLists.txt.
#
...
# ============================================================================
# _tlk_otp.c and _tlk_advanced_stimer.c — added in dev mode only
if(NOT EXISTS "${UNISDK_BASE}/libraries")
    zephyr_sources(${SOC_CHIP_BASE}/drivers/src/_tlk_otp.c)
