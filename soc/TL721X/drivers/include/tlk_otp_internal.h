 ...
 *  API Reference
 *  ===============
 *  Header File: tlk_otp.h
 *
 *  How to use this driver
 *  ===============
 *   -# Power on OTP using the function tlk_otp_set_active_mode().
 *   -# OTP read/write, tlk_otp_read(), tlk_otp_write().
 *   -# OTP shutdown to save current using the function tlk_otp_set_deep_standby_mode().
 *
 */
#ifndef TLK_OTP_INTERNAL_H_
#define TLK_OTP_INTERNAL_H_
