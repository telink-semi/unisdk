...
#include "registers/tlk_chacha20_poly1305_reg.h"
#include <string.h>
...
#define rCHACHA20_POLY1305_CTRL                                                                    \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR))) /* Offset: 0x000 (W1S)             \
                                                                   chacha20_poly1305 Control       \
                                                                   Register */
#define rCHACHA20_POLY1305_CFG                                                                     \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x004U))) /* Offset: 0x004 (R/W) chacha20_poly1305 Config         \
                                              Register */
#define rCHACHA20_POLY1305_SOFT_RST_N                                                              \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x008U))) /* Offset: 0x008 (W0)  chacha20_poly1305 Soft Reset     \
                                              Register*/
#define rCHACHA20_POLY1305_DIN_RDY                                                                 \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x00CU))) /* Offset: 0x00C (R0)  chacha20_poly1305 Ready Data     \
                                              Register*/
#define rCHACHA20_POLY1305_RISR                                                                    \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x010U))) /* Offset: 0x010 (W0C) chacha20_poly1305 Interrupt      \
                                              Source Register */
#define rCHACHA20_POLY1305_IMCR                                                                    \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x014U))) /* Offset: 0x014 (R/W) chacha20_poly1305 Interrupt      \
                                              Enable Register */
#define rCHACHA20_POLY1305_STATUS                                                                  \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x018U))) /* Offset: 0x018 (R)   chacha20_poly1305 Status         \
                                              Register */
#define rCHACHA20_POLY1305_ERR_CODE                                                                \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x01CU))) /* Offset: 0x01C (R)   chacha20_poly1305 Error Code     \
                                              Register */
#define rCHACHA20_POLY1305_LAST                                                                    \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x020U))) /* Offset: 0x020 (R/W) chacha20_poly1305 Last Data      \
                                              Register */
#define rCHACHA20_POLY1305_SE_DONE                                                                 \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x024U))) /* Offset: 0x024 (R)   chacha20_poly1305 Secure Key     \
                                              Configured Register */
#define rCHACHA20_POLY1305_KEY(i)                                                                  \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR + 0x030U +                            \
                                 ((i) << 2)))) /* Offset: 0x030 (W)   chacha20_poly1305 Key        \
                                                  Register, 8 words*/
#define rCHACHA20_POLY1305_IV(i)                                                                   \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR + 0x050U +                            \
                                 ((i) << 2)))) /* Offset: 0x050 (W)   chacha20_poly1305 IV         \
                                                  Register, 2 words*/
#define rCHACHA20_POLY1305_CONSTANT                                                                \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x058U))) /* Offset: 0x058 (W)   chacha20_poly1305 Constant       \
                                              Register */
#define rCHACHA20_POLY1305_LENGTH(i)                                                               \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR + 0x060U +                            \
                                 ((i) << 2)))) /* Offset: 0x060 (W)   chacha20_poly1305 Length     \
                                                  Register, 5 words */
#define rCHACHA20_POLY1305_CNT                                                                     \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x074U))) /* Offset: 0x074 (W)   chacha20_poly1305 Counter        \
                                              Register */
#define rCHACHA20_POLY1305_TAG_IN(i)                                                               \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR + 0x080U +                            \
                                 ((i) << 2)))) /* Offset: 0x080 (W)   chacha20_poly1305 Tag Input  \
                                                  Register, 5 words */
#define rCHACHA20_POLY1305_DIN                                                                     \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x094U))) /* Offset: 0x094 (W)   chacha20_poly1305 Data Input     \
                                              Register */
#define rCHACHA20_POLY1305_VERSION                                                                 \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x0FCU))) /* Offset: 0x0FC (R)   chacha20_poly1305 Version        \
                                              Register */
#define rCHACHA20_POLY1305_DOUT(i)                                                                 \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR + 0x100U +                            \
                                 ((i) << 2)))) /* Offset: 0x100 (R)   chacha20_poly1305 Data       \
                                                  Output Register, 4 words */
#define rCHACHA20_POLY1305_TOUT(i)                                                                 \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR + 0x110U +                            \
                                 ((i) << 2)))) /* Offset: 0x110 (R)   chacha20_poly1305 Tag Output \
                                                  register, 5 words */
#define rCHACHA20_POLY1305_COUT                                                                    \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x124U))) /* Offset: 0x124 (R)   chacha20_poly1305 Counter Output \
                                              Register */
#define rCHACHA20_POLY1305_DMA_SADDR_A                                                             \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x1C0U))) /* Offset: 0x1C0 (R/W) DMA Source AAD Register */
#define rCHACHA20_POLY1305_DMA_RLEN_A                                                              \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x1C4U))) /* Offset: 0x1C4 (R/W) DMA Reading AAD Byte Length      \
                                              Register */
#define rCHACHA20_POLY1305_DMA_SADDR_D                                                             \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x1D0U))) /* Offset: 0x1D0 (R/W) DMA Source Payload Register */
#define rCHACHA20_POLY1305_DMA_DADDR_D                                                             \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x1D4U))) /* Offset: 0x1D4 (R/W) DMA Destination Payload Register \
                                            */
#define rCHACHA20_POLY1305_DMA_LEN_D                                                               \
    (*((volatile unsigned int*) (CHACHA20_POLY1305_BASE_ADDR +                                     \
                                 0x1D8U))) /* Offset: 0x1D8 (R/W) DMA Reading Payload Byte Length  \
                                              Register */
#endif
     ...
     * @return      none
     */
    void chacha20_poly1305_set_length(unsigned long long aad_bytes,
     ...
     * @return      none
     */
    void chacha20_poly1305_set_length_clean_aad_last(unsigned long long aad_bytes,
                                                     unsigned long long payload_bytes);
    ...
    /**
     * @brief       set whether chacha20_poly1305 next input data is the last word data or not (CPU
     * mode)
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int chacha20_poly1305_update_blocks(unsigned char* in, unsigned char* out,
                                                 unsigned int bytes);
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int chacha20_poly1305_update_last_block(unsigned char* in, unsigned char* out,
 ...
 */
     ...
     * @return      0:success     other:error
     */
    unsigned int chacha20_poly1305_dma_operate(unsigned int* in, unsigned int* out,
                                               unsigned int bytes);
#endif
