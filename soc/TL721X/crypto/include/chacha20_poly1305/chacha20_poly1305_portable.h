...
extern "C"
{
     ...
     */
    enum tlk_dma_chn chacha20_poly1305_get_tx_dma_channel(void);

    /**
     * @brief       get chacha20_poly1305 rx dma channel.
     * @return      chacha20_poly1305 rx dma channel
     */
    enum tlk_dma_chn chacha20_poly1305_get_rx_dma_channel(void);
     ...
     * @return      none
     */
    void chacha20_poly1305_set_tx_dma_channel(enum tlk_dma_chn chn);
     ...
     * @return      none
     */
    void chacha20_poly1305_set_rx_dma_channel(enum tlk_dma_chn chn);
     ...
     * @note
     */
    void chacha20_poly1305_tx_dma(enum tlk_dma_chn chn, unsigned int buf_addr, unsigned int len);

    /**
     * @brief configure the dma channel destination address and data length for chacha20_poly1305 rx
     * dma.
     * @param[in]   chn              - dma channel
     ...
     * @note
     */
    void chacha20_poly1305_rx_dma(enum tlk_dma_chn chn, unsigned int buf_addr, unsigned int len);
     ...
     * @return      none
     */
    void chacha20_poly1305_set_tx_dma_config(enum tlk_dma_chn tx_chn);
     ...
     * @return     none
     */
    void chacha20_poly1305_set_rx_dma_config(enum tlk_dma_chn        rx_chn,
                                             enum tlk_dma_burst_size burst_size);

    /**
     * @brief Initialize CHACHA20_POLY1305-related generic configurations.
     * @note        Only after calling this function can other CHACHA20_POLY1305 related functions
     * be called. Otherwise, other CHACHA20_POLY1305 function settings will not take effect.
     * @return None.
     */
    void chacha20_poly1305_dig_en(void);

    /**
     * @brief     Resets CHACHA20_POLY1305 module,before using CHACHA20_POLY1305, it is needed to
     * call chacha20_poly1305_reset() to avoid affecting the use of CHACHA20_POLY1305.
     * @return    none
     */
