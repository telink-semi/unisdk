...
#define MIN_RSA_BIT_LEN  (512)
    ...
    // define KDF
    typedef void* (*KDF_FUNC)(void* input, unsigned int byteLen, unsigned char* key,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int pke_modadd(unsigned int* modulus, unsigned int* a,
                            unsigned int* b, //----------------------
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int pke_modsub(unsigned int* modulus, unsigned int* a,
                            unsigned int* b, //----------------------
                            unsigned int* out, unsigned int wordLen);
    /**
 * @brief      out = (a+b) mod modulus
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int pke_add(volatile unsigned int* a, volatile unsigned int* b, unsigned int* out,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int pke_mul(unsigned int* a, unsigned int* b, volatile unsigned int* out,
                         unsigned int ab_wordLen);

    /**
 * @brief      calc H(R^2 mod modulus) and n1( - modulus ^(-1) mod 2^w ) for modMul,modExp, and
 pointMul. etc.
 ...
 *    -# 3. wordLen must not be bigger than OPERAND_MAX_WORD_LEN
  @endverbatim
 */
    unsigned int pke_pre_calc_mont(volatile unsigned int* modulus, unsigned int bitLen,
                                   unsigned int* H, unsigned int* n1);
 ...
 * @note
  ...
  @endverbatim
 */
    void pke_load_pre_calc_mont(volatile unsigned int* H, volatile unsigned int* n1,
                                unsigned int wordLen);

    /**
 * @brief      load modulus and pre-calculated mont parameters H(R^2 mod modulus) and n0'(- modulus
 ...
 *        of modulus are located in the right address.
  @endverbatim
 */
    unsigned int pke_modmul_internal(volatile unsigned int* modulus, volatile unsigned int* a,
                                     volatile unsigned int* b, volatile unsigned int* out,
                                     unsigned int wordLen);
 ...
 */
    unsigned int
    pke_modexp(volatile unsigned int* modulus, volatile unsigned int* exponent,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int pke_mod(unsigned int* a, unsigned int aWordLen, unsigned int* b,
                         volatile unsigned int* b_h, volatile unsigned int* b_n1,
 ...
 */
    ...
    // unsigned int eccp_get_pubkey_from_prikey(eccp_curve_t *curve, unsigned char *priKey, unsigned
    // char *pubKey);
