 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha256_update(HMAC_SHA256_CTX* ctx, const unsigned char* msg,
 ...
 */
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_sha256_dma_init(HMAC_SHA256_DMA_CTX* ctx, const unsigned char* key,
                                      unsigned short sp_key_idx, unsigned int key_bytes,
 ...
 * @param[in]   ctx                    - HMAC_CTX context pointer.
 * @param[in]   msg                    - message.
 * @param[in]   msg_words              - word length of the input message, must be a multiple of
 block word length
 *                                       of SHA256(16).
 * @return      0:success     other:error
 * @note
