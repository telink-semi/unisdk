 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha512_update(HMAC_SHA512_CTX* ctx, const unsigned char* msg,
 ...
 */
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_sha512_dma_init(HMAC_SHA512_DMA_CTX* ctx, const unsigned char* key,
                                      unsigned short sp_key_idx, unsigned int key_bytes,
 ...
 * @param[in]   remainder_bytes   - word length of the input message, must be a multiple of block
 word length of SHA512(32).
 * @param[out]  mac               - hmac.
 * @return      0:success     other:error
 * @note
  @verbatim
