 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_init(HMAC_CTX* ctx, HASH_ALG hash_alg, const unsigned char* key,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_dma_init(HMAC_DMA_CTX* ctx, HASH_ALG hash_alg, const unsigned char* key,
                               unsigned short sp_key_idx, unsigned int key_bytes,
