 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha512_256_update(HMAC_SHA512_256_CTX* ctx, const unsigned char* msg,
 ...
 */
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_sha512_256_dma_init(HMAC_SHA512_256_DMA_CTX* ctx, const unsigned char* key,
                                          unsigned short sp_key_idx, unsigned int key_bytes,
