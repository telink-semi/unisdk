 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_md5_update(HMAC_MD5_CTX* ctx, const unsigned char* msg,
 ...
 */
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_md5_dma_init(HMAC_MD5_DMA_CTX* ctx, const unsigned char* key,
 ...
 * @param[in]   ctx           - HMAC_MD5_DMA_CTX context pointer.
 * @param[in]   msg           - message.
 * @param[in]   msg_words     - word length of the input message, must be a multiple of block word
 length of MD5(16).
 * @return      0:success     other:error
 * @note
  @verbatim
