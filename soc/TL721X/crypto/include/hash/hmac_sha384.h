 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha384_update(HMAC_SHA384_CTX* ctx, const unsigned char* msg,
 ...
 */
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_sha384_dma_init(HMAC_SHA384_DMA_CTX* ctx, const unsigned char* key,
                                      unsigned short sp_key_idx, unsigned int key_bytes,
