...
#if 0 // warning: hardware does not support 3DES directly, here the 4 MACRO should be defined or not
 ...
 * @note
  @verbatim
      ...
      -# 2.it could be without output, namely, out can be NULL, out_words can be 0(for input AAD, or
 CBC_MAC/CMAC mode).
  @endverbatim
 */
