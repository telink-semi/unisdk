...
extern "C"
{
     ...
     */
    enum tlk_dma_chn ske_get_tx_dma_channel(void);

    /**
     * @brief       get ske rx dma channel.
     * @return      ske rx dma channel
     */
    enum tlk_dma_chn ske_get_rx_dma_channel(void);
     ...
     * @return      none
     */
    void ske_set_tx_dma_channel(enum tlk_dma_chn chn);
     ...
     * @return      none
     */
    void ske_set_rx_dma_channel(enum tlk_dma_chn chn);
     ...
     * @note
     */
    void ske_tx_dma(enum tlk_dma_chn chn, unsigned int buf_addr, unsigned int len);
     ...
     * @note
     */
    void ske_rx_dma(enum tlk_dma_chn chn, unsigned int buf_addr, unsigned int len);
     ...
     * @return      none
     */
    void ske_set_tx_dma_config(enum tlk_dma_chn tx_chn);
     ...
     * @return     none
     */
    void ske_set_rx_dma_config(enum tlk_dma_chn rx_chn, enum tlk_dma_burst_size burst_size);
#endif
    ...
    /**
     * @brief     Resets SKE module,before using SKE, it is needed to call ske_reset() to avoid
     * affecting the use of SKE.
     * @return    none
     */
