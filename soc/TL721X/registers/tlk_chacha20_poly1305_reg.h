#ifndef TLK_TLK_CHACHA20_POLY1305_REG_REGISTERS_H_
#define TLK_TLK_CHACHA20_POLY1305_REG_REGISTERS_H_

#include <stdint.h>
#include <common/include/tlk_bit.h>

typedef enum tlk_chacha20_control_e {
    TLK_CHACHA20_CONTROL_START = TLK_BIT(0),
} tlk_chacha20_control_e;

typedef enum tlk_chacha20_config_e {
    TLK_CHACHA20_CONFIG_DECODE = TLK_BIT(2),
    TLK_CHACHA20_CONFIG_DMA_EN = TLK_BIT(3),
} tlk_chacha20_config_e;

typedef enum tlk_chacha20_soft_reset_e {
    TLK_CHACHA20_SOFT_RESET_VALUE = TLK_BIT(0),
} tlk_chacha20_soft_reset_e;

typedef enum tlk_chacha20_data_in_ready_e {
    TLK_CHACHA20_DATA_IN_READY_VALUE = TLK_BIT(0),
} tlk_chacha20_data_in_ready_e;

typedef enum tlk_chacha20_risr_e {
    TLK_CHACHA20_RISR_VALUE = TLK_BIT(0),
} tlk_chacha20_risr_e;

typedef enum tlk_chacha20_imcr_e {
    TLK_CHACHA20_IMCR_VALUE = TLK_BIT(0),
} tlk_chacha20_imcr_e;

typedef enum tlk_chacha20_status_e {
    TLK_CHACHA20_STATUS_VALUE = TLK_BIT(0),
} tlk_chacha20_status_e;

typedef enum tlk_chacha20_last_e {
    TLK_CHACHA20_LAST_VALUE = TLK_BIT(0),
} tlk_chacha20_last_e;

typedef enum tlk_chacha20_se_done_e {
    TLK_CHACHA20_SE_DONE_VALUE = TLK_BIT(0),
} tlk_chacha20_se_done_e;
...
typedef struct __attribute__((packed)) {
    union {
        ...
        struct {
            enum tlk_chacha20_control_e __attribute__((packed)) control : 8;
        }; // address: 0x80105000, offset: 0x0
    };
    ...
    union {
        ...
        struct {
            enum tlk_chacha20_config_e __attribute__((packed)) config : 8;
        }; // address: 0x80105004, offset: 0x4
    };
    ...
    union {
        ...
        struct {
            enum tlk_chacha20_soft_reset_e __attribute__((packed)) soft_reset : 8;
        }; // address: 0x80105008, offset: 0x8
    };
    ...
    union {
        ...
        struct {
            enum tlk_chacha20_data_in_ready_e __attribute__((packed)) data_in_ready : 8;
        }; // address: 0x8010500c, offset: 0xc
    };
    ...
    union {
        ...
        struct {
            enum tlk_chacha20_risr_e __attribute__((packed)) risr : 8;
        }; // address: 0x80105010, offset: 0x10
    };
    ...
    union {
        ...
        struct {
            enum tlk_chacha20_imcr_e __attribute__((packed)) imcr : 8;
        }; // address: 0x80105014, offset: 0x14
    };
    ...
    union {
        ...
        struct {
            enum tlk_chacha20_status_e __attribute__((packed)) status : 8;
        }; // address: 0x80105018, offset: 0x18
    };
    ...
    union {
        ...
        struct {
            enum tlk_chacha20_last_e __attribute__((packed)) last : 8;
        }; // address: 0x80105020, offset: 0x20
    };
    ...
    union {
        ...
        struct {
            enum tlk_chacha20_se_done_e __attribute__((packed)) se_done : 8;
        }; // address: 0x80105024, offset: 0x24
    };
...
typedef enum tlk_chacha20_extended_dma_en_e {
    TLK_CHACHA20_EXTENDED_DMA_EN_TXDMA_EN = TLK_BIT(0),
    TLK_CHACHA20_EXTENDED_DMA_EN_RXDMA_EN = TLK_BIT(1),
} tlk_chacha20_extended_dma_en_e;
...
typedef struct __attribute__((packed)) {
    ...
    union {
        ...
        struct {
            enum tlk_chacha20_extended_dma_en_e __attribute__((packed)) dma_en : 8;
        }; // address: 0x80100814, offset: 0x14
    };
    union {
        struct {
