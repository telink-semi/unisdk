...
typedef enum
{
    ...
    FLD_RF_IRQ_RADIO_DONE        = TLK_BIT(26), /*TODO:TODO:This function interface is not available at this time, and will be updated in subsequent releases.(unverified)*/
