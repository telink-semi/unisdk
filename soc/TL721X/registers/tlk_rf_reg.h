...
enum
{
    ...
    FLD_RF_R_CRC_CHECK_EN = TLK_BIT(6),
    FLD_RF_R_CRC_LAT_RST  = TLK_BIT(7),
};
...
typedef enum
{
    ...
    FLD_RF_IRQ_RX_FIFO_FULL =
        TLK_BIT(3), /*Auto/Manual:An interrupt is generated when the data size of the total received
                       packets is exceeded to the allocated storage range of Rx SRAM TL721X chip
    ...
    FLD_RF_IRQ_RADIO_DONE =
        TLK_BIT(26), /*TODO:TODO:This function interface is not available at this time, and will be
...
enum
{
    ...
    FLD_RF_NESN           = TLK_BIT(4),
    FLD_RF_TURNAROUND_IRQ = TLK_BIT(7),
};
...
enum
{
    FLD_RF_PA_CAS_BIAS_DIG = TLK_BIT_RNG(0, 1),
};
...
enum
{
    FLD_RF_RCCAL_OVERWRITE        = TLK_BIT_RNG(0, 5),
...
enum
{
    ...
    FLD_RF_RCCAL_ACCUM_INIT  = TLK_BIT_RNG(3, 7),
};
...
enum
{
    FLD_RF_RCCAL_CBPF_CCODE_PRT = TLK_BIT(0),
};
...
enum
{
    FLD_RF_RCCAL_CODE   = TLK_BIT_RNG(0, 5),
    FLD_RF_CBPF_CCODE_L = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_CBPF_CCODE_H = TLK_BIT_RNG(0, 4),
};
...
enum
{
    ...
    FLD_RF_DCOC_IDAC_CODE_OVERWRITE   = TLK_BIT_RNG(1, 6),
    FLD_RF_DCOC_QDAC_CODE_OVERWRITE_L = TLK_BIT(7),
};
...
enum
{
    FLD_RF_DCOC_QDAC_CODE_OVERWRITE_H = TLK_BIT_RNG(0, 4),
};
...
enum
{
    FLD_RF_DCOC_IDAC_CODE = TLK_BIT_RNG(0, 5),
    FLD_RF_SPARE_3        = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_DCOC_QDAC_CODE = TLK_BIT_RNG(0, 5),
};
...
enum
{
    FLD_RF_LNA_ITRIM       = TLK_BIT_RNG(0, 1),
    FLD_RF_MIX_VBIAS       = TLK_BIT_RNG(2, 3),
    FLD_RF_PA_VBIAS        = TLK_BIT_RNG(4, 5),
    FLD_RF_RTFE_PTAT_FORCE = TLK_BIT(6),
    FLD_RF_FE_RTRIM_TX_L   = TLK_BIT(7),
};
...
enum
{
    FLD_RF_CBPF_TRIM_I            = TLK_BIT_RNG(0, 1),
    FLD_RF_CBPF_TRIM_Q            = TLK_BIT_RNG(2, 3),
    FLD_RF_CBPF_EN_DIAG_MEAS      = TLK_BIT(4),
    FLD_RF_CBPF_TRIM_SHORT_DCBIAS = TLK_BIT_RNG(5, 6),
    FLD_RF_CBPF_VCM_TRIM_L        = TLK_BIT(7),
};
