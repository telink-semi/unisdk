...
enum
{
    FLD_ADC_RES_M         = TLK_BIT_RNG(0, 1),
    FLD_ADC_EN_DIFF_CHN_M = TLK_BIT(6),
};
...
enum
{
    FLD_NOT_SAMPLE_ADC_DATA = TLK_BIT(0), //hold mode
    FLD_DWA_EN_O            = TLK_BIT(1),
    FLD_ANA_RD_EN           = TLK_BIT(2),
};
...
enum
{
    FLD_ADC_SAMPLE_CLK_DIV = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_M_CHN_DATA_VALID_STATUS = TLK_BIT(0),
};
...
enum
{
    FLD_ADC_ITRIM_PREAMP  = TLK_BIT_RNG(0, 1),
    FLD_ADC_ITRIM_VREFBUF = TLK_BIT_RNG(2, 3),
    FLD_ADC_ITRIM_VCMBUF  = TLK_BIT_RNG(4, 5),
};
...
enum
{
    FLD_SAR_ADC_POWER_DOWN = TLK_BIT(5),
};
...
enum
{
    FLD_TEMP_SENSOR_POWER_DOWN = TLK_BIT(2),
};
...
enum
{
    FLD_P_INPUT_PIN = TLK_BIT_RNG(0, 3),
    FLD_N_INPUT_PIN = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_M_TSAMP = TLK_BIT_RNG(0, 3),
    FLD_L_TSAMP = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_M_VBAT_DIV = TLK_BIT_RNG(0, 1),
    FLD_L_VBAT_DIV = TLK_BIT_RNG(2, 3),
    FLD_R_VBAT_DIV = TLK_BIT_RNG(4, 5),
};
...
enum
{
    FLD_R_MAX_S      = TLK_BIT_RNG(0, 3),
    FLD_SEL_AI_SCALE = TLK_BIT_RNG(4, 5),
    FLD_SEL_VREF     = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_R_MAX_C_L = TLK_BIT_RNG(0, 7),
    FLD_R_MAX_C_H = TLK_BIT_RNG(8, 9),
};
...
enum
{
    FLD_SAR_ADC_CLK_DIV = TLK_BIT_RNG(0, 3),
    FLD_ADC_MODE        = TLK_BIT(5),
};
...
enum
{
    FLD_M_CHANNEL_EN            = TLK_BIT(0),
    FLD_L_CHANNEL_EN            = TLK_BIT(1),
    FLD_R_CHANNEL_EN            = TLK_BIT(2),
    FLD_RX_DMA_ENABLE           = TLK_BIT(4),
    FLD_CLK_EN                  = TLK_BIT(5),
    FLD_SAR_RX_INTERRUPT_ENABLE = TLK_BIT(6),
    FLD_TRIG_MODE               = TLK_BIT(7),
};
...
enum
{
    FLD_RXFIFO_TRIG_NUM = TLK_BIT_RNG(0, 2),
    FLD_BUF_CNT         = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_SAR_IRQ_RX_STATUS = TLK_BIT(0),
    FLD_FIFO_CLR          = TLK_BIT(1),
    FLD_TRIG_START        = TLK_BIT(2),
    FLD_SOFT_START        = TLK_BIT(7),
};
...
enum
{
    FLD_PEM_TASK_ENABLE   = TLK_BIT(0),
    FLD_PEM_EVENT0_ENABLE = TLK_BIT(1),
    FLD_PEM_EVENT1_ENABLE = TLK_BIT(2),
};
