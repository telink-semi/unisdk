...
enum
{
    FLD_RXFIFO0_AINEN  = TLK_BIT(0),
    FLD_RXFIFO1_AINEN  = TLK_BIT(1),
    FLD_RXFIFO2_AINEN  = TLK_BIT(2),
    FLD_RXFIFO0_IRQ_EN = TLK_BIT(4),
    FLD_RXFIFO1_IRQ_EN = TLK_BIT(5),
    FLD_RXFIFO2_IRQ_EN = TLK_BIT(6),
};
...
enum
{
    FLD_R_IF    = TLK_BIT_RNG(0, 1),
    FLD_R_NEG   = TLK_BIT(5),
    FLD_L_CH_EN = TLK_BIT(6),
    FLD_R_CH_EN = TLK_BIT(7),
};
...
enum
{
    FLD_DEC_VOL = TLK_BIT_RNG(0, 5),
    FLD_MIC_SEL = TLK_BIT(7),
};
...
enum
{
    FLD_AIN1_SEL = TLK_BIT_RNG(0, 2),
    FLD_AIN2_SEL = TLK_BIT_RNG(4, 6),
};
...
enum
{
    FLD_I2S01_MONOL_RXFIFO_SEL = TLK_BIT_RNG(0, 1),
    FLD_I2S01_MONOR_RXFIFO_SEL = TLK_BIT_RNG(2, 3),
    FLD_I2S2_MONOL_RXFIFO_SEL  = TLK_BIT_RNG(4, 5),
    FLD_I2S2_MONOR_RXFIFO_SEL  = TLK_BIT_RNG(6, 7),
    FLD_DECL_RXFIFO_SEL        = TLK_BIT_RNG(4, 5),
    FLD_DECR_RXFIFO_SEL        = TLK_BIT_RNG(6, 7),
};

/**
 * BIT[0:3] i2s sync mode selsect: i2s0,i2s1,i2s2 sync mode; i2s0,i2s1 sync mode; i2s1,i2s2 sync
 * mode.
 */
...
enum
{
    FLD_I2S_SYNC_MODE = TLK_BIT_RNG(0, 3),
};

/**
 * BIT[0:1] i2s input fifo0 selsect: 2'd0:16bit mono;2'd1:20bit/24bit mono;2'd2:16bit
 * stereo;2'd3:20bit/24bit stereo. BIT[2:3] i2s input fifo1 selsect: 2'd0:16bit
 * mono;2'd1:20bit/24bit mono;2'd2:16bit stereo;2'd3:20bit/24bit stereo. BIT[4:5] i2s input fifo2
 * selsect: 2'd0:16bit mono;2'd1:20bit/24bit mono;2'd2:16bit stereo;2'd3:20bit/24bit stereo.
 */
#define reg_i2s_ain_mode(i) REG_ADDR8((AUDIO_DFIFO_REG_BASE + 0x38) + (i * 0x01))

enum
{
    FLD_I2S_AIN0_MODE = TLK_BIT_RNG(0, 1),
    FLD_I2S_AIN1_MODE = TLK_BIT_RNG(2, 3),
    FLD_I2S_AIN2_MODE = TLK_BIT_RNG(4, 5),
};

/**
 * BIT[0:1] codec input fifo0 selsect: 16bit mono;2'd1:20bit mono;2'd2:16bit stereo;2'd3:20bit
 * stereo. BIT[2:3] codec input fifo1 selsect: 16bit mono;2'd1:20bit mono;2'd2:16bit
 * stereo;2'd3:20bit stereo. BIT[4:5] codec input fifo2 selsect: 16bit mono;2'd1:20bit
 * mono;2'd2:16bit stereo;2'd3:20bit stereo.
 */
#define reg_dec_ain_mode REG_ADDR8(AUDIO_DFIFO_REG_BASE + 0x3b)

enum
{
    FLD_DEC_AIN0_MODE = TLK_BIT_RNG(0, 1),
    FLD_DEC_AIN1_MODE = TLK_BIT_RNG(2, 3),
    FLD_DEC_AIN2_MODE = TLK_BIT_RNG(4, 5),
};
...
enum
{
    FLD_AUDIO_RXFIFO_TRIG_NUM = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RX0_WPTR_EN = TLK_BIT(0),
    FLD_RX1_WPTR_EN = TLK_BIT(1),
    FLD_RX2_WPTR_EN = TLK_BIT(2),
    FLD_TX0_RPTR_EN = TLK_BIT(4),
    FLD_TX1_RPTR_EN = TLK_BIT(5),
    FLD_TX2_RPTR_EN = TLK_BIT(6),
};
...
enum
{
    FLD_RXFIFO0_CLR = TLK_BIT(0),
    FLD_RXFIFO1_CLR = TLK_BIT(1),
    FLD_RXFIFO2_CLR = TLK_BIT(2),
    FLD_TXFIFO0_CLR = TLK_BIT(4),
    FLD_TXFIFO1_CLR = TLK_BIT(5),
    FLD_TXFIFO2_CLR = TLK_BIT(6),
};
...
enum
{
    FLD_TXFIFO0_AOUTEN = TLK_BIT(0),
    FLD_TXFIFO1_AOUTEN = TLK_BIT(1),
    FLD_TXFIFO2_AOUTEN = TLK_BIT(2),
    FLD_TXFIFO0_IRQ_EN = TLK_BIT(4),
    FLD_TXFIFO1_IRQ_EN = TLK_BIT(5),
    FLD_TXFIFO2_IRQ_EN = TLK_BIT(6),
};

/**
 * BIT[0:1] i2s0 out mode select:2'd0:16bit mono;2'd1:20bit/24bit mono;2'd2:16bit
 * stereo;2'd3:20bit/24bit stereo. BIT[2:3] i2s1 out mode select:2'd0:16bit mono;2'd1:20bit/24bit
 * mono;2'd2:16bit stereo;2'd3:20bit/24bit stereo. BIT[4:5] i2s2 out mode select:2'd0:16bit
 * mono;2'd1:20bit/24bit mono;2'd2:16bit stereo;2'd3:20bit/24bit stereo.
 */
#define reg_i2s_aout_mode REG_ADDR8(AUDIO_DFIFO_REG_BASE + 0x42)

enum
{
    FLD_I2S0_AOUT_MODE = TLK_BIT_RNG(0, 1),
    FLD_I2S1_AOUT_MODE = TLK_BIT_RNG(2, 3),
    FLD_I2S2_AOUT_MODE = TLK_BIT_RNG(4, 5),
...
enum
{
    FLD_TXFIFO_TRIG_NUM = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RXFIFO0_OVERRUN  = TLK_BIT(0),
    FLD_RXFIFO1_OVERRUN  = TLK_BIT(1),
    FLD_RXFIFO2_OVERRUN  = TLK_BIT(2),
    FLD_TXFIFO0_UNDERRUN = TLK_BIT(4),
    FLD_TXFIFO1_UNDERRUN = TLK_BIT(5),
    FLD_TXFIFO2_UNDERRUN = TLK_BIT(6),
};
...
enum
{
    FLD_I2S2_TDM_AIN_MODE  = TLK_BIT_RNG(0, 1),
    FLD_I2S2_TDM_AOUT_MODE = TLK_BIT_RNG(2, 3),
};
...
enum
{
    FLD_I2S0_2FIFO_MODE = TLK_BIT(0),
    FLD_I2S1_2FIFO_MODE = TLK_BIT(1),
    FLD_I2S2_2FIFO_MODE = TLK_BIT(2),
};
...
enum
{
    FLD_TXFIFO_NUML = TLK_BIT_RNG(0, 3),
    FLD_TXFIFO_NUMH = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_TXFIFO_MUN = TLK_BIT_RNG(0, 3),
};
...
/**
 * BIT[0] clearing the rxfifo0 threshold interrupt and determining the status of the threshold
 * interrupt. BIT[1] clearing the rxfifo1 threshold interrupt and determining the status of the
 * threshold interrupt. BIT[2] clearing the rxfifo2 threshold interrupt and determining the status
 * of the threshold interrupt. BIT[3] clearing the txfifo0 threshold interrupt and determining the
 * status of the threshold interrupt. BIT[4] clearing the txfifo1 threshold interrupt and
 * determining the status of the threshold interrupt. BIT[5] clearing the txfifo2 threshold
 * interrupt and determining the status of the threshold interrupt.
 */
#define reg_fifo_irq REG_ADDR8(AUDIO_DFIFO_REG_BASE + 0x68)

enum
{
    FLD_RXFIFO0_IRQ = TLK_BIT(0),
    FLD_RXFIFO1_IRQ = TLK_BIT(1),
    FLD_RXFIFO2_IRQ = TLK_BIT(2),
    FLD_TXFIFO0_IRQ = TLK_BIT(3),
    FLD_TXFIFO1_IRQ = TLK_BIT(4),
    FLD_TXFIFO2_IRQ = TLK_BIT(5),
};
...
enum
{
    FLD_RXFIFO0_TH_IRQ = TLK_BIT(0),
    FLD_RXFIFO1_TH_IRQ = TLK_BIT(1),
    FLD_RXFIFO2_TH_IRQ = TLK_BIT(2),
    FLD_TXFIFO0_TH_IRQ = TLK_BIT(3),
    FLD_TXFIFO1_TH_IRQ = TLK_BIT(4),
    FLD_TXFIFO2_TH_IRQ = TLK_BIT(5),
};
...
enum
{
    FLD_RXFIFO0_TH_IRQ_EN = TLK_BIT(0),
    FLD_RXFIFO1_TH_IRQ_EN = TLK_BIT(1),
    FLD_RXFIFO2_TH_IRQ_EN = TLK_BIT(2),
    FLD_TXFIFO0_TH_IRQ_EN = TLK_BIT(3),
    FLD_TXFIFO1_TH_IRQ_EN = TLK_BIT(4),
    FLD_TXFIFO2_TH_IRQ_EN = TLK_BIT(5),
};
...
enum
{
    FLD_ACLK_DBG_OPEN = TLK_BIT(0),
    FLD_I2S0_CLK_DBG  = TLK_BIT(1),
    FLD_I2S1_CLK_DBG  = TLK_BIT(2),
    FLD_I2S2_CLK_DBG  = TLK_BIT(3),
    FLD_ADC_CLK6M_DBG = TLK_BIT(4),
    FLD_ADC_CLK1M_DBG = TLK_BIT(5),
    FLD_CODEC_CLK_DBG = TLK_BIT(6),
};
...
enum
{
    FLD_HPF_EN         = TLK_BIT(0),
    FLD_R_CK_SEL       = TLK_BIT(1),
    FLD_SFT_ZC         = TLK_BIT(2),
    FLD_SRAM_CE_MANUAL = TLK_BIT(3),
    FLD_DATI_SOFT_MUTE = TLK_BIT(4),
    FLD_DATO_SOFT_MUTE = TLK_BIT(5),
};
...
enum
{
    FLD_CLK_USB      = TLK_BIT(0),
    FLD_CLK_SR       = TLK_BIT_RNG(1, 5),
    FLD_CLK_DIV2     = TLK_BIT(6),
    FLD_CODEC_CLK_EN = TLK_BIT(7),
};
...
enum
{
    FLD_ALCL    = TLK_BIT_RNG(0, 3),
    FLD_MAXGAIN = TLK_BIT_RNG(4, 6),
};
...
enum
{
    FLD_HLD    = TLK_BIT_RNG(0, 3),
    FLD_ALCSEL = TLK_BIT_RNG(5, 6),
};
...
enum
{
    FLD_ATK = TLK_BIT_RNG(0, 3),
    FLD_DCY = TLK_BIT_RNG(4, 7),
};
 ...
 * BIT[3:7] noise gate threshold value,1.5db
 step;5'b00000:-76.5dbFS...5'b11110:-31.5dbFS;5'b11111:-30dbFS
 */
...
{
    FLD_NGAT = TLK_BIT(0),
    FLD_NGG  = TLK_BIT_RNG(1, 2),
    FLD_NGTH = TLK_BIT_RNG(3, 7),
};
...
enum
{
    FLD_MINGAIN       = TLK_BIT_RNG(0, 2),
    FLD_DMIC_CLK_SEL  = TLK_BIT(4),
    FLD_CODEC_TRIG_EN = TLK_BIT(5),
    FLD_CODEC_DIS_EN  = TLK_BIT(6),
    FLD_SCHDL_EN      = TLK_BIT(7),
};
...
enum
{
    FLD_I2S_BCM_BITS     = TLK_BIT_RNG(0, 1),
    FLD_I2S_CLK_EN       = TLK_BIT(2),
    FLD_I2S_CLK_DIV2     = TLK_BIT(3),
    FLD_I2S_BLCKINV_O    = TLK_BIT(4),
    FLD_I2S_ADC_DCI_MS   = TLK_BIT(5),
    FLD_I2S_DAC_DCI_MS   = TLK_BIT(6),
    FLD_I2S_ADC_FRM_LOOP = TLK_BIT(7),
};
...
enum
{
    FLD_I2S_ADC_MBCLK_LOOP = TLK_BIT(0),
    FLD_I2S_DAC_MBCLK_LOOP = TLK_BIT(1),
    FLD_FRM_INV            = TLK_BIT(2),
    FLD_I2S_WL             = TLK_BIT_RNG(3, 4),
    I2S_FORMAT             = TLK_BIT_RNG(5, 7),
};
 ...
 * BIT[6] i2s dsp mode select:DSP mode select when i2s DSP format or LRCLK invert operation :1'b1:
 * dsp mode A;1'b0: dsp mode B; 1'b1: LRCLK invert;1'b0: not invert. BIT[7] dac frm loop from pad.
 */
#define reg_i2s_cfg3(i) REG_ADDR8((I2S0_BASE + 0x02) + (i * 0x20))

enum
{
    FLD_I2S_LRSWAP         = TLK_BIT(0),
    FLD_RX_2LANE_ENABLE    = TLK_BIT(1),
    FLD_TX_2LANE_ENABLE    = TLK_BIT(2),
    FLD_I2S_DAC_FRM_ENABLE = TLK_BIT(3),
    FLD_I2S_ADC_FRM_ENABLE = TLK_BIT(4),
    FLD_I2S_TX_DAT_SEL     = TLK_BIT(5),
    FLD_I2S_LRP            = TLK_BIT(6),
    FLD_I2S_DAC_FRM_LOOP   = TLK_BIT(7),
};
...
enum
{
    FLD_I2S_MODE         = TLK_BIT_RNG(0, 1),
    FLD_I2S_PAD_BCLK_SEL = TLK_BIT(2),
    FLD_I2S_REX_BIT_SEL  = TLK_BIT(3),
    FLD_I2S_SCHEDULE_EN  = TLK_BIT(4),
    FLD_ASCL_BYPASS      = TLK_BIT(5),
    FLD_PEM_TRIG_EN_0    = TLK_BIT(6),
    FLD_PEM_DIS_EN_0     = TLK_BIT(7),
};
...
enum
{
    FLD_RX_DSP_START_SEL = TLK_BIT(6),
};
...
enum
{
    FLD_I2S_DACTUNE_L1 = TLK_BIT_RNG(0, 3),
    FLD_I2S_DACTUNE_L2 = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_I2S_ADCTUNE_L1 = TLK_BIT_RNG(0, 3),
    FLD_I2S_ADCTUNE_L2 = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_TXFIFO_LESSL1 = TLK_BIT(0),
    FLD_TXFIFO_LESSL2 = TLK_BIT(1),
    FLD_TXFIFO_MOREL1 = TLK_BIT(2),
    FLD_TXFIFO_MOREL2 = TLK_BIT(3),
    FLD_RXFIFO_LESSL1 = TLK_BIT(4),
    FLD_RXFIFO_LESSL2 = TLK_BIT(5),
    FLD_RXFIFO_MOREL1 = TLK_BIT(6),
    FLD_RXFIFO_MOREL2 = TLK_BIT(7),
};
...
enum
{
    FLD_I2S_ALIGN_EN   = TLK_BIT(0),
    FLD_I2S_ALIGN_CTRL = TLK_BIT_RNG(1, 3),
    FLD_I2S_ALIGN_MASK = TLK_BIT(4),
    FLD_I2S_CLK_SEL    = TLK_BIT(5),
};

/**
 * BIT[0:1] configure the number of i2s2 tdm rx channel: 2'b00 2channel, 2'b01 4channel,2'b10
 * 6channel,2'b11 8channel. BIT[2:3] configure the number of i2s2 tdm tx channel 2'b00 2channel,
 * 2'b01 4channel,2'b10 6channel,2'b11 8channel. BIT[4:5] i2s2 TDM mode:2'b00: TDM_mode_a2'b01:
 * TDM_mode_b2'b10: TDM_mode_c. BIT[6:7] i2s tdm slot:2'b00 16 BCLK wide  2'b01 24  BCLK wide 2'b10
 * 32 BCLK wide.
 */
...
enum
{
    FLD_I2S2_TDM_RX_CH_NUM = TLK_BIT_RNG(0, 1),
    FLD_I2S2_TDM_TX_CH_NUM = TLK_BIT_RNG(2, 3),
    FLD_I2S2_TDM_MODE      = TLK_BIT_RNG(4, 5),
    FLD_I2S_TDM_SLOT       = TLK_BIT_RNG(6, 7),
};
...
{
    FLD_MONO            = TLK_BIT(0),
    FLD_ASCL_FORMAT_SEL = TLK_BIT(1),
    FLD_SDMPEN          = TLK_BIT(2),
    FLD_ISOPEN          = TLK_BIT(3),
    FLD_PEM_TRIG_EN_1   = TLK_BIT(4),
    FLD_PEM_DIS_EN_1    = TLK_BIT(5),
    FLD_SDMGRP          = TLK_BIT(6),
    FLD_HPF             = TLK_BIT(7),
};
...
enum
{
    FLD_VOL_0  = TLK_BIT_RNG(0, 6),
    FLD_MUTE_0 = TLK_BIT(7),
};

/**
 * BIT[0] 1'b1:not multiply 2 when PWM;1'b0:multiply 2
 * BIT[1] PWM enable.
 * BIT[2] select either linear interpolation or delay interpolation for the rate matching
 * block.1'b1: linear interpolation. BIT[3] left 1'b1:4 bit output; 1'b0:1 bit output BIT[4] right
 * 1'b1:4 bit output; 1'b0:1 bit output BIT[5] left shapping enable. BIT[6] right shapping enable.
 */
...
enum
{
    FLD_NOX2   = TLK_BIT(0),
    FLD_PWM    = TLK_BIT(1),
    FLD_LINE_0 = TLK_BIT(2),
    FLD_YSEL_L = TLK_BIT(3),
    FLD_YSEL_R = TLK_BIT(4),
    FLD_SHAP_L = TLK_BIT(5),
    FLD_SHAP_R = TLK_BIT(6),
};

#define reg_step_tune_0 REG_ADDR32(ASCL0_SDM_BASE + 0x04)

/**
 * BIT[0:7] reg_tune_0[7:0] tune step for rate matching block,to adjust step value when fifo almost
 * full or empty.
 */
...
enum
{
    FLD_AFIFO_CLR         = TLK_BIT(0),
    FLD_SDM_AFIFO_OVERRUN = TLK_BIT(1),
    FLD_SDM_FIFO_EMPTY    = TLK_BIT(2),
    FLD_SDM_DATA_SYNC_SEL = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FDL_PN1_BITS_L = TLK_BIT_RNG(0, 4),
    FLD_PN_SEL_L   = TLK_BIT_RNG(5, 6),
};
...
enum
{
    FLD_PN2_BITS_L = TLK_BIT_RNG(0, 4),
    FLD_PN_SEL_R   = TLK_BIT_RNG(5, 6),
};
...
enum
{
    FLD_PN1_R       = TLK_BIT_RNG(0, 4),
    FLD_CHANNEL_CHG = TLK_BIT(5),
};
...
enum
{
    FLD_PN2_BITS_R  = TLK_BIT_RNG(0, 4),
    FLD_CONST_SEL_L = TLK_BIT(5),
    FLD_CONST_SEL_R = TLK_BIT(6),
};
...
enum
{
    FLD_MONO_12            = TLK_BIT(0),
    FLD_ASCL_FORMAT_SEL_12 = TLK_BIT(1),
    FLD_HPF_12             = TLK_BIT(7),
};
...
enum
{
    FLD_VOL_12  = TLK_BIT_RNG(0, 6),
    FLD_MUTE_12 = TLK_BIT(7),
};
...
enum
{
    FLD_LINE_12 = TLK_BIT(2),
};

#define reg_step_tune_12(i) REG_ADDR32((ASCL1_BASE + 0x04) + (i * 0x08))

/**
 * BIT[0:7] reg_tune_12[7:0] tune step for rate matching block,to adjust step value when fifo almost
 * full or empty.
 */
