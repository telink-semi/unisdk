...
enum
{
    ...
    FLD_TRNG_CR0_ROSEN2 = TLK_BIT(5),
    FLD_TRNG_CR0_ROSEN1 = TLK_BIT(6),
    FLD_TRNG_CR0_ROSEN0 = TLK_BIT(7),
};
...
enum
{
    FLD_RBG_SR_HTF   = TLK_BIT(0),
    FLD_RBG_SR_DRDY  = TLK_BIT(1),
    FLD_RBG_SR_ERERR = TLK_BIT(2),
};
