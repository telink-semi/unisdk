...
enum
{
    FLD_USB_CTRL_AUTO_CLK = TLK_BIT(0),
    FLD_USB_CTRL_LOW_SPD  = TLK_BIT(1),
    FLD_USB_CTRL_LOW_JITT = TLK_BIT(2),
    FLD_USB_CTRL_TST_MODE = TLK_BIT(3),
    FLD_USB_CTRL_CLK_SEL  = TLK_BIT_RNG(4, 7),
};
