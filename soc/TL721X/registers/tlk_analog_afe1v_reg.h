...
enum
{
    FLD_LOCK_DET_SIG_ENABLE = TLK_BIT(7), //lock detect enable signal
};
...
enum
{
    FLD_LOCK_DET_SIG_RESET = TLK_BIT(7), //lock detect reset signal
};
...
enum
{
    FLD_BBPLL_LOCK_DETECTOR = TLK_BIT(5),

    FLD_XO_READY_ANA = TLK_BIT(7),
};
...
enum
{
    FLD_XO_DYN_CAP_ANA = TLK_BIT(1), //Cap control to optimize the startup time.

    FLD_XO_CNT_OFF_ANA = TLK_BIT(3), //Disable xo counter
};
...
enum
{
    FLD_XO_EN_CLK_ANA = TLK_BIT(1), //xtal_24M clock to analog   0:turn off  1:turn on   default :0
};
...
enum
{
    FLD_AUDIO_PD_ENABLE_0R6 = TLK_BIT(0),
    FLD_AUDIO_PD_INPPGA     = TLK_BIT(3),
    FLD_AUDIO_PD_PGABUF     = TLK_BIT(4),
    FLD_AUDIO_PD_PGABOOST   = TLK_BIT(5),
    FLD_AUDIO_PD_ASDM       = TLK_BIT(6),
    FLD_AUDIO_PD_BIAS       = TLK_BIT(7),
};
