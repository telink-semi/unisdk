...
enum
{
    FLD_ENABLE_LOCK_DET_BBPLL        = TLK_BIT(5),
    FLD_POWER_ON_BBPLL_SUPPLY_SWITCH = TLK_BIT(7),
};
...
enum
{
    FLD_XO_READY_ANA        = TLK_BIT(1),
    FLD_BBPLL_LOCK_DETECTOR = TLK_BIT(2),
};
...
enum
{
    FLD_XO_LDO_FORCE_ANA  = TLK_BIT(0),
    FLD_XO_EN_CLK_ANA_ANA = TLK_BIT(1),
    FLD_AUDIO_DEM_EN      = TLK_BIT(2),
    FLD_AUDIO_A_DITHER    = TLK_BIT_RNG(3, 4),
    FLD_AUDIO_EN_DITHER   = TLK_BIT(5),
    FLD_AUDIO_DITHER_IN   = TLK_BIT(6),
    FLD_AUDIO_LV_EN       = TLK_BIT(7),
};
...
enum
{
    FLD_AUDIO_IBSEL      = TLK_BIT_RNG(0, 1),
    FLD_AUDIO_MUTE_PGA   = TLK_BIT(2),
    FLD_AUDIO_INMUTE_PGA = TLK_BIT(3),
    FLD_AUDIO_PGAVOL_IN  = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_AUDIO_FILTCAP_CTL = TLK_BIT_RNG(0, 1),
    FLD_AUDIO_VMIDSEL     = TLK_BIT_RNG(2, 3),
    FLD_AUDIO_PD_PGA      = TLK_BIT(4),
    FLD_AUDIO_PD_BIAS     = TLK_BIT(5),
    FLD_AUDIO_PD_ADC      = TLK_BIT(6),
    FLD_AUDIO_PD_VMID     = TLK_BIT(7),
};
...
enum
{
    FLD_AUDIO_ADC_LOW_POWER_MODE = TLK_BIT_RNG(0, 2),
    FLD_AUDIO_PGA_LOW_POWER_MODE = TLK_BIT(3),
};
...
enum
{
    FLD_CAL_32K_DONE = TLK_BIT(6),
    FLD_CAL_24M_DONE = TLK_BIT(7),
};
