...
/**
 * BIT[0:1] sdm out mode select:2'd0:16bit mono;2'd1:20bit/24bit mono;2'd2:16bit
...
enum
{
    FLD_MONO_1            = TLK_BIT(0),
    FLD_ASCL_FORMAT_SEL_1 = TLK_BIT(1),
    FLD_HPF_1             = TLK_BIT(7),
};
...
enum
{
    FLD_VOL_1  = TLK_BIT_RNG(0, 6),
    FLD_MUTE_1 = TLK_BIT(7),
};
...
enum
{
    FLD_LINE_1 = TLK_BIT(2),
};

#define reg_step_tune_1(i) REG_ADDR32((ASCL1_BASE + 0x04) + (i * 0x08))

/**
 * BIT[0:7] reg_tune_1[7:0] tune step for rate matching block,to adjust step value when fifo almost
 * full or empty.
 */
