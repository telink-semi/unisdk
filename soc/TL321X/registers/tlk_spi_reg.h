 ...
 * BIT[4]  set xip write address format 0:single mode  1:the format of addr phase is the same as the
 * data phase(Dual/Quad),XIP ONLY BIT[5]  1:enable xip write addr phase, XIP ONLY. BIT[6]  xip write
 * cmd format 0: single mode  1: the format of the cmd phase is the same as the data
...
typedef enum
{
    FLD_SPI_XIP_WR_DATA_IO_MODE = TLK_BIT_RNG(0, 1),
