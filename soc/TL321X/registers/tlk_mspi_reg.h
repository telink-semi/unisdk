...
enum
{
    FLD_MSPI_RXFIFO_INT_EN = TLK_BIT(2),
    FLD_MSPI_TXFIFO_INT_EN = TLK_BIT(3),
    FLD_MSPI_END_INT_EN    = TLK_BIT(4),
    FLD_MSPI_RX_DMA_EN     = TLK_BIT(6),
    FLD_MSPI_TX_DMA_EN     = TLK_BIT(7),
};
...
enum
{
    FLD_MSPI_CS2SCLK = TLK_BIT_RNG(0, 2),
    FLD_MSPI_CSHT    = TLK_BIT_RNG(3, 7),
};
...
enum
{
    FLD_MSPI_DUAL     = TLK_BIT(0),
    FLD_MSPI_DUAD     = TLK_BIT(1),
    FLD_MSPI_ADDR_LEN = TLK_BIT_RNG(2, 3),
    FLD_MSPI_ADDR_FMT = TLK_BIT(4),
    FLD_MSPI_ADDR_EN  = TLK_BIT(5),
    FLD_MSPI_CMD_FMT  = TLK_BIT(6),
    FLD_MSPI_CMD_EN   = TLK_BIT(7),
};
...
enum
{
    FLD_MSPI_DUMMY     = TLK_BIT_RNG(0, 3),
    FLD_MSPI_TRANSMODE = TLK_BIT_RNG(4, 7),
};

#define reg_mspi_ctrl REG_ADDR16(MSPI_BASE_ADDR + 0x08)

/**
 * This is a special control register for register reading flash, XIP read flash can not be used, so
 * "_reg" is added.
 */
...
enum
{
    FLD_MSPI_LSB       = TLK_BIT(0),
    FLD_MSPI_3LINE     = TLK_BIT(1),
    FLD_MSPI_WORK_MODE = TLK_BIT_RNG(2, 3),

    FLD_MSPI_DMATX_EOF_CLRTXFIFO_EN = TLK_BIT(5),
    FLD_MSPI_DMARX_EOF_CLRRXFIFO_EN = TLK_BIT(6),
    FLD_MSPI_AUTO_HRREADY_EN        = TLK_BIT(7),
};
...
enum
{
    FLD_MSPI_TXFIFO_THRES = TLK_BIT_RNG(0, 5),
};
...
enum
{
    FLD_MSPI_RXFIFO_THRES = TLK_BIT_RNG(0, 5),
};
...
enum
{
    FLD_MSPI_XIP_STOP      = TLK_BIT(2),
    FLD_MSPI_XIP_ENABLE    = TLK_BIT(3),
    FLD_MSPI_DUMMY_CNT_ADD = TLK_BIT_RNG(4, 7),
};

/**
 * BIT[0:7]  Use this combined with xip_mode being xip sequential mode.default page boundary size is
 * 32byte, 2^page_size.
 */
...
enum
{
    FLD_MSPI_TXFIFO_ENTRIES = TLK_BIT_RNG(0, 6),
    FLD_MSPI_TXFIFO_FULL    = TLK_BIT(7),
};
...
enum
{
    FLD_MSPI_RXFIFO_ENTRIES = TLK_BIT_RNG(0, 6),
    FLD_MSPI_RXFIFO_EMPTY   = TLK_BIT(7),
};
...
enum
{
    FLD_MSPI_SOFT_RESET       = TLK_BIT(2),
    FLD_MSPI_XIP_REG_ARB_ERR  = TLK_BIT(3),
    FLD_MSPI_RXFIFO_CLR_LEVEL = TLK_BIT(4),
    FLD_MSPI_TXFIFO_CLR_LEVEL = TLK_BIT(5),
    FLD_MSPI_BUSY             = TLK_BIT(7),
};
...
enum
{
    FLD_MSPI_RXF_THRES_INT_STA = TLK_BIT(2),
    FLD_MSPI_TXF_THRES_INT_STA = TLK_BIT(3),
    FLD_MSPI_TRANS_END_INT_STA = TLK_BIT(4),
};
...
enum
{
    FLD_MSPI_XIP_RD_DUAL  = TLK_BIT(0),
    FLD_MSPI_XIP_RD_QUAD  = TLK_BIT(1),
    FLD_MSPI_XIP_ADDR_LEN = TLK_BIT_RNG(2, 3),
    FLD_MSPI_XIP_ADDR_FMT = TLK_BIT(4),
    FLD_MSPI_XIP_ADDR_EN  = TLK_BIT(5),
    FLD_MSPI_XIP_CMD_FMT  = TLK_BIT(6),
    FLD_MSPI_XIP_CMD_EN   = TLK_BIT(7),
};
...
enum
{
    FLD_MSPI_XIP_RD_DUMMY_CNT = TLK_BIT_RNG(0, 3),
    FLD_MSPI_XIP_RD_TRANSMODE = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_XIP_CMD1_EN          = TLK_BIT(0),
    FLD_XIP_TOKEN_VAL_SEL    = TLK_BIT(1),
    FLD_XIP_TOKEN_EN         = TLK_BIT(2),
    FLD_XIP_RD_DUMMY_CNT_ADD = TLK_BIT(3),
    FLD_XIP_DDR_MODE         = TLK_BIT(4),
    FLD_XIP_PAGE_MODE_EN     = TLK_BIT(5),
    FLD_XIP_TIMEOUT_MODE_EN  = TLK_BIT(6),
    FLD_XIP_TCEM_MODE_EN     = TLK_BIT(7),
};
...
enum
{
    FLD_MSPI_XIP_WR_DUAL     = TLK_BIT(0),
    FLD_MSPI_XIP_WR_QUAD     = TLK_BIT(1),
    FLD_MSPI_XIP_WR_ADDR_LEN = TLK_BIT_RNG(2, 3),
    FLD_MSPI_XIP_WR_ADDR_FMT = TLK_BIT(4),
    FLD_MSPI_XIP_WR_ADDR_EN  = TLK_BIT(5),
    FLD_MSPI_XIP_WR_CMD_FMT  = TLK_BIT(6),
    FLD_MSPI_XIP_WR_CMD_EN   = TLK_BIT(7),
};
...
enum
{
    FLD_MSPI_XIP_WR_DUMMY_CNT = TLK_BIT_RNG(0, 3),
    FLD_MSPI_XIP_WR_TRANSMODE = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_MSPI_XIP_CMD1_EN = TLK_BIT(0),
};
...
enum
{
    FLD_MSPI_XIP0_END_ADDR = TLK_BIT_RNG(0, 1),
    FLD_MSPI_XIP1_END_ADDR = TLK_BIT_RNG(2, 3),
    FLD_MSPI_XIP2_END_ADDR = TLK_BIT_RNG(4, 5),
    FLD_MSPI_XIP3_END_ADDR = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_MSPI_CIPHER_RD_EN = TLK_BIT(0),
    FLD_MSPI_CIPHER_WR_EN = TLK_BIT(1)
};
