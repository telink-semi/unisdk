...
enum
{
    FLD_EP_DAT_ACK     = TLK_BIT(0),
    FLD_EP_DAT_BUSY    = TLK_BIT(0),
    FLD_EP_DAT_STALL   = TLK_BIT(1),
    FLD_EP_STA_ACK     = TLK_BIT(2),
    FLD_EP_STA_STALL   = TLK_BIT(3),
    FLD_EP_IRQ_SETADDR = TLK_BIT(6),
};
...
enum
{
    FLD_USB_IRQ_RESET_STATUS   = TLK_BIT(0),
    FLD_USB_IRQ_250US_STATUS   = TLK_BIT(1),
    FLD_USB_IRQ_SUSPEND_STATUS = TLK_BIT(2),
    FLD_USB_IRQ_SOF_STATUS     = TLK_BIT(3),
    FLD_CTRL_EP_IRQ_SETUP      = TLK_BIT(4),
    FLD_CTRL_EP_IRQ_DATA       = TLK_BIT(5),
    FLD_CTRL_EP_IRQ_STA        = TLK_BIT(6),
    FLD_CTRL_EP_IRQ_INTF       = TLK_BIT(7),
};
...
enum
{
    FLD_CTRL_EP_AUTO_ADDR = TLK_BIT(0),
    FLD_CTRL_EP_AUTO_CFG  = TLK_BIT(1),
    FLD_CTRL_EP_AUTO_INTF = TLK_BIT(2),
    FLD_CTRL_EP_AUTO_STA  = TLK_BIT(3),
    FLD_CTRL_EP_AUTO_SYN  = TLK_BIT(4),
    FLD_CTRL_EP_AUTO_DESC = TLK_BIT(5),
    FLD_CTRL_EP_AUTO_FEAT = TLK_BIT(6),
    FLD_CTRL_EP_AUTO_STD  = TLK_BIT(7),
};
...
typedef enum
{
    FLD_USB_AUTO_HALT_CLR    = TLK_BIT(0), /* enable auto clear halt feature(STALL) after either a SetConfiguration() or SetInterface() */
    FLD_USB_AUTO_HALT_STALL  = TLK_BIT(1), /* enable auto decoding the halt feature(STALL) by hardware */
    FLD_USB_AUTO_HALT_TOGGLE = TLK_BIT(2), /* enable auto decoding the data toggle */
    FLD_USB_AUTO_WKUP_FEA    = TLK_BIT(3), /* enable auto decoding the wakeup feature command */
} usb_hw_feature_e;
...
enum
{
    FLD_USB_CTR_EP_SIZE      = TLK_BIT_RNG(0, 1), /* 0-8bytes,1-16bytes,2-32bytes,3-64bytes, */
    FLD_USB_CTR_EP_LENS      = TLK_BIT_RNG(2, 3),
    FLD_USB_IRQ_RESET_LVL    = TLK_BIT(4),
    FLD_USB_IRQ_250US_LVL    = TLK_BIT(5),
    FLD_USB_IRQ_SETADDR_MASK = TLK_BIT(6),
    FLD_USB_IRQ_SOF_LVL      = TLK_BIT(7),
};
...
enum
{
    FLD_USB_MDEV_SELF_PWR     = TLK_BIT(0),
    FLD_USB_MDEV_SET_WAKE_FEA = TLK_BIT(1),
    FLD_USB_MDEV_WAKE_FEA     = TLK_BIT(2),
    FLD_USB_MDEV_VEND_CMD     = TLK_BIT(3),
    FLD_USB_MDEV_VEND_DIS     = TLK_BIT(4),
    FLD_USB_MDEV_MODEL_SEL    = TLK_BIT_RNG(5, 6),
    FLD_USB_CONFIG_NOW        = TLK_BIT(7),
};
...
enum
{
    FLD_USB_ADDRESS      = TLK_BIT_RNG(0, 6),
    FLD_USB_SET_ADDR_ERR = TLK_BIT(7),
};
...
enum
{
    FLD_USB_SUSPEND_CNT  = TLK_BIT_RNG(0, 4),
    FLD_USB_CTR_EP_STALL = TLK_BIT(5),
    FLD_USB_HOLD0        = TLK_BIT_RNG(6, 7)
};
...
typedef enum
{
    FLD_USB_EDP8_EN = TLK_BIT(0), // printer
    FLD_USB_EDP1_EN = TLK_BIT(1), // keyboard
    FLD_USB_EDP2_EN = TLK_BIT(2), // mouse
    FLD_USB_EDP3_EN = TLK_BIT(3),
    FLD_USB_EDP4_EN = TLK_BIT(4),
    FLD_USB_EDP5_EN = TLK_BIT(5), // printer
    FLD_USB_EDP6_EN = TLK_BIT(6), // audio
    FLD_USB_EDP7_EN = TLK_BIT(7), // audio
} usb_ep_en_e;
...
enum
{
    FLD_USB_IRQ_RESET_MASK   = TLK_BIT(0),
    FLD_USB_IRQ_250US_MASK   = TLK_BIT(1),
    FLD_USB_IRQ_SUSPEND_MASK = TLK_BIT(2),
    FLD_USB_IRQ_SOF_MASK     = TLK_BIT(3),
    FLD_USB_IRQ_SETUP_MASK   = TLK_BIT(4),
    FLD_USB_IRQ_DATA_MASK    = TLK_BIT(5),
    FLD_USB_IRQ_STATUS_MASK  = TLK_BIT(6),
    FLD_USB_IRQ_SETINF_MASK  = TLK_BIT(7),
};
...
enum
{
    FLD_USB_EP_ACK     = TLK_BIT(0),
    FLD_USB_EP_BUSY    = TLK_BIT(0), // read only
    FLD_USB_EP_STALL   = TLK_BIT(1),
    FLD_USB_EP_DAT0    = TLK_BIT(2),
    FLD_USB_EP_DAT1    = TLK_BIT(3),
    FLD_USB_EP_MONO    = TLK_BIT(6),
    FLD_USB_EP_EOF_ISO = TLK_BIT(7),
};
...
typedef enum
{
    FLD_USB_EDP8_IRQ = TLK_BIT(0),
    FLD_USB_EDP1_IRQ = TLK_BIT(1),
    FLD_USB_EDP2_IRQ = TLK_BIT(2),
    FLD_USB_EDP3_IRQ = TLK_BIT(3),
    FLD_USB_EDP4_IRQ = TLK_BIT(4),
    FLD_USB_EDP5_IRQ = TLK_BIT(5),
    FLD_USB_EDP6_IRQ = TLK_BIT(6),
    FLD_USB_EDP7_IRQ = TLK_BIT(7),
} usb_ep_irq_e;
...
enum
{
    FLD_USB_ENP8_FIFO_MODE = TLK_BIT(0),
    FLD_USB_ENP8_FULL_FLAG = TLK_BIT(1),
    FLD_USB_RMODE00        = TLK_BIT(2),
    FLD_USB_ENP8_EOF       = TLK_BIT(3),
    FLD_USB_ENP8_DMA_EOF   = TLK_BIT_RNG(4, 6),
};
...
enum
{
    FLD_USB_CEN_PWR_DN = TLK_BIT(0),
    FLD_USB_CLK_PWR_DN = TLK_BIT(1),
    FLD_USB_WEN_PWR_DN = TLK_BIT(3),
    FLD_USB_CEN_FUNC   = TLK_BIT(4),
};
...
enum
{
    FLD_CTRL_EP8_SEND_THRES_H = TLK_BIT_RNG(0, 2),
    FLD_USB_EDP_MAP_MANUAL_EN = TLK_BIT(3),
    FLD_USB_EDP_MAP_AUTO_EN   = TLK_BIT(4),
    FLD_USB_EDPS_SM_MAP_EN    = TLK_BIT(5),
    FLD_USB_EDPS_MAP_TGL_EN   = TLK_BIT(6),
    FLD_USB_GET_STA_MAP_EN    = TLK_BIT(7),
};
...
enum
{
    FLD_USB_PEM_EVENT_EN  = TLK_BIT(0),
    FLD_USB_PEM_EVENT_SEL = TLK_BIT(1),
};
