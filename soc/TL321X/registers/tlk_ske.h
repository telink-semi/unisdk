#ifndef TLK_TLK_SKE_REGISTERS_H_
#define TLK_TLK_SKE_REGISTERS_H_

#include <stdint.h>
#include <common/include/tlk_bit.h>

typedef enum tlk_ske_control_e {
    TLK_SKE_CONTROL_START = TLK_BIT(0),
} tlk_ske_control_e;

typedef enum tlk_ske_config_e {
    TLK_SKE_CONFIG_DEC    = TLK_BIT(11),
    TLK_SKE_CONFIG_UP_CFG = TLK_BIT(12),
    TLK_SKE_CONFIG_DMA_EN = TLK_BIT(16),
    TLK_SKE_CONFIG_IRQ_EN = TLK_BIT(17),
} tlk_ske_config_e;

typedef enum tlk_ske_status1_e {
    TLK_SKE_STATUS1_BUSY = TLK_BIT(0),
} tlk_ske_status1_e;

typedef enum tlk_ske_status2_e {
    TLK_SKE_STATUS2_CORE_DONE = TLK_BIT(0),
} tlk_ske_status2_e;

typedef enum tlk_ske_data_in_control_e {
    TLK_SKE_DATA_IN_CONTROL_LAST = TLK_BIT(16),
} tlk_ske_data_in_control_e;
...
typedef struct __attribute__((packed)) {
    union {
        ...
        struct {
            enum tlk_ske_control_e __attribute__((packed)) control : 8;
        }; // address: 0x80104000, offset: 0x0
    };
    ...
    union {
        ...
        struct {
            enum tlk_ske_config_e __attribute__((packed)) config : 32;
        }; // address: 0x80104004, offset: 0x4
    };
    union {
        struct {
            unsigned busy : 1;
        ...
        struct {
            enum tlk_ske_status1_e __attribute__((packed)) status1 : 8;
        }; // address: 0x80104008, offset: 0x8
    };
    ...
    union {
        ...
        struct {
            enum tlk_ske_status2_e __attribute__((packed)) status2 : 8;
        }; // address: 0x8010400c, offset: 0xc
    };
    ...
    union {
        ...
        struct {
            enum tlk_ske_data_in_control_e __attribute__((packed)) data_in_control : 32;
        }; // address: 0x80104080, offset: 0x80
    };
...
typedef enum tlk_ske_extended_dma_en_e {
    TLK_SKE_EXTENDED_DMA_EN_SKE_TXDMA_EN = TLK_BIT(0),
    TLK_SKE_EXTENDED_DMA_EN_SKE_RXDMA_EN = TLK_BIT(1),
} tlk_ske_extended_dma_en_e;

typedef enum tlk_ske_extended_ske_sp_vld_e {
    TLK_SKE_EXTENDED_SKE_SP_VLD_VALUE = TLK_BIT(0),
} tlk_ske_extended_ske_sp_vld_e;
...
typedef struct __attribute__((packed)) {
    ...
    union {
        ...
        struct {
            enum tlk_ske_extended_dma_en_e __attribute__((packed)) dma_en : 8;
        }; // address: 0x80100824, offset: 0x24
    };
    union {
        struct {
    ...
    union {
        ...
        struct {
            enum tlk_ske_extended_ske_sp_vld_e __attribute__((packed)) ske_sp_vld : 8;
        }; // address: 0x80100826, offset: 0x26
    };
