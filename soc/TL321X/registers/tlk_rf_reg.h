...
enum
{
    FLD_BB_TIMER_IRQ_MASK        = TLK_BIT_RNG(0, 1),
    FLD_BB_TIMER_IRQ_WAIT        = TLK_BIT(2),
    FLD_BB_TIMER_TRIG_PAST_EN    = TLK_BIT(3),
    FLD_BB_TIMER_TIMER_ALIGN     = TLK_BIT(4),
    FLD_BB_TIMER_TIMER_SYN_MODE  = TLK_BIT(5),
    FLD_BB_TIMER_TIMER_PREC_MODE = TLK_BIT_RNG(6, 7),
};
...
typedef enum
{
    FLD_BB_TIMER_IRQ_CLR_BB_TIMER = TLK_BIT(0), // clear IRQ systimer level irq  0x09[0]
    FLD_BB_TIMER_IRQ_CLR_CAL =
        TLK_BIT(1), // calibration latch result update irq (clear 32k cal irq 09[1] )
    FLD_BB_TIMER_CMD_ALIGN_TRIG = TLK_BIT(2), // The system timer alignment function is triggered
} rf_bb_timer_irq_e;
...
enum
{
    FLD_BB_TIMER_32K_WR_EN    = TLK_BIT(0),
    FLD_BB_TIMER_TIMER_EN     = TLK_BIT(1),
    FLD_BB_TIMER_TIMER_AUTO   = TLK_BIT(2),
    FLD_BB_TIMER_32K_TRACK_EN = TLK_BIT(3),
    FLD_BB_TIMER_32K_CAL_MODE = TLK_BIT_RNG(4, 7),
...
enum
{
    ...
    FLD_BB_TIMER_CMD_STOP         = TLK_BIT(1),
    FLD_BB_TIMER_CMD_SYNC         = TLK_BIT(3),
    FLD_BB_TIMER_CLK_32K          = TLK_BIT(4),
    FLD_BB_TIMER_CLR_RD_DONE      = TLK_BIT(5),
    FLD_BB_TIMER_RD_BUSY          = TLK_BIT(6),
    FLD_BB_TIMER_CMD_SET_DLY_DONE = TLK_BIT(7),
...
enum
{
    ...
    FLD_BB_TIMER_PEM_EVENT_EN  = TLK_BIT(3),
    FLD_BB_TIMER_PEM_TASK_0_EN = TLK_BIT(4),
    FLD_BB_TIMER_PEM_TASK_1_EN = TLK_BIT(5),
    FLD_BB_TIMER_R_TMR_MAN_SEL = TLK_BIT(7),
...
enum
{
    FLD_BB_TIMER_SYS_TIMER_ALIGN_COMP = TLK_BIT_RNG(
        0, 4), // Compensation of system timer and system timer bb counters. default:0x10
    FLD_BB_TIMER_HOLD = TLK_BIT(5), // 0x0
};
...
enum
{
    FLD_BB_TIMER_SYS_TIMER_ALIGN_CNT = TLK_BIT_RNG(
        0, 1), // system timer and system timer bb clock count alignment compensation. default:0x1
    FLD_BB_TIMER_SYS_32KTIMER_ALIGN_CNT = TLK_BIT_RNG(
        2,
        3), // system timer and system timer bb 32k clock count alignment compensation. default:0x1
};
...
enum
{
    FLD_BB_DMA_CHANNEL_ENABLE        = TLK_BIT(0),
    FLD_BB_DMA_CHANNEL_TC_MASK       = TLK_BIT(1),
    FLD_BB_DMA_CHANNEL_ERR_MASK      = TLK_BIT(2),
    FLD_BB_DMA_CHANNEL_ABT_MASK      = TLK_BIT(3),
    FLD_BB_DMA_CHANNEL_DST_REQ_SEL   = TLK_BIT_RNG(4, 8),
    FLD_BB_DMA_CHANNEL_SRC_REQ_SEL   = TLK_BIT_RNG(9, 13),
    FLD_BB_DMA_CHANNEL_DST_ADDR_CTRL = TLK_BIT_RNG(14, 15),
    FLD_BB_DMA_CHANNEL_SRC_ADDR_CTRL = TLK_BIT_RNG(16, 17),
    FLD_BB_DMA_CHANNEL_DST_MODE      = TLK_BIT(18),
    FLD_BB_DMA_CHANNEL_SRC_MODE      = TLK_BIT(19),
    FLD_BB_DMA_CHANNEL_DST_WIDTH     = TLK_BIT_RNG(20, 21),
    FLD_BB_DMA_CHANNEL_SRC_WIDTH     = TLK_BIT_RNG(22, 23),
};
...
enum
{
    FLD_BB_DMA_SRC_BURST_SIZE = TLK_BIT_RNG(0, 2),
    FLD_BB_DMA_R_NUM_EN       = TLK_BIT(4),
    FLD_BB_DMA_PRIORITY       = TLK_BIT(5),
    FLD_BB_DMA_W_NUM_EN       = TLK_BIT(6),
    FLD_BB_DMA_AUTO_ENABLE_EN = TLK_BIT(7),
};
...
enum
{
    FLD_BB_DMA_TANS_SIZE0 = TLK_BIT_RNG(0, 15),
};
...
enum
{
    FLD_BB_DMA_TANS_SIZE1 = TLK_BIT_RNG(0, 5),
    FLD_BB_DMA_TANS_IDX   = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_BB_DMA_TX_SIZE     = TLK_BIT_RNG(0, 21),
    FLD_BB_DMA_TX_SIZE_IDX = TLK_BIT_RNG(22, 23),
};
...
enum
{
    FLD_RF_TX_MULTI_EN     = TLK_BIT(0),
    FLD_RF_RX_MULTI_EN     = TLK_BIT(1),
    FLD_RF_CH_0_RNUM_EN_BK = TLK_BIT(2),
    FLD_RF_CH_1_RNUM_EN_BK = TLK_BIT(3),
    FLD_RF_CH1_RX_ERR_EN   = TLK_BIT(4),
    FLD_RF_DMA_REQ_D1_EN   = TLK_BIT(5),
};
...
enum
{
    FLD_BB_DMA_RPTR_MASK = TLK_BIT_RNG(0, 4),
    FLD_BB_DMA_RPTR_SET  = TLK_BIT(5),
    FLD_BB_DMA_RPTR_NEXT = TLK_BIT(6),
    FLD_BB_DMA_RPTR_CLR  = TLK_BIT(7),
};
...
enum
{
    FLD_BB_DMA_WPTR_MASK = TLK_BIT_RNG(0, 4),
};

#define reg_rf_dma_tx_rptr1(i) REG_ADDR8(0x170919 + (i << 1))
#define reg_rf_dma_tx_wptr1(i) REG_ADDR8(0x170918 + (i << 1))

#define reg_rf_bb_rx_size   REG_ADDR16(BB_DMA_BASE_ADDR + 0xf6)
#define reg_rf_bb_rx_size_l REG_ADDR8(BB_DMA_BASE_ADDR + 0xf6)
...
enum
{
    FLD_RF_DMA_EN       = TLK_BIT(0),
    FLD_RF_CRC_EN       = TLK_BIT(1),
    FLD_RF_TX_MODE      = TLK_BIT_RNG(2, 4),
    FLD_RF_TX_TEST_DATA = TLK_BIT(5),
    FLD_RF_TX_TEST_EN   = TLK_BIT(6),
    FLD_RF_BB_DEC       = TLK_BIT(7),
};
...
enum
{
    FLD_RF_ZB_PN_EN         = TLK_BIT(0),
    FLD_RF_TLK_CRYPT_ENABLE = TLK_BIT(1),
    FLD_RF_TLK_MST_SLV      = TLK_BIT(2),
    FLD_RF_V_PN_EN          = TLK_BIT(3),
    FLD_RF_R_CUSTOM_MADE    = TLK_BIT(4),
    FLD_RF_V_INTLV_EN       = TLK_BIT(5),
    FLD_RF_TX_OUT_PLR       = TLK_BIT(6),
    FLD_RF_TX_EN_TGL        = TLK_BIT(6),
};
...
enum
{
    FLD_RF_PREAMBLE_LEN = TLK_BIT_RNG(0, 4),
    FLD_RF_TRAILER_LEN  = TLK_BIT_RNG(5, 7),
};
...
enum
{
    FLD_RF_SLOW_EN     = TLK_BIT(0),
    FLD_RF_SLOW_SEL    = TLK_BIT(1),
    FLD_RF_XMODE_EN    = TLK_BIT(2),
    FLD_RF_REV_ORDER   = TLK_BIT(3),
    FLD_RF_TX_XOR_MODE = TLK_BIT(4),
    FLD_RF_R_DBG_SEL0  = TLK_BIT(5),
    FLD_RF_MODEM1M_PAT = TLK_BIT(6),
    FLD_RF_R_DBG_SEL1  = TLK_BIT(7),
};
...
enum
{
    FLD_RF_HEAD_MODE = TLK_BIT_RNG(0, 2),
    FLD_RF_BLE_1M    = TLK_BIT(4),
    FLD_RF_BLE_WT    = TLK_BIT(5),
    FLD_RF_TX_NOACK  = TLK_BIT(6),
    FLD_RF_PN_AUTO   = TLK_BIT(7),
};
...
enum
{
    FLD_RF_ACC_LEN = TLK_BIT_RNG(0, 2),
    /* RSVD */
    FLD_RF_LR_TX_SEL  = TLK_BIT(4),
    FLD_RF_BLE_LR     = TLK_BIT(5),
    FLD_RF_R_DBG_SEL2 = TLK_BIT(6),
};
...
enum
{
    FLD_RF_TX_ANT_SWITCH = TLK_BIT_RNG(0, 1),
    FLD_RF_RX_ANT_SWITCH = TLK_BIT(2),
    FLD_RF_TEST_TXON     = TLK_BIT(6),
    FLD_RF_TEST_TXON_EN  = TLK_BIT(7),
};
...
enum
{
    FLD_RF_TX_HLEN_MODE  = TLK_BIT_RNG(0, 1),
    FLD_RF_TX_HLEN_WIDTH = TLK_BIT(2),
    FLD_RF_RD_EMPTY_MUX  = TLK_BIT(3),
    FLD_RF_TX_VLD_EN     = TLK_BIT(4),
};
...
enum
{
    FLD_RF_TX_FIFO_FULL = TLK_BIT(0),
    FLD_RF_TX_ACT_2D    = TLK_BIT(1),
};
...
enum
{
    FLD_RF_R_PILOT_LEN_O = TLK_BIT_RNG(0, 3),
    FLD_RF_R_ZB_SFD_O    = TLK_BIT(4),
    FLD_RF_R_PKTLEN_O    = TLK_BIT(5),
    FLD_RF_R_SN_LEN_O    = TLK_BIT(6),
    FLD_RF_R_LEN_0_EN_O  = TLK_BIT(7),
};
...
enum
{
    FLD_RF_RXCHN_MAN_EN = TLK_BIT(3),
    FLD_RF_RXCHN_MAN    = TLK_BIT_RNG(4, 6),
};
...
enum
{
    FLD_RF_ANT_NUM = TLK_BIT_RNG(0, 5),
};
...
enum
{
    FLD_RF_ANT_SEL_MAN = TLK_BIT_RNG(0, 5),
};
...
enum
{
    FLD_RF_AUX_HL_ADV = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_H1M_ODD       = TLK_BIT(0),
    FLD_RF_REV_ZB_SAMP   = TLK_BIT(1),
    FLD_RF_SFD_LAST_CHIP = TLK_BIT(2),
};
...
enum
{
    FLD_RF_CLKON_O = TLK_BIT_RNG(0, 1),
};
...
enum
{
    FLD_RF_CLK_AUTO = TLK_BIT_RNG(0, 1),
};
...
enum
{
    FLD_RF_LAT_CNT    = TLK_BIT_RNG(0, 3),
    FLD_RF_LAT_AT_END = TLK_BIT(4),
};
...
enum
{
    FLD_RF_FILTER_CRC_PKT = TLK_BIT(0),
    FLD_RF_EN_TS_RX       = TLK_BIT(2),
    FLD_RF_EN_TS_TX       = TLK_BIT(3),
    FLD_RF_LEN_SET_O      = TLK_BIT_RNG(4, 5),
};
...
enum
{
    FLD_RF_MAX_LEN    = TLK_BIT_RNG(0, 6),
    FLD_RF_RX_ISO_PDU = TLK_BIT(7),
};
...
enum
{
    FLD_RF_R_LATF_CNT_O    = TLK_BIT_RNG(0, 3),
    FLD_RF_R_LATF_AT_END_O = TLK_BIT(4),
    FLD_RF_R_IQ_SAMP_MODE  = TLK_BIT(5),
...
enum
{
    FLD_RF_DMA_BURST_SIZE = TLK_BIT_RNG(0, 1),
    FLD_RF_RX_HLEN_MODE   = TLK_BIT_RNG(2, 3),
    FLD_RF_HLEN_WIDTH     = TLK_BIT(4), // FLD_RF_SEL_MAN                 =   TLK_BIT_RNG(4,7),
};
...
enum
{
    FLD_RF_ANT_INTERVAL_MSB  = TLK_BIT(0),
    FLD_RF_TX_ANT_OFFSET_MSB = TLK_BIT(1),
    FLD_RF_RX_ANT_OFFSET_MSB = TLK_BIT(2),
};
...
enum
{
    FLD_RF_RX_SUPP_D_EN = TLK_BIT(0),
    FLD_RF_RX_SUPP_A_EN = TLK_BIT(1),
    FLD_RF_TX_SUPP_D_EN = TLK_BIT(2),
    FLD_RF_TX_SUPP_A_EN = TLK_BIT(3),
};
...
enum
{
    //  FLD_RF_ANT_SEL_MAN          =   TLK_BIT_RNG(0,2),
    FLD_RF_ANT_SEL_MAN_EN  = TLK_BIT(3),
    FLD_RF_SLOT_1US_MAN_EN = TLK_BIT(4),
    FLD_RF_SLOT_1US_MAN    = TLK_BIT(5),
    FLD_RF_ANT_PAT         = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_ANT_SOF_OFFSET  = TLK_BIT_RNG(0, 1),
    FLD_RF_SAMP_SOF_OFFSET = TLK_BIT_RNG(2, 3),
    FLD_RF_SUPP_MODE       = TLK_BIT_RNG(4, 6),
};
...
enum
{
    FLD_RF_INTV_MODE        = TLK_BIT_RNG(0, 1),
    FLD_RF_IQ_SAMP_EN       = TLK_BIT(2),
    FLD_RF_INFO_EXTENSION   = TLK_BIT(3),
    FLD_RF_IQ_SAMP_INTERVAL = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_RF_SS          = TLK_BIT_RNG(0, 2),
    FLD_RF_TLK_MIC_ERR = TLK_BIT(3),
    FLD_RF_PKT_DEC_ERR = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_RF_R_TSTAMP0 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_R_TSTAMP1 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_R_TSTAMP2 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_R_TSTAMP3 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_IQSTART_TSTAMP0 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_IQSTART_TSTAMP1 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_IQSTART_TSTAMP2 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_IQSTART_TSTAMP3 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_MATCH_REG_SYNC0 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_MATCH_REG_SYNC1 = TLK_BIT(0),
    FLD_RF_FILT_AGC_GAIN   = TLK_BIT_RNG(4, 6),
    FLD_RF_S2_S8_FLAG      = TLK_BIT(7),
};
...
enum
{
    FLD_RF_PKT_FLT_EN      = TLK_BIT(0),
    FLD_RF_PKT_FLT_INI     = TLK_BIT(1),
    FLD_RF_RXFIFO_CLR_EN   = TLK_BIT(2),
    FLD_RF_FLT_REV_BYTE_EN = TLK_BIT(3),
    FLD_RF_FLT_BYTE_EN     = TLK_BIT(4),
};
...
enum
{
    FLD_RF_PKT_START = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_END = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MATCH_TH = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MATCH0 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MATCH1 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MATCH2 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MATCH3 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MATCH4 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MATCH5 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MATCH6 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MATCH7 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MASK0 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MASK1 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MASK2 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MASK3 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MASK4 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MASK5 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MASK6 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MASK7 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MATCH_IDX = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_PKT_MATCH_VALUE = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_RXDMA_FIFO0 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_RXDMA_FIFO1 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_RXDMA_FIFO2 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_RXDMA_FIFO3 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_TXDMA_FIFO0 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_TXDMA_FIFO1 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_TXDMA_FIFO2 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_TXDMA_FIFO3 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_TLK_CRYPT_SOFT_RST = TLK_BIT(0), // tlk_crypt software reset, active high /**< W1C */
    FLD_RF_TLK_CRYPT_DSB      = TLK_BIT(1), // TLK BLE encryption/decryption disable
};
...
enum
{
    FLD_RF_ANT_LUT0 = TLK_BIT_RNG(0, 5),
    FLD_RF_ANT_LUT1 = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_CRC_START_BYTE = TLK_BIT_RNG(0, 5),
};
...
enum
{
    FLD_RF_CRC_LENGTH   = TLK_BIT_RNG(0, 2),
    FLD_RF_CRC_BYTE_ORD = TLK_BIT(3),
...
enum
{
    FLD_RF_PN_LENGTH = TLK_BIT_RNG(0, 4),
};
...
enum
{
    FLD_RF_LR_CFG0 = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_LR_CFG1 = TLK_BIT_RNG(0, 2),
};
...
enum
{
    FLD_RF_ZB_PHR_EN           = TLK_BIT(0),
    FLD_RF_ZB_PHR_EXTEND_EN    = TLK_BIT(1),
    FLD_RF_ZB_HYBEE_NEW        = TLK_BIT(2),
    FLD_RF_ZB_PHR_CRC_EN       = TLK_BIT(3),
    FLD_RF_ZB_SFD_ORD          = TLK_BIT(4),
    FLD_RF_ZB_PSDU_LENGTH_HIGH = TLK_BIT_RNG(5, 7),
};
...
enum
{
    FLD_RF_ZB_PSDU_LENGTH_LOW = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_ZB_GAP_LENGTH = TLK_BIT_RNG(0, 5),
    FLD_RF_ZB_SFD_LENGTH = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_NEW_2G4_H0_SIZE = TLK_BIT_RNG(0, 4),
};
...
enum
{
    FLD_RF_NEW_2G4_H1_SIZE = TLK_BIT_RNG(0, 4),
};
...
enum
{
    FLD_RF_NEW_2G4_LENGTH_SIZE    = TLK_BIT_RNG(0, 4),
    FLD_RF_NEW_2G4_LENGTH_BIT_ORD = TLK_BIT(7),
};
...
enum
{
    FLD_RF_NEW_2G4_PID_START_BIT = TLK_BIT_RNG(0, 5),
    FLD_RF_NEW_2G4_PID_EN        = TLK_BIT(7),
};
...
enum
{
    FLD_RF_NEW_2G4_NOACK_START_BIT = TLK_BIT_RNG(0, 5),
    FLD_RF_NEW_2G4_NOACK_EN        = TLK_BIT(7),
};
...
enum
{
    FLD_RF_NEW_2G4_LENGTH_ADJ = TLK_BIT_RNG(0, 5),
};
...
enum
{
    FLD_RF_R_RESET_PID_0 = TLK_BIT(0),
    FLD_RF_R_RESET_PID_1 = TLK_BIT(1),
    FLD_RF_R_RESET_PID_2 = TLK_BIT(2),
    FLD_RF_R_RESET_PID_3 = TLK_BIT(3),
    FLD_RF_R_RESET_PID_4 = TLK_BIT(4),
    FLD_RF_R_RESET_PID_5 = TLK_BIT(5),
    FLD_RF_R_RESET_PID_6 = TLK_BIT(6),
    FLD_RF_R_RESET_PID_7 = TLK_BIT(7),
};
...
enum
{
    FLD_RF_R_MD_EN           = TLK_BIT(0),
    FLD_RF_R_ID_EN           = TLK_BIT(1),
    FLD_RF_R_RX_NOACK_MAN    = TLK_BIT(2),
    FLD_RF_R_RX_NOACK_MAN_EN = TLK_BIT(3),
    FLD_RF_R_TX_EN_MAN       = TLK_BIT(4),
    FLD_RF_R_RX_EN_MAN       = TLK_BIT(5),
    FLD_RF_R_TX_TRIQ_AUTO_EN = TLK_BIT(6),
    FLD_RF_R_S_TX_TIMEOUT_EN = TLK_BIT(7),
};
...
enum
{
    FLD_RF_FSM_TIMEOUT_EN      = TLK_BIT(0),
    FLD_RF_RX_FIRST_TIMEOUT_EN = TLK_BIT(1),
    FLD_RF_RX_TIMEOUT_EN       = TLK_BIT(2),
    FLD_RF_CRC_2_EN            = TLK_BIT(3),

    // BLE mode
    FLD_RF_INIT_PRX_PID = TLK_BIT_RNG(4, 5),
    FLD_RF_INIT_PTX_PID = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_R_T_TXSTL_H = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_R_T_RXWAIT_H = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_R_STIMER_REVERT_EN =
        TLK_BIT(0), // Set to 1, stimer controls the function and ststamp through the system timer;
                    // Otherwise system timer bb is used
    FLD_RF_R_ST_HADM_REVERT_EN = TLK_BIT(
...
enum
{
    FLD_RF_R_T_RX_H = TLK_BIT_RNG(0, 3),
};

#define reg_rf_ll_rxstl   REG_ADDR16(REG_BB_LL_BASE_ADDR + 0x0c)
#define reg_rf_ll_rxstl_l REG_ADDR8(REG_BB_LL_BASE_ADDR + 0x0c)
#define reg_rf_ll_rxstl_h REG_ADDR8(REG_BB_LL_BASE_ADDR + 0x0d)

enum
{
    FLD_RF_R_T_RXSTL_H = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_R_T_TXWAIT_H = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_R_T_ARD_H = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_R_TXCHN_MAN          = TLK_BIT_RNG(0, 2),
    FLD_RF_R_NOACK_RETRY_CNT_EN = TLK_BIT(3),
    FLD_RF_R_TXCHN_MAN_EN       = TLK_BIT(4),
    FLD_RF_R_NOACK_REV_EN       = TLK_BIT(5),
    FLD_RF_R_RXIRQ_REPORT_ALL   = TLK_BIT(6),
    FLD_RF_R_REP_SN_PID_EN      = TLK_BIT(7),
};
...
enum
{
    FLD_RF_R_TX_EN_DLY_EN    = TLK_BIT(0),
    FLD_RF_R_PLL_RESET_EN    = TLK_BIT(1),
    FLD_RF_R_CMD_SCHEDULE_EN = TLK_BIT(2),
    FLD_RF_R_PLL_EN_MAN      = TLK_BIT(3),
    FLD_RF_R_T_TX_EN_DLY     = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_RF_R_TX_ID       = TLK_BIT_RNG(0, 6),
    FLD_RF_R_LL_IRQ_MASK = TLK_BIT(7),
};
...
{
    FLD_RF_IRQ_RX =
        TLK_BIT(0), /*Auto/Manual: an interrupt is generated after each packet is received.*/
    FLD_RF_IRQ_TX = TLK_BIT(1), /*Auto/Manual: an interrupt is generated after each packet is sent*/
    FLD_RF_IRQ_RX_TIMEOUT =
        TLK_BIT(2), /*Auto: If the packet is still not received within the time set from trigger to
                       timeout, an interrupt is generated and the state machine returns to idle
                       state. The timeout time is set by void rf_set_rx_timeout(); and the timeout
                       starts from the trigger RX.*/
    FLD_RF_IRQ_RX_FIFO_FULL =
        TLK_BIT(3), /*Auto/Manual:An interrupt is generated when the data size of the total received
                       packets is exceeded to the allocated storage range of Rx SRAM TL321X chip
                       unavailable, it will not work after configuration.(add by chenxi.wang,
                       confirmed by jingyong 202402029)*/
    FLD_RF_IRQ_RX_CRC_2 =
        TLK_BIT(4), /*Auto:BTX,BRX,PTX,PRX will generate interrupt if CRC error is detected twice in
                       a row during packet receiving (continuous packet receiving).*/
    FLD_RF_IRQ_CMD_DONE = TLK_BIT(
        5), /*Auto:After completing a normal packet receiving or sending operation,
              the state machine returns to the IDLE state normally and generates an interrupt.*/
    FLD_RF_IRQ_FSM_TIMEOUT =
        TLK_BIT(6), /*Auto:It contains the state machine used for switching from receive to send,
                      specifying the time of the entire state machine, and determining whether the
                      specified time is exceeded in the TX_WAIT state*/
    FLD_RF_IRQ_TX_RETRYCNT = TLK_BIT(7), /*Auto:Generate an interrupt when the number of ptx retry
                                            exceeds the set r_max_retry_cnt.*/
    FLD_RF_IRQ_TX_DS =
        TLK_BIT(8), /*Auto:Length of payload (sent by PTX, PRX) ! = 0, generate tx_ds interrupt.*/
    FLD_RF_IRQ_RX_DR = TLK_BIT(9), /*Auto:PRX, PTX, SRX received packets detect the packet payload
                                      length ! = 0, generate rx_dr interrupt*/
    FLD_RF_IRQ_FIRST_TIMEOUT =
        TLK_BIT(10), /*Auto:BRX, PRX, SRX, SRT first RX timeout, when the first packet receive
                        timeout it will generate an interrupt*/
    FLD_RF_IRQ_INVALID_PID =
        TLK_BIT(11), /*Auto:PTX or PRX receives invalid pid and generates interrupt*/
    FLD_RF_IRQ_STX_TIMEOUT =
        TLK_BIT(12), /*Auto:The STX state does not wait for tx_done in the specified time, thus
                        timeout, generating an interrupt.*/
    FLD_RF_IRQ_WIFI_DENY = TLK_BIT(
        13), /*Auto:After the Bluetooth chip receives the wifi_deny signal from the WiFi chip when
                it is connected to the WiFi chip, the Bluetooth chip generates an interrupt*/
    FLD_RF_IRQ_SUPP_OF =
        TLK_BIT(14), /*Auto/Manual:The interrupt is mainly used for AOA and AOD. If iq sampling
                        frequency is too high the hardware FIFO will overflow error, generate
                        interrupt iq sample and synchronize fifo overflow.*/
    FLD_RF_IRQ_RXDMA_OF      = TLK_BIT(15),
    FLD_RF_IRQ_TR_TURNAROUND = TLK_BIT(16),
    FLD_RF_IRQ_TLK_RXCRYPT_ERR =
        TLK_BIT(17), /*Auto/Manual:Indicates real time decryption error, happens when CCM decryption
                        is too slow compared to receiving bitstream by Packet Controller. */
    FLD_RF_IRQ_TLK_TXCRYPT_ERR =
        TLK_BIT(18), /*Auto/Manual:Indicates Real Time encryption error, happens when CCM encryption
                        is too slow compared to transmitting requests by Packet Controller. */
    FLD_RF_IRQ_HIT_SYNC = TLK_BIT(19), /*Auto/Manual:An interrupt is generated when sync up of one
                                          packet is detected in Rx mode*/
    FLD_RF_IRQ_HEADER_DONE = TLK_BIT(20), /*Auto/Manual:Interrupt is generated when the Header Field
                                             of one packet has been received completely.*/
    FLD_RF_IRQ_PKT_UNMATCH =
        TLK_BIT(21), /*Auto/Manual:An interrupt is generated when the certain bits of the received
                        packet are not matched to the predefined ones within the packet filter
                        registers in Rx mode.*/
    FLD_RF_IRQ_PKT_MATCH = TLK_BIT(
        22), /*Auto/Manual:An interrupt is generated when the certain bits of the received packet
                are matched to the predefined ones within the packet filter registers in Rx mode. */
    FLD_RF_IRQ_RX_ZB_FREQ_HOP =
        TLK_BIT(23), /*Auto/Manual:When Zigbee performs dual-channel detection, it switches channels
                        at preset intervals, and the interrupt generated at this time*/
    FLD_RF_IRQ_RX_FREQ_HOP_FIXED = TLK_BIT(
        24), /*Auto/Manual:When Zigbee performs dual-channel detection, the interrupt is generated
                when it stays in one of the channels to successfully receive packets and fixes the
                interrupt when it continues to receive over-the-air packets in this channel.*/
    FLD_RF_IRQ_TRX_FCAL_DONE =
        TLK_BIT(25), /*After RF is turned on, the interrupt generated at the moment of fcal
                        calibration is completed at tx or rx (including switching channels during
                        dual-channel detection by zigbee).*/
    FLD_RF_IRQ_RADIO_DONE =
        TLK_BIT(26), /*TODO:This function interface is not available at this time, and will be
                        updated in subsequent releases.(unverified)*/
...
enum
{
    FLD_RF_PID0 = TLK_BIT_RNG(0, 1),
    FLD_RF_PID1 = TLK_BIT_RNG(2, 3),
    FLD_RF_PID2 = TLK_BIT_RNG(4, 5),
    FLD_RF_PID3 = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_PID4 = TLK_BIT_RNG(0, 1),
    FLD_RF_PID5 = TLK_BIT_RNG(2, 3),
    FLD_RF_PID6 = TLK_BIT_RNG(4, 5),
    FLD_RF_PID7 = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_LL_RETRY_CNT = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_CRC_CNT = TLK_BIT_RNG(0, 3),
    FLD_RF_NAK_CNT = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_RF_OLD_CNT = TLK_BIT_RNG(0, 3),
    FLD_RF_ID_CNT  = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_RF_COEX_EN        = TLK_BIT(0),
    FLD_RF_COEX_WF_DN_POL = TLK_BIT(1),
    FLD_RF_COEX_STATUS    = TLK_BIT(2),
    FLD_RF_COEX_TRX_POL   = TLK_BIT(3),
    FLD_RF_TRX_PRIO       = TLK_BIT(4),
    FLD_RF_TX_PRIO        = TLK_BIT(5),
    FLD_RF_RX_PRIO        = TLK_BIT(6),
};
...
enum
{
    FLD_RF_ON_MANUAL         = TLK_BIT(0),
    FLD_RF_ON                = TLK_BIT(1),
    FLD_RF_DIS_TXLEN_FLG_UPD = TLK_BIT(2),
    FLD_RF_DIS_TXCNT_UPDATE  = TLK_BIT(3),
    FLD_RF_DIS_RXCNT_UPDATE  = TLK_BIT(4),
};
...
enum
{
    FLD_RF_LR_MODE         = TLK_BIT(0),
    FLD_RF_CONT_MODE       = TLK_BIT(3),
    FLD_RF_RX_DATA_CLK_DBG = TLK_BIT(5),
    FLD_RF_LR_TRIG_MODE    = TLK_BIT(6),
    FLD_RF_FDC_DBG_SEL     = TLK_BIT(7),
...
enum
{
    FLD_RF_ZIGBEE_MODE_RX = TLK_BIT(0),
    FLD_RF_LR_MODEM_SEL   = TLK_BIT(2),
    FLD_RF_LR_VITERBI_SEL = TLK_BIT(3),
    FLD_RF_HYBEE_SEL      = TLK_BIT_RNG(4, 6),
    FLD_RF_SPARE_ZB_REG   = TLK_BIT(7),
};
...
enum
{
    FLD_RF_ZIGBEE_MODEM_TX = TLK_BIT(7),
};
...
enum
{
    FLD_RF_X1_CQ_N      = TLK_BIT(0),
    FLD_RF_SYNC_RST_SEL = TLK_BIT(1),
    FLD_RF_GF_BT        = TLK_BIT(2),
    FLD_RF_GF_BT2_0     = TLK_BIT(3),
};
...
enum
{
    FLD_RF_RX_ACC_LNE = TLK_BIT_RNG(0, 2),
    FLD_RF_RX_CRC_EN  = TLK_BIT(3),
    FLD_RF_SFD0_NUM   = TLK_BIT_RNG(4, 6),
};
...
enum
{
    FLD_RF_RX_EN      = TLK_BIT_RNG(0, 5),
    FLD_RF_LR_MAN_EN  = TLK_BIT(6),
    FLD_RF_LR_MAN_SEL = TLK_BIT(7),
};
...
enum
{
    FLD_RF_TX_TP_EN        = TLK_BIT(0),
    FLD_RF_TX_IQ_EN        = TLK_BIT(1),
    FLD_RF_TX_MPSK_EN      = TLK_BIT(2),
    FLD_RF_TX_TP_ALIGN_BT  = TLK_BIT(3),
    FLD_RF_TX_TP_ALIGN_BLE = TLK_BIT(4),
};
...
enum
{
    FLD_RF_BW_CODE = TLK_BIT_RNG(1, 3),
    FLD_RF_SC_CODE = TLK_BIT(4),
};
...
enum
{
    FLD_RF_MODE_VANT_RX = TLK_BIT(1),
    FLD_RF_FE_RTRIM_RX  = TLK_BIT_RNG(2, 4),
    FLD_RF_IF_FREQ      = TLK_BIT_RNG(5, 6),
...
enum
{
    FLD_RF_BLE_MODE_TX           = TLK_BIT(0),
    FLD_RF_VCO_TRIM_KVM          = TLK_BIT_RNG(1, 3),
    FLD_RF_HPMC_EXP_DIFF_COUNT_L = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_RF_HPMC_EXP_DIFF_COUNT_H = TLK_BIT_RNG(0, 4),
    FLD_RF_DAC_TRIM_CFBK         = TLK_BIT_RNG(5, 6),
...
enum
{
    FLD_RF_DIS_CLK_DIG_O    = TLK_BIT(0),
    FLD_RF_VANT_PULLDN      = TLK_BIT(1),
    FLD_RF_TX_IQ_MODE_EN_BT = TLK_BIT(2),
    FLD_RF_LDO_ANT_TRIM     = TLK_BIT_RNG(3, 5),
    FLD_RF_CBPF_TYPE        = TLK_BIT(6),
    FLD_RF_TX_PA_PWR_L      = TLK_BIT(7),
};
...
enum
{
    FLD_RF_TX_PA_PWR_H = TLK_BIT_RNG(0, 4),
};
...
enum
{
    FLD_RF_CHNL_NUM = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_CH_NUMLL_SEL        = TLK_BIT(0),
    FLD_RF_TX_EN_PIF           = TLK_BIT(1),
    FLD_RF_RX_EN_PIF           = TLK_BIT(2),
    FLD_RF_RX_TIM_SRQ_SEL_TESQ = TLK_BIT(3),
    FLD_RF_TX_TIM_SRQ_SEL_TESQ = TLK_BIT(4),
    FLD_RF_FE_CTRIM            = TLK_BIT_RNG(5, 7),
};
...
enum
{
    FLD_RF_MODE_CFG_TX3      = TLK_BIT_RNG(0, 5),
    FLD_RF_MODE_VANT_TX_BLE  = TLK_BIT(6),
    FLD_RF_TX_IQ_MODE_EN_BLE = TLK_BIT(7),
};
...
enum
{
    FLD_RF_LDO_ANT_TRIM_BLE = TLK_BIT_RNG(0, 2),
    FLD_RF_BT_BLE_SEL_EN    = TLK_BIT(3),
    FLD_RF_TXC_PWR_SRL      = TLK_BIT(4),
    FLD_RF_BW_CODE_BLE      = TLK_BIT_RNG(5, 7),
...
enum
{
    FLD_RF_TXC_MI_FLEX_L = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_RF_TXC_MI_FLEX_H        = TLK_BIT(0),
    FLD_RF_LOW_RATE_EN          = TLK_BIT(1),
    FLD_RF_LOW_RATE_MODE        = TLK_BIT(2),
    FLD_RF_TX_DATA_RS           = TLK_BIT_RNG(3, 4),
    FLD_RF_NORM_PKT_FAST_STL_EN = TLK_BIT(5),
    FLD_RF_NON_ID_FAST_STL_EN   = TLK_BIT(6),
    FLD_RF_FAST_STL_EN          = TLK_BIT(7),
};
...
enum
{
    FLD_RF_AGC_DISABLE    = TLK_BIT(1),
    FLD_RF_RX_GAIN        = TLK_BIT_RNG(2, 4),
    FLD_RF_ADC_IQ_SWAP    = TLK_BIT(5),
    FLD_RF_INVERT_CLK_DSM = TLK_BIT(6),
    FLD_RF_DSM_FRAC_LSW_L = TLK_BIT(7),
};
...
enum
{
    FLD_RF_DSM_FRAC_LSW_H  = TLK_BIT_RNG(0, 1),
    FLD_RF_SPARE_1         = TLK_BIT(2),
    FLD_RF_AM_OVERRIDE_EN  = TLK_BIT(3),
    FLD_RF_AM_OVERRIDE_VAL = TLK_BIT(4),
    FLD_RF_LOAD_PREV_GAIN  = TLK_BIT(5),
    FLD_RF_ADC_CLIP_EN     = TLK_BIT(6),
};
...
enum
{
    FLD_RF_CHNL_FREQ_DIRECT = TLK_BIT(0),
    FLD_RF_CHNL_FREQ_L      = TLK_BIT_RNG(1, 7),
};
...
enum
{
    FLD_RF_CHNL_FREQ_H        = TLK_BIT_RNG(0, 5),
    FLD_RF_DSN_DITHER_DISABLE = TLK_BIT(6),
    FLD_RF_DSM_INT_MODE       = TLK_BIT(7),
};
...
enum
{
    FLD_RF_DSM_RUN_OW     = TLK_BIT(0),
    FLD_RF_LDOT_TX_RUN_OW = TLK_BIT(1),
    FLD_RF_RCCAL_RUN_OW   = TLK_BIT(2),
    FLD_RF_FCAL_TX_RUN_OW = TLK_BIT(3),
    FLD_RF_RXDCOC_RUN_OW  = TLK_BIT(4),
    FLD_RF_HPMC_RUN_OW    = TLK_BIT(5),
    FLD_RF_LOCD_RUN_OW    = TLK_BIT(6),
};
...
enum
{
    FLD_RF_LDOT_RX_RUN_OW    = TLK_BIT(0),
    FLD_RF_FCAL_RX_RUN_OW    = TLK_BIT(1),
    FLD_RF_LDOT_DEBUG_RUN_OW = TLK_BIT(2),
    FLD_RF_FCAL_DEBUG_RUN_OW = TLK_BIT(3),
    FLD_RF_TIM_REC_REST_BLE  = TLK_BIT(6),
    FLD_RF_HOLD0             = TLK_BIT(7),
};
...
enum
{
    FLD_RF_LDOT_RX_RUN    = TLK_BIT(0),
    FLD_RF_FCAL_RX_RUN    = TLK_BIT(1),
    FLD_RF_LDOT_DEBUG_RUN = TLK_BIT(2),
    FLD_RF_FCAL_DEBUG_RUN = TLK_BIT(3),
};
...
enum
{
    FLD_RF_LDOT_TX_RUN_CB = TLK_BIT(0),
    FLD_RF_FCAL_TX_RUN_CB = TLK_BIT(1),
    FLD_RF_HPMC_RUN_CB    = TLK_BIT(2),
    //
    FLD_RF_LDOT_RX_RUN_CB = TLK_BIT(4),
    FLD_RF_FCAL_RX_RUN_CB = TLK_BIT(5),
    FLD_RF_RCCAL_RUN_CB   = TLK_BIT(6),
    FLD_RF_RXDCOC_RUN_CB  = TLK_BIT(7),
};
...
enum
{
    FLD_RF_DCOC_GAIN_CFG_OW = TLK_BIT(0),
    FLD_RF_RX_DIG_EN_OW     = TLK_BIT(1),
    FLD_RF_TXC_TX_EN_OW     = TLK_BIT(2),
    FLD_RF_TX_HPM_CAL_EN_OW = TLK_BIT(3),
    FLD_RF_TX_MOD_EN_OW     = TLK_BIT(4),
    FLD_RF_RESTART_TIM_SEL  = TLK_BIT_RNG(5, 7),
};
...
enum
{
    FLD_RF_DCOC_GAIN_CFG    = TLK_BIT(0),
    FLD_RF_RX_DIG_EN        = TLK_BIT(1),
    FLD_RF_TXC_TX_EN        = TLK_BIT(2),
    FLD_RF_TX_HPM_CAL_EN    = TLK_BIT(3),
    FLD_RF_TX_MOD_EN        = TLK_BIT(4),
    FLD_RF_EN_DCOC_ADC_DATA = TLK_BIT(5),
};
...
enum
{
    FLD_RF_FCAL_DEBUG_COUNT_H = TLK_BIT_RNG(0, 4),
    FLD_RF_FCAL_PASS          = TLK_BIT(5),
};
...
enum
{
    FLD_RF_BYPASS                = TLK_BIT(0),
    FLD_RF_DCAP_COARSE_OVERWRITE = TLK_BIT_RNG(1, 6),
    FLD_RF_DCAP_FINE_OVERWRITE_L = TLK_BIT(7),
};
...
enum
{
    FLD_RF_DCAP_FINE_OVERWRITE_H = TLK_BIT(0),
    FLD_RF_COUNT_POL             = TLK_BIT(1),
    FLD_RF_DEBUG_CNT_SEL         = TLK_BIT_RNG(2, 5),
};
...
enum
{
    FLD_RF_BANDGAP_TX_RUN = TLK_BIT(0),
    FLD_RF_PDSTL_TX_RUN   = TLK_BIT(1),
    FLD_RF_BANDGAP_RX_RUN = TLK_BIT(2),
    FLD_RF_PDSTL_RX_RUN   = TLK_BIT(3),
};
...
enum
{
    FLD_RF_BYPASS_RCCAL           = TLK_BIT(0),
    FLD_RF_RCCAL_OVERWRITE        = TLK_BIT_RNG(1, 5),
    FLD_RF_CBPF_CCODE_BYPASS      = TLK_BIT(6),
    FLD_RF_CBPF_CCODE_OVERWRITE_L = TLK_BIT(7),
};
...
enum
{
    FLD_RF_CBPF_CCODE_OVERWRITE_H = TLK_BIT_RNG(0, 5),
    FLD_RF_COMP_POL               = TLK_BIT(6),
};
...
enum
{
    FLD_RF_RCCAL_CBPF_OFFSET = TLK_BIT_RNG(0, 2),
};
...
enum
{
    FLD_RF_RCCAL_CODE   = TLK_BIT_RNG(0, 4),
    FLD_RF_CBPF_CCODE_L = TLK_BIT_RNG(5, 7),
};
...
enum
{
    FLD_RF_CBPF_CCODE_H = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_DCOC_BYPASS_ADC            = TLK_BIT(0),
    FLD_RF_DCOC_IADC_OFFSET_OVERWRITE = TLK_BIT_RNG(1, 7),
};
...
enum
{
    FLD_RF_DCOC_QADC_OFFSET_OVERWRITE = TLK_BIT_RNG(0, 6),
};
...
enum
{
    FLD_RF_DCOC_BYPASS_DAC          = TLK_BIT(0),
    FLD_RF_DCOC_IDAC_CODE_OVERWRITE = TLK_BIT_RNG(1, 7),
};
...
enum
{
    FLD_RF_DCOC_QDAC_CODE_OVERWRITE = TLK_BIT_RNG(0, 6),
};
...
enum
{
    FLD_RF_DCOC_SFIQ         = TLK_BIT(0),
    FLD_RF_DCOC_SFQI         = TLK_BIT(1),
    FLD_RF_DCOC_IDAC_SRC_POL = TLK_BIT(2),
    FLD_RF_DCOC_QDAC_SRC_POL = TLK_BIT(3),
    FLD_RF_DCOC_SFIIP        = TLK_BIT(4),
    FLD_RF_DCOC_SFQQP        = TLK_BIT(5),
    FLD_RF_DCOC_SFII_L       = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_DCOC_SFII_H    = TLK_BIT_RNG(0, 1),
    FLD_RF_DCOC_SFQQ      = TLK_BIT_RNG(2, 5),
    FLD_RF_DCOC_DAC_ORDER = TLK_BIT(6),
};
...
enum
{
    FLD_RF_DCOC_ILNA_OFFSET   = TLK_BIT_RNG(0, 5),
    FLD_RF_DCOC_QLNA_OFFSET_L = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_DCOC_QLNA_OFFSET_H = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_DCOC_ICBPF_OFFSET   = TLK_BIT_RNG(0, 5),
    FLD_RF_DCOC_QCBPF_OFFSET_L = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_DCOC_QCBPF_OFFSET_H = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_DCOC_IDAC_CODE = TLK_BIT_RNG(0, 6),
    FLD_RF_SPARE_3        = TLK_BIT(7),
};
...
enum
{
    FLD_RF_SPARE_4 = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_DCOC_QDAC_CODE = TLK_BIT_RNG(0, 6),
};
...
enum
{
    FLD_RF_DCOC_IADC_OFFSET   = TLK_BIT_RNG(0, 6),
    FLD_RF_DCOC_QADC_OFFSET_L = TLK_BIT(7),
};
...
enum
{
    FLD_RF_DCOC_QADC_OFFSET_H = TLK_BIT_RNG(0, 5),
};
...
enum
{
    FLD_RF_LDOT_LDO_CAL_BYPASS         = TLK_BIT(0),
    FLD_RF_LDOT_LDO_CAL_TRIM_OVERWRITE = TLK_BIT_RNG(1, 6),
};
...
enum
{
    FLD_RF_LDOT_LDO_RXTXHF_BYPASS         = TLK_BIT(0),
    FLD_RF_LDOT_LDO_RXTXLF_BYPASS         = TLK_BIT(1),
    FLD_RF_LDOT_LDO_RXTXHF_TRIM_OVERWRITE = TLK_BIT_RNG(2, 7),
};
...
enum
{
    FLD_RF_LDOT_LDO_RXTXLF_TRIM_OVERWRITE = TLK_BIT_RNG(0, 5),
};
...
enum
{
    FLD_RF_LDOT_LDO_PLL_BYPASS         = TLK_BIT(0),
    FLD_RF_LDOT_LDO_VCO_BYPASS         = TLK_BIT(1),
    FLD_RF_LDOT_LDO_PLL_TRIM_OVERWRITE = TLK_BIT_RNG(2, 7),
};
...
enum
{
    FLD_RF_LDOT_LDO_VCO_TRIM_OVERWRITE = TLK_BIT_RNG(0, 5),
};
...
enum
{
    FLD_RF_LDOT_INCCAL_DIS        = TLK_BIT(0),
    FLD_RF_LDOT_LDO_RXTXHF_OFFSET = TLK_BIT_RNG(1, 2),
    FLD_RF_LDOT_LDO_RXTXLF_OFFSET = TLK_BIT_RNG(3, 4),
    FLD_RF_LDOT_LDO_PLL_OFFSET    = TLK_BIT_RNG(5, 6),
    FLD_RF_LDOT_LDO_VCO_OFFSET_L  = TLK_BIT(7),
};
...
enum
{
    FLD_RF_LDOT_LDO_VCO_OFFSET_H = TLK_BIT(0),
};
...
enum
{
    FLD_RF_LDOT_LDO_CAL_TRIM = TLK_BIT_RNG(0, 5),
};
...
enum
{
    FLD_RF_LDOT_LDO_RXTXHF_TRIM   = TLK_BIT_RNG(0, 5),
    FLD_RF_LDOT_LDO_RXTXLF_TRIM_L = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_LDOT_LDO_RXTXLF_TRIM_H = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_LDOT_LDO_PLL_TRIM   = TLK_BIT_RNG(0, 5),
    FLD_RF_LDOT_LDO_VCO_TRIM_L = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_LDOT_LDO_VCO_TRIM_H = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_HPMC_DAC_SWING = TLK_BIT(0),
    FLD_RF_HPMC_SLOW_MODE = TLK_BIT(1),
    FLD_RF_HPMC_COUNT_POL = TLK_BIT(2),
};
...
enum
{
    FLD_RF_HPMC_BYPASS           = TLK_BIT(0),
    FLD_RF_HPMC_GAIN_OVERWRITE_L = TLK_BIT_RNG(1, 7),
};
...
enum
{
    FLD_RF_HPMC_GAIN_OVERWRITE_H = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_RF_HPMC_COUNT1_LSW        = TLK_BIT_RNG(0, 2),
    FLD_RF_HPMC_COUNT2_LSW        = TLK_BIT_RNG(3, 5),
    FLD_RF_HPMC_MEAS_DIFF_COUNT_L = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_HPMC_MEAS_DIFF_COUNT_H = TLK_BIT_RNG(0, 6),
    FLD_RF_HPMC_PASS              = TLK_BIT(7),
};
...
enum
{
    FLD_RF_HPMC_GAIN_H = TLK_BIT_RNG(0, 2),
};
...
enum
{
    FLD_RF_LOCD_DUR    = TLK_BIT_RNG(0, 6),
    FLD_RF_LOCD_WAIT_L = TLK_BIT(7),
};
...
enum
{
    FLD_RF_RX_LNA_PUP_OW         = TLK_BIT(0),
    FLD_RF_RX_LNA_HGAIN_OW       = TLK_BIT(1),
    FLD_RF_RX_LNA_LGAIN_OW       = TLK_BIT(2),
    FLD_RF_RX_LNA_ATTN_OW        = TLK_BIT(3),
    FLD_RF_RX_MIX_PUP_OW         = TLK_BIT(4),
    FLD_RF_TX_PA_PUP_OW          = TLK_BIT(5),
    FLD_RF_TX_PA_PWR_OW          = TLK_BIT(6),
    FLD_RF_PA_RAMP_TSEQ_OR_TX_ON = TLK_BIT(7),
};
...
enum
{
    FLD_RF_TX_PA_PUP = TLK_BIT(0),
    FLD_RF_TX_PA_PWR = TLK_BIT_RNG(1, 6),
};
...
enum
{
    FLD_RF_FCAL_DCAP_COARSE = TLK_BIT_RNG(0, 5),
    FLD_RF_FCAL_DCAP_FINE   = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_RF_TX_FRAC_TIME_MUX      = TLK_BIT(0),
    FLD_RF_TXC_DSM_INT_OVERWRITE = TLK_BIT(1),
    FLD_RF_FCAL_STL_DCAP_EN      = TLK_BIT(2), // FCAL fast settle enable
    FLD_RF_FCAL_RVT_T1           = TLK_BIT(3),
    FLD_RF_CH_FREQ_RVT_T1        = TLK_BIT(4),
    FLD_RF_TX_MI_SWITCH_TONE_EN  = TLK_BIT(5),
    FLD_RF_TX_HAFM_RAMP_DOWN_EN  = TLK_BIT(6),
    FLD_RF_TX_RAMP_DOWN_TONE_EN  = TLK_BIT(7),
};
...
#define reg_rf_fcal_chn_range_ctf_low(i)                                                           \
    REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0x1b8 + (i << 1)) // i range:0~7

#define reg_rf_fcal_chn_range_ctf_high(i)                                                          \
    REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0x1b9 + (i << 1)) // i range:0~7
