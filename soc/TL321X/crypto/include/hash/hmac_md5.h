...
extern "C"
{
     ...
     */
    unsigned int hmac_md5_init(HMAC_MD5_CTX* ctx, unsigned char* key, unsigned short sp_key_idx,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_md5(unsigned char* key, unsigned short sp_key_idx, unsigned int key_bytes,
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_md5_dma_init(HMAC_MD5_DMA_CTX* ctx, unsigned char* key,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_md5_dma_update_blocks(HMAC_MD5_DMA_CTX* ctx, unsigned int* msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_md5_dma_final(HMAC_MD5_DMA_CTX* ctx, unsigned int* remainder_msg,
     ...
     * @return       0:success     other:error
     */
    unsigned int hmac_md5_dma(unsigned char* key, unsigned short sp_key_idx, unsigned int key_bytes,
 ...
 *          address and byte length.
  @endverbatim
 */
    unsigned int hmac_md5_node_steps(unsigned char* key, unsigned short sp_key_idx,
 ...
 *          address and byte length.
 ...
 block length.
  @endverbatim
 */
    unsigned int hmac_md5_dma_node_steps(unsigned char* key, unsigned short sp_key_idx,
