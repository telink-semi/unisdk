 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha384_dma_update_blocks(SHA384_DMA_CTX* ctx, unsigned int* msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha384_dma_final(SHA384_DMA_CTX* ctx, unsigned int* remainder_msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha384_dma(unsigned int* msg, unsigned int msg_bytes, unsigned int* digest,
 ...
 *     -# 3. for every node or segment except the last, its message length must be a multiple of
 block length.
  @endverbatim
 */
    unsigned int sha384_dma_node_steps(HASH_DMA_NODE* node, unsigned int node_num,
