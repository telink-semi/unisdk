 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha224_dma_update_blocks(SHA224_DMA_CTX* ctx, unsigned int* msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha224_dma_final(SHA224_DMA_CTX* ctx, unsigned int* remainder_msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha224_dma(unsigned int* msg, unsigned int msg_bytes, unsigned int* digest,
...
*/
    ...
    unsigned int sha224_dma_node_steps(HASH_DMA_NODE* node, unsigned int node_num,
