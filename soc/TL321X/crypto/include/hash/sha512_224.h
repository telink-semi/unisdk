 ...
 *        address and byte length.
  @endverbatim
 */
    unsigned int sha512_224_node_steps(HASH_NODE* node, unsigned int node_num,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha512_224_dma_update_blocks(SHA512_224_DMA_CTX* ctx, unsigned int* msg,
 ...
 * @param[in]   remainder_bytes   - byte length of the remainder message, must be in [0,
 BLOCK_BYTE_LEN-1],
 *                                  here BLOCK_BYTE_LEN is block byte length of sha512_224, it is
 128.
 *@param[out]   digest            - sha512_224 digest, 28 bytes.
 * @return      0:success     other:error
 * @note
  ...
  @endverbatim
  */
    unsigned int sha512_224_dma_final(SHA512_224_DMA_CTX* ctx, unsigned int* remainder_msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha512_224_dma(unsigned int* msg, unsigned int msg_bytes, unsigned int* digest,
 ...
 *     3. for every node or segment except the last, its message length must be a multiple of block
 length.
  @endverbatim
 */
    unsigned int sha512_224_dma_node_steps(HASH_DMA_NODE* node, unsigned int node_num,
