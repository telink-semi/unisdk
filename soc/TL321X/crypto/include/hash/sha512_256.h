 ...
 */
    ...
    unsigned int sha512_256_node_steps(HASH_NODE* node, unsigned int node_num,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha512_256_dma_update_blocks(SHA512_256_DMA_CTX* ctx, unsigned int* msg,
 ...
 * @param[in]   remainder_bytes   - byte length of the remainder message, must be in [0,
 BLOCK_BYTE_LEN-1],
 *                                  here BLOCK_BYTE_LEN is block byte length of sha512_256, it is
 128.
 *@param[out]   digest            - sha512_256 digest, 32 bytes.
 * @return      0:success     other:error
 * @note
  ...
  @endverbatim
  */
    unsigned int sha512_256_dma_final(SHA512_256_DMA_CTX* ctx, unsigned int* remainder_msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha512_256_dma(unsigned int* msg, unsigned int msg_bytes, unsigned int* digest,
                                HASH_CALLBACK callback);

#ifdef SUPPORT_HASH_DMA_NODE
    unsigned int sha512_256_dma_node_steps(HASH_DMA_NODE* node, unsigned int node_num,
