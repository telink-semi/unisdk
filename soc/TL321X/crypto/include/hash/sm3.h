 ...
 * @note
  ...
  @endverbatim
  */
    unsigned int sm3_dma_final(SM3_DMA_CTX* ctx, unsigned int* remainder_msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sm3_dma(unsigned int* msg, unsigned int msg_bytes, unsigned int* digest,
 ...
 */
    ...
    unsigned int sm3_dma_node_steps(HASH_DMA_NODE* node, unsigned int node_num,
