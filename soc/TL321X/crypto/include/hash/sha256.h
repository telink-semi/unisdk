 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha256_dma_update_blocks(SHA256_DMA_CTX* ctx, unsigned int* msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha256_dma_final(SHA256_DMA_CTX* ctx, unsigned int* remainder_msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha256_dma(unsigned int* msg, unsigned int msg_bytes, unsigned int* digest,
...
*/
    ...
    unsigned int sha256_dma_node_steps(HASH_DMA_NODE* node, unsigned int node_num,
