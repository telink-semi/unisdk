...
extern "C"
{
     ...
     */
    unsigned int hmac_sha512_init(HMAC_SHA512_CTX* ctx, unsigned char* key,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha512_update(HMAC_SHA512_CTX* ctx, unsigned char* msg,
 ...
 *     -# 1. please make sure the mac buffer is sufficient
  @endverbatim
 */
    unsigned int hmac_sha512(unsigned char* key, unsigned short sp_key_idx, unsigned int key_bytes,
...
*/
    ...
    unsigned int hmac_sha512_node_steps(unsigned char* key, unsigned short sp_key_idx,
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_sha512_dma_init(HMAC_SHA512_DMA_CTX* ctx, unsigned char* key,
                                      unsigned short sp_key_idx, unsigned int key_bytes,
 ...
 * @param[in]   ctx               - HMAC_SHA512_DMA_CTX context pointer.
 * @param[in]   msg               - message.
 * @param[in]   msg_words         - word length of the input message, must be a multiple of block
 word length
 *                                  of SHA512(128).
 * @return      0:success     other:error
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha512_dma_update_blocks(HMAC_SHA512_DMA_CTX* ctx, unsigned int* msg,
                                               unsigned int msg_bytes);
    /**
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha512_dma_final(HMAC_SHA512_DMA_CTX* ctx, unsigned int* remainder_msg,
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_sha512_dma(unsigned char* key, unsigned short sp_key_idx,
...
*/
    ...
    unsigned int hmac_sha512_dma_node_steps(unsigned char* key, unsigned short sp_key_idx,
