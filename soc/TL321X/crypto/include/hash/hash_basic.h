...
#define rHASH_CTRL                                                                                 \
    (*((volatile unsigned int*) (HASH_BASE_ADDR))) /* Offset: 0x000 (W1S)  Control register */
#define rHASH_CFG                                                                                  \
    (*((volatile unsigned int*) (HASH_BASE_ADDR +                                                  \
                                 0x004))) /* Offset: 0x004 (R/W)  Config register */
#define rHASH_SR1                                                                                  \
    (*((volatile unsigned int*) (HASH_BASE_ADDR +                                                  \
                                 0x008))) /* Offset: 0x008 (R)    Status register 1 */
#define rHASH_SR2                                                                                  \
    (*((volatile unsigned int*) (HASH_BASE_ADDR +                                                  \
                                 0x00C))) /* Offset: 0x00C (W1C)  Status register 2 */
#define rHASH_PCR_LEN(i)                                                                           \
    (*((volatile unsigned int*) (HASH_BASE_ADDR + 0x020 +                                          \
                                 ((i) << 2)))) /* Offset: 0x020 (R/W)  message length register, 4  \
                                                  words */
#define rHASH_OUT(i)                                                                               \
    (*((volatile unsigned int*) (HASH_BASE_ADDR + 0x030 +                                          \
                                 ((i)                                                              \
                                  << 2)))) /* Offset: 0x030 (R)    Output register, 16 words */
#define rHASH_IN(i)                                                                                \
    (*((volatile unsigned int*) (HASH_BASE_ADDR + 0x070 +                                          \
                                 ((i) << 2)))) /* Offset: 0x070 (W)    Hash iterator Input         \
                                                  register, 16 words */
#define rHASH_VERSION                                                                              \
    (*((volatile unsigned int*) (HASH_BASE_ADDR +                                                  \
                                 0x0B0))) /* Offset: 0x0B0 (R)    Version register */
#define rHASH_M_DIN(i)                                                                             \
    (*((volatile unsigned int*) (HASH_BASE_ADDR + 0x100 +                                          \
                                 ((i) << 2)))) /* Offset: 0x100 (R/W)  Hash message Input          \
                                                  register, 32 words */
#define rHASH_DMA_SA                                                                               \
    (*((volatile unsigned int*) (HASH_BASE_ADDR +                                                  \
                                 0x180))) /* Offset: 0x180 (R/W)  DMA Source Address register */
#define rHASH_DMA_DA                                                                               \
    (*((volatile unsigned int*) (HASH_BASE_ADDR + 0x184))) /* Offset: 0x184 (R/W)  DMA Destination \
                                                              Address register */
#define rHASH_DMA_RLEN                                                                             \
    (*((volatile unsigned int*) (HASH_BASE_ADDR +                                                  \
                                 0x188))) /* Offset: 0x188 (R/W)  DMA Input Length register */
#define rHASH_DMA_WLEN                                                                             \
    (*((volatile unsigned int*) (HASH_BASE_ADDR +                                                  \
                                 0x18C))) /* Offset: 0x18C (R/W)  DMA Output Length register */
 ...
 */
    ...
    void hash_dma_operate(unsigned int in_h, unsigned int in_l, unsigned int out_h,
                          unsigned int out_l, unsigned int inByteLen, HASH_CALLBACK callback);
#else

    /**
 * @brief       input message.
 * @param[in]   in             - message of some blocks, or message including the last byte(last
 block).
 ...
 * @note
  @verbatim
      -# 1. for DMA operation, the unit of input and output is 4 words, so, please make sure the
 buffer out is sufficient.
      -# 2. if just to input message, not to get digest or hmac, please set para out to be NULL and
 WLEN to be 0. if to get the digest or hmac, para out can not be NULL, and please set WLEN to be
 digest length.
  @endverbatim
 */
    void hash_dma_operate(unsigned int* in, unsigned int* out, unsigned int inByteLen,
