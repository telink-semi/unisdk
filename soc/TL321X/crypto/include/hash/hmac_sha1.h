...
extern "C"
{
     ...
     */
    unsigned int hmac_sha1_init(HMAC_SHA1_CTX* ctx, unsigned char* key, unsigned short sp_key_idx,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha1(unsigned char* key, unsigned short sp_key_idx, unsigned int key_bytes,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha1_node_steps(unsigned char* key, unsigned short sp_key_idx,
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_sha1_dma_init(HMAC_SHA1_DMA_CTX* ctx, unsigned char* key,
...
* @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha1_dma_update_blocks(HMAC_SHA1_DMA_CTX* ctx, unsigned int* msg,
...
* @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha1_dma_final(HMAC_SHA1_DMA_CTX* ctx, unsigned int* remainder_msg,
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_sha1_dma(unsigned char* key, unsigned short sp_key_idx,
 ...
 * @note
 ...
 block length.
  @endverbatim
 */
    unsigned int hmac_sha1_dma_node_steps(unsigned char* key, unsigned short sp_key_idx,
