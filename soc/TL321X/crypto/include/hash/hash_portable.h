...
extern "C"
{
     ...
     */
    enum tlk_dma_chn hash_get_tx_dma_channel(void);

    /**
     * @brief       get hash rx dma channel.
     * @return      hash rx dma channel
     */
    enum tlk_dma_chn hash_get_rx_dma_channel(void);
     ...
     * @return      none
     */
    void hash_set_tx_dma_channel(enum tlk_dma_chn chn);
     ...
     * @return      none
     */
    void hash_set_rx_dma_channel(enum tlk_dma_chn chn);
     ...
     * @note
     */
    void hash_tx_dma(enum tlk_dma_chn chn, unsigned int buf_addr, unsigned int len);
     ...
     * @note
     */
    void hash_rx_dma(enum tlk_dma_chn chn, unsigned int buf_addr, unsigned int len);
     ...
     * @return     none
     */
    void hash_set_tx_dma_config(enum tlk_dma_chn tx_chn);
     ...
     * @return     none
     */
    void hash_set_rx_dma_config(enum tlk_dma_chn rx_chn, enum tlk_dma_burst_size burst_size);
    ...
    /**
     * @brief     Resets HASH module,before using HASH, it is needed to call hash_reset() to avoid
     * affecting the use of HASH.
     * @return    none
     */
