...
extern "C"
{
     ...
     */
    unsigned int hmac_sha256_init(HMAC_SHA256_CTX* ctx, unsigned char* key,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha256_update(HMAC_SHA256_CTX* ctx, unsigned char* msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha256(unsigned char* key, unsigned short sp_key_idx, unsigned int key_bytes,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha256_node_steps(unsigned char* key, unsigned short sp_key_idx,
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_sha256_dma_init(HMAC_SHA256_DMA_CTX* ctx, unsigned char* key,
                                      unsigned short sp_key_idx, unsigned int key_bytes,
 ...
 * @param[in]   ctx                    - HMAC_CTX context pointer.
 * @param[in]   msg                    - message.
 * @param[in]   msg_bytes              - word length of the input message, must be a multiple of
 block word length
 *                                       of SHA256(16).
 * @return      0:success     other:error
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha256_dma_update_blocks(HMAC_SHA256_DMA_CTX* ctx, unsigned int* msg,
                                               unsigned int msg_bytes);
    /**
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int hmac_sha256_dma_final(HMAC_SHA256_DMA_CTX* ctx, unsigned int* remainder_msg,
     ...
     * @return      0:success     other:error
     */
    unsigned int hmac_sha256_dma(unsigned char* key, unsigned short sp_key_idx,
...
*/
    ...
    unsigned int hmac_sha256_dma_node_steps(unsigned char* key, unsigned short sp_key_idx,
