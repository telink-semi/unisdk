 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha512_dma_update_blocks(SHA512_DMA_CTX* ctx, unsigned int* msg,
 ...
 * @note
  ...
  @endverbatim
  */
    unsigned int sha512_dma_final(SHA512_DMA_CTX* ctx, unsigned int* remainder_msg,
 ...
 * @note
  ...
  @endverbatim
 */
    unsigned int sha512_dma(unsigned int* msg, unsigned int msg_bytes, unsigned int* digest,
 ...
 *     -# 3. for every node or segment except the last, its message length must be a multiple of
 block length.
  @endverbatim
 */
    unsigned int sha512_dma_node_steps(HASH_DMA_NODE* node, unsigned int node_num,
