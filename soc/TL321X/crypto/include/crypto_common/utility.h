 ...
 * @note
   ...
   @endverbatim
 */
    void uint8_XOR(const unsigned char* A, const unsigned char* B, unsigned char* C,
 ...
 * @note
   ...
   @endverbatim
 */
    void uint32_XOR(const unsigned int* A, const unsigned int* B, unsigned int* C,
 ...
 * @note
   ...
   @endverbatim
 */
    unsigned int uint8_big_num_big_endian_add_little(unsigned char* a, unsigned int a_bytes,
                                                     unsigned char b, unsigned char is_secure);
 ...
 * @note
   ...
   @endverbatim
 */
    unsigned int uint32_big_num_little_endian_add_little(unsigned int* a, unsigned int a_words,
                                                         unsigned int b, unsigned char is_secure);
 ...
 * @note
   ...
   @endverbatim
 */
    int32_t uint32_BigNumCmp(const unsigned int* a, unsigned int aWordLen, const unsigned int* b,
                             unsigned int bWordLen);
 ...
 * @note
   ...
   @endverbatim
 */
    unsigned int Bigint_Check_p_1(const unsigned int* a, const unsigned int* p,
                                  unsigned int wordLen);
     ...
     */
    unsigned int uint32_integer_check(const unsigned int* k, const unsigned int* n,
                                      unsigned int wordLen, unsigned int ret_zero,
                                      unsigned int ret_big, unsigned int ret_success);
