...
#include "pke.h"
     ...
     * @caution     a, n, and out have the same word length:((nBitLen+31)>>5); and e word length is
     * (eBitLen+31)>>5
     */
     ...
     * @return      RSA_SUCCESS(success), other(error).
     * @caution     a and out have the same word length:((nBitLen+31)>>5); and p,p_h,q,q_h,dp,dq,u
