...
enum
{
    FLD_MSPI_XIP_PAGE_MODE_EN    = TLK_BIT(0),
    FLD_MSPI_XIP_TIMEOUT_MODE_EN = TLK_BIT(1),
    FLD_MSPI_XIP_STOP            = TLK_BIT(2),
    FLD_MSPI_XIP_ENABLE          = TLK_BIT(3),
    FLD_MSPI_DUMMY_CNT_ADD       = TLK_BIT(4),
};
...
enum
{
    FLD_MSPI_XIP_WR_TRANS_MODE = TLK_BIT_RNG(0, 3),
    FLD_MSPI_XIP_RD_TRANS_MODE = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_MSPI_XIP_SET_L = TLK_BIT_RNG(0, 2),
};
...
enum
{
    FLD_MSPI_XIP_SET_H = TLK_BIT_RNG(0, 6),
};
...
enum
{
    ...
    FLD_MSPI_TXFIFO_CLR_LEVEL = TLK_BIT(4),
    FLD_MSPI_RXFIFO_CLR_LEVEL = TLK_BIT(5),
