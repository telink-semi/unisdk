...
enum
{
    FLD_AUDIO_I2S_CLK_EN   = TLK_BIT(0),        // reg_i2s_en(0) and reg_i2s_en(1)
    FLD_AUDIO_I2S_CLK_DIV2 = TLK_BIT(1),        // reg_i2s_en(0) and reg_i2s_en(1)
    FLD_AUDIO_I2S0_MODE    = TLK_BIT_RNG(2, 3), // only reg_i2s_en(0)
    FLD_AUDIO_I2S1_MODE    = TLK_BIT_RNG(4, 5), // only reg_i2s_en(0)
};

enum
{
    FLD_AUDIO_I2S1_CLK_EN   = TLK_BIT(0),
    FLD_AUDIO_I2S1_CLK_DIV2 = TLK_BIT(1),
};
...
enum
{
    FLD_AUDIO_I2S_FORMAT     = TLK_BIT_RNG(0, 1),
    FLD_AUDIO_I2S_WL         = TLK_BIT_RNG(2, 3),
    FLD_AUDIO_I2S_LRP        = TLK_BIT(4),
    FLD_AUDIO_I2S_LRSWAP     = TLK_BIT(5),
    FLD_AUDIO_I2S_ADC_DCI_MS = TLK_BIT(6),
    FLD_AUDIO_I2S_DAC_DCI_MS = TLK_BIT(7),
};
...
enum
{
    FLD_AUDIO_I2S0_BCM_BITS = TLK_BIT_RNG(0, 1),
    FLD_AUDIO_I2S0_BCK_INV  = TLK_BIT(2),
    FLD_AUDIO_FIFO0_RST     = TLK_BIT(3),
    FLD_AUDIO_FIFO1_RST     = TLK_BIT(4),
};
...
enum
{
    FLD_AUDIO_I2S1_BCM_BITS = TLK_BIT_RNG(0, 1),
    FLD_AUDIO_I2S1_BCK_INV  = TLK_BIT(2),
};
...
enum
{
    FLD_AUDIO_CODEC_I2S0_SEL   = TLK_BIT(2),
    FLD_AUDIO_I2S0_OUT_BIT_SEL = TLK_BIT(3), // for debug
};
...
enum
{
    FLD_AUDIO_I2S_SYNC_MODE    = TLK_BIT_RNG(0, 1),
    FLD_AUDIO_I2S1_OUT_BIT_SEL = TLK_BIT(3), // for debug
};
...
enum
{
    FLD_AUDIO_I2S_AIN0_COME = TLK_BIT_RNG(0, 1),
    FLD_AUDIO_I2S_AIN1_COME = TLK_BIT_RNG(2, 3),
    FLD_AUDIO_I2S_AOUT_COME = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_AUDIO_DEC0_AINL_COME = TLK_BIT_RNG(0, 1),
    FLD_AUDIO_DEC0_AINR_COME = TLK_BIT_RNG(2, 3),
    FLD_AUDIO_INT_AOUT_COME  = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_AUDIO_DEC1_AINL_COME = TLK_BIT_RNG(0, 2),
    FLD_AUDIO_DEC1_AINR_COME = TLK_BIT_RNG(4, 6),
};
...
enum
{
    FLD_AUDIO_AIN0_SEL  = TLK_BIT_RNG(0, 2),
    FLD_AUDIO_AOUT0_SEL = TLK_BIT_RNG(3, 4),
};
...
enum
{
    FLD_AUDIO_AIN1_SEL  = TLK_BIT_RNG(0, 2),
    FLD_AUDIO_AOUT1_SEL = TLK_BIT_RNG(3, 4),
};
...
enum
{
    FLD_AUDIO_AIN_SEL  = TLK_BIT_RNG(0, 2),
    FLD_AUDIO_AOUT_SEL = TLK_BIT_RNG(3, 4),
};
...
enum
{
    FLD_AUDIO_FIFO_AOUT_TRIG_NUM = TLK_BIT_RNG(0, 3),
    FLD_AUDIO_FIFO_AIN_TRIG_NUM  = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_AUDIO_TX_WPTR_PTR_EN = TLK_BIT(0),
    FLD_AUDIO_TX_RPTR_PTR_EN = TLK_BIT(1),
    FLD_AUDIO_RX_WPTR_PTR_EN = TLK_BIT(2),
    FLD_AUDIO_RX_RPTR_PTR_EN = TLK_BIT(3),
...
enum
{
    FLD_AUDIO_RX_FIFO0 = TLK_BIT(0),
    FLD_AUDIO_TX_FIFO0 = TLK_BIT(1),
    FLD_AUDIO_RX_FIFO1 = TLK_BIT(2),
    FLD_AUDIO_TX_FIFO1 = TLK_BIT(3),
};
...
enum
{
    FLD_USB_RD_MODE      = TLK_BIT(0),
    FLD_CODEC_ALIGN_MASK = TLK_BIT(1),
    FLD_I2S_ALIGN_MASK   = TLK_BIT(2),
};
...
enum
{
    FLD_CODEC_ALIGN_EN    = TLK_BIT(0),
    FLD_I2S_ALIGN_EN      = TLK_BIT(1),
    FLD_I2S_ALIGN_CLK_SEL = TLK_BIT(2),
    FLD_I2S_CLK_SEL       = TLK_BIT(3),
    FLD_I2S_ALIGN_CTRL    = TLK_BIT_RNG(4, 5),
    FLD_CODEC_ALIGN_CTRL  = TLK_BIT_RNG(6, 7),
};
...
enum
{
    FLD_AUDIO_CODEC_DEC0_SWAP = TLK_BIT(4),
    FLD_AUDIO_CODEC_INT_SWAP  = TLK_BIT(5),
};
...
enum
{
    FLD_AUDIO_CODEC_INT_MUTE_L = TLK_BIT(0),
    FLD_AUDIO_CODEC_INT_MUTE_R = TLK_BIT(1),
    FLD_AUDIO_CODEC_SDTG_L     = TLK_BIT_RNG(2, 4),
    FLD_AUDIO_CODEC_SDTG_R     = TLK_BIT_RNG(5, 7),
};
...
enum
{
    FLD_AUDIO_CODEC_INT_VOL_R_L = TLK_BIT_RNG(0, 3),
    FLD_AUDIO_CODEC_ALC_K1      = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_AUDIO_CODEC_INT_VOL_R_H = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_AUDIO_CODEC_INT_VOL_L_L = TLK_BIT_RNG(0, 3),
    FLD_AUDIO_CODEC_ALC_K2      = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_AUDIO_CODEC_INT_VOL_L_H = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_AUDIO_CODEC_CLK_USB     = TLK_BIT(0),
    FLD_AUDIO_CODEC_DEC0_CLK_SR = TLK_BIT_RNG(1, 5),
    FLD_AUDIO_CODEC_CLK_DIV2    = TLK_BIT(6),
    FLD_AUDIO_CODEC_CLK0_EN     = TLK_BIT(7),
};
...
enum
{
    FLD_AUDIO_CODEC_DEC0_EN    = TLK_BIT(0),
    FLD_AUDIO_CODEC_INT_EN     = TLK_BIT(1),
    FLD_AUDIO_CODEC_INT_CLK_SR = TLK_BIT_RNG(3, 7),
};
...
enum
{
    FLD_AUDIO_PGA_GAIN_R_L = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_AUDIO_PGA_GAIN_R_H = TLK_BIT_RNG(0, 2),
    FLD_AUDIO_PGA_MUTE_R   = TLK_BIT(3),
};
...
enum
{
    FLD_AUDIO_PGA_GAIN_L_L = TLK_BIT_RNG(0, 7),
};
...
enum
{
    FLD_AUDIO_PGA_GAIN_L_H  = TLK_BIT_RNG(0, 2),
    FLD_AUDIO_PGA_MUTE_L    = TLK_BIT(3),
    FLD_AUDIO_DSM_GCOEF_SEL = TLK_BIT(4),
    FLD_AUDIO_DSM_OPT_SEL   = TLK_BIT(5),
    FLD_AUDIO_CIC_COMP_EN   = TLK_BIT(6),
};
...
enum
{
    FLD_AUDIO_CODEC_DAC_L_INV = TLK_BIT(0),
    FLD_AUDIO_CODEC_DAC_R_INV = TLK_BIT(1),
    FLD_AUDIO_CODEC_INT_GAIN  = TLK_BIT(2),        // dac 1:+6dB
    FLD_AUDIO_CODEC_DEC_GAIN  = TLK_BIT_RNG(4, 5), // 1:+6dB,2:+12dB,3:+18dB only dec0
    FLD_AUDIO_CODEC_DIGMIX    = TLK_BIT(7),
...
enum
{
    FLD_AUDIO_PGA_VOL_IN_L = TLK_BIT_RNG(0, 3),
};
...
enum
{
    FLD_AUDIO_PD_PGABUF   = TLK_BIT(2),
    FLD_AUDIO_PD_PGABOOST = TLK_BIT(3),
    FLD_AUDIO_PD_INPPGA   = TLK_BIT(4),
};
...
enum
{
    FLD_AUDIO_PD_PA_L    = TLK_BIT(0),
    FLD_AUDIO_PD_PA_R    = TLK_BIT(1),
    FLD_AUDIO_PD_DAC_L   = TLK_BIT(2),
    FLD_AUDIO_PD_DAC_R   = TLK_BIT(3),
    FLD_AUDIO_PD_SCF_CTL = TLK_BIT_RNG(4, 5),
};
...
enum
{
    FLD_AUDIO_HP_VREF_BUF = TLK_BIT(0),
    FLD_AUDIO_INT_VREF    = TLK_BIT(1),
    FLD_AUDIO_LP_VREF_BUF = TLK_BIT(2),
    FLD_AUDIO_LP_L_DAC    = TLK_BIT(3),
    FLD_AUDIO_LP_R_DAC    = TLK_BIT(4),
    FLD_AUDIO_LP_L_DRV    = TLK_BIT(5),
    FLD_AUDIO_LP_R_DRV    = TLK_BIT(6),
};

/**
 * BIT[0] L_FRC_ON_DRVL   Force turn on left  DRV control signal. 1'b1, force on DRV enable; 1'b0,
 * disable force on function. BIT[1] L_FRC_ON_DRVR   Force turn on right DRV control signal. 1'b1,
 * force on DRV enable; 1'b0, disable force on function.  " BIT[2] L_HP_ctrl_drvL  1'b1:enable
 * high-performance left  driver. BIT[3] L_HP_ctrl_drvR  1'b1:enable high-performance right driver.
 */
#define reg_codec_ana_reg7 REG_ADDR8(REG_AUDIO_CODEC_BASE + 0x17)

enum
{
    FLD_AUDIO_FRC_ON_DRVL   = TLK_BIT(0),
    FLD_AUDIO_FRC_ON_DRVR   = TLK_BIT(1),
    FLD_AUDIO_HP_CTRL_DRV_L = TLK_BIT(2),
    FLD_AUDIO_HP_CTRL_DRV_R = TLK_BIT(3),
};
...
enum
{
    FLD_AUDIO_PGA_VOL_IN_R = TLK_BIT_RNG(0, 3),
};

/**
 * BIT[2]   Enabling FLD_AUDIO_CODEC_R_NEG bit is valid for both stream0 and stream1.
 * If this bit is 0 and the DMIC sampling rate is 44.1k and 48k,the left and right channel data will
 * be exchanged.
 **/
...
enum
{
    FLD_AUDIO_CODEC_DEC0_CH0_EN = TLK_BIT(0),
    FLD_AUDIO_CODEC_DEC0_CH1_EN = TLK_BIT(1),
    FLD_AUDIO_CODEC_R_NEG       = TLK_BIT(2),
    FLD_AUDIO_CODEC_MIC_SEL     = TLK_BIT(3),
};
...
enum
{
    FLD_AUDIO_CODEC_CLK_1M_EN         = TLK_BIT(0),
    FLD_AUDIO_CODEC_CLK_1M_SEL        = TLK_BIT(1), // 1:6M  0:1M
    FLD_AUDIO_CODEC_DEC_SFT_CTRL      = TLK_BIT_RNG(2, 3),
    FLD_AUDIO_CODEC_SOFTMUTE_MODE_SEL = TLK_BIT(4),
    FLD_AUDIO_CODEC_ANA_PA_CLK_6M_EN  = TLK_BIT(5),
    FLD_AUDIO_CODEC_DMIC_CLK_MODE     = TLK_BIT(6),
};
...
enum
{
    FLD_AUDIO_CODEC_DEC1_EN     = TLK_BIT(0),
    FLD_AUDIO_CODEC_CLK1_EN     = TLK_BIT(1),
    FLD_AUDIO_CODEC_DEC1_CH0_EN = TLK_BIT(2),
    FLD_AUDIO_CODEC_DEC1_CH1_EN = TLK_BIT(3),
    FLD_AUDIO_CODEC_DEC1_SWAP   = TLK_BIT(4),
};
...
enum
{
    FLD_AUDIO_CODEC_DEC1_CLK_SR = TLK_BIT_RNG(0, 4),
};
