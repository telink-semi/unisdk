...
#define reg_rf_bb_rx_size   REG_ADDR16(CHNADDR + 0xf6)
#define reg_rf_bb_rx_size_l REG_ADDR8(CHNADDR + 0xf6)
...
enum
{
    ...
    FLD_RF_RESERVED0     = TLK_BIT_RNG(1, 2),
    FLD_RF_V_PN_EN       = TLK_BIT(3),
    FLD_RF_R_CUSTOM_MADE = TLK_BIT(4),
    FLD_RF_RESERVED1     = TLK_BIT(5),
...
enum
{
    FLD_RF_HEAD_MODE = TLK_BIT_RNG(0, 1),
    FLD_RF_CRC_MODE  = TLK_BIT_RNG(2, 3),
...
enum
{
    FLD_RF_PN_INIT = TLK_BIT_RNG(0, 5),
};
...
#define reg_rf_32_access_5            REG_ADDR32(REG_BASEBAND_BASE_ADDR + 0x10)
...
#define reg_rf_access_code_base_pipe1 0x170010
...
enum
{
    ...
    FLD_RF_SEL_MAN        = TLK_BIT_RNG(4, 7),
};
...
enum
{
    ...
    FLD_RF_ANT_NUM      = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_RF_ANT_LUT0 = TLK_BIT_RNG(0, 3),
    FLD_RF_ANT_LUT1 = TLK_BIT_RNG(4, 7),
};
...
#define reg_rf_16_ll_cmd REG_ADDR16(REG_BB_LL_BASE_ADDR)
...
#define reg_rf_16_ll_rxstl_l REG_ADDR16(REG_BB_LL_BASE_ADDR + 0x0c)
...
#define reg_rf_16_ll_ard_l REG_ADDR16(REG_BB_LL_BASE_ADDR + 0x10)
...
enum
{
    FLD_RF_R_TX_COMMITTED = TLK_BIT_RNG(0, 5),
};
...
typedef enum
{
    FLD_RF_IRQ_RX            = TLK_BIT(0),
    FLD_RF_IRQ_TX            = TLK_BIT(1),
    FLD_RF_IRQ_RX_TIMEOUT    = TLK_BIT(2),
    FLD_RF_IRQ_RX_FIFO_FULL  = TLK_BIT(3),
    FLD_RF_IRQ_RX_CRC_2      = TLK_BIT(4),
    FLD_RF_IRQ_CMD_DONE      = TLK_BIT(5),
    FLD_RF_IRQ_FSM_TIMEOUT   = TLK_BIT(6),
    FLD_RF_IRQ_TX_RETRYCNT   = TLK_BIT(7),
    FLD_RF_IRQ_TX_DS         = TLK_BIT(8),
    FLD_RF_IRQ_RX_DR         = TLK_BIT(9),
    FLD_RF_IRQ_FIRST_TIMEOUT = TLK_BIT(10),
    FLD_RF_IRQ_INVALID_PID   = TLK_BIT(11),
    FLD_RF_IRQ_STX_TIMEOUT   = TLK_BIT(12),
    FLD_RF_IRQ_WIFI_DENY     = TLK_BIT(13),
    FLD_RF_IRQ_SUPP_OF       = TLK_BIT(14),
...
enum
{
    ...
    FLD_RF_BT_BLE_SEL_AUTO  = TLK_BIT(1),
    FLD_RF_BT_BLE_SEL_EN_RX = TLK_BIT(2),
    FLD_RF_CONT_MODE        = TLK_BIT(3),
    FLD_RF_NTL_CV           = TLK_BIT(4),
...
// REG_TL_MODEM_BASE_ADDR
#define reg_rf_lr_access_trig      REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x25)
#define reg_rf_modem_debug_txrx1_0 REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x2a)
#define reg_rf_zb_pdet_cfg_0       REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x2c)

#define reg_rf_rssi_start_0       REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x30)
#define reg_rf_rssi_start_1       REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x31)
#define reg_rf_rssi_stop_0        REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x32)
#define reg_rf_rssi_stop_1        REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x33)
#define reg_rf_rssi_filt          REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x34)
#define reg_rf_lr_freq_corr_cfg_0 REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x36)
#define reg_rf_lr_freq_corr_cfg_1 REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x37)
#define reg_rf_lr_tim_rec_cfg_0   REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x38)
#define reg_rf_lr_tim_rec_cfg_1   REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x39)
#define reg_rf_zb_freq_corr_cfg_0 REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x3a)
#define reg_rf_zb_freq_corr_cfg_1 REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x3b)
#define reg_rf_zb_thr_cfg_0       REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x3c)
#define reg_rf_zb_thr_cfg_1       REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x3d)
#define reg_rf_mode_cfg_rx2_0     REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x3e)
#define reg_rf_mode_cfg_rx2_1     REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x3f)

#define reg_rf_tim_rec_cfg_1    REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0x73)
...
#define reg_rf_rx_ctrl1 REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0xbb)

#define reg_rf_grx_0   REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0xc2)
#define reg_rf_grx_1   REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0xc3)
#define reg_rf_grx_2   REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0xc4)
#define reg_rf_grx_3   REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0xc5)
#define reg_rf_grx_4   REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0xc6)
#define reg_rf_grx_5   REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0xc7)
#define reg_rf_grx_fix REG_ADDR8(REG_TL_MODEM_BASE_ADDR + 0xc8)
...
#define reg_rf_agc_thrshld2_1m_0 REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0x4c)
#define reg_rf_agc_thrshld2_1m_1 REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0x4d)
...
#define reg_rf_adc_rbk_i_0 REG_ADDR32(REG_TL_RADIO_BASE_ADDR + 0x6c) //!!
...
#define reg_rf_8_dcoc_bypass_adc_0  REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0xce)
#define reg_rf_16_dcoc_bypass_adc_0 REG_ADDR16(REG_TL_RADIO_BASE_ADDR + 0xce)

#define reg_rf_8_dcoc_bypass_dac_0  REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0xd0)
#define reg_rf_16_dcoc_bypass_dac_0 REG_ADDR16(REG_TL_RADIO_BASE_ADDR + 0xd0)
...
#define reg_rf_8_hpmc_debug_0  REG_ADDR8(REG_TL_RADIO_BASE_ADDR + 0xf6)
#define reg_rf_16_hpmc_debug_0 REG_ADDR16(REG_TL_RADIO_BASE_ADDR + 0xf6)
#define reg_rf_hpmc_rdbk4_0    REG_ADDR16(REG_TL_RADIO_BASE_ADDR + 0xfe) //!!
