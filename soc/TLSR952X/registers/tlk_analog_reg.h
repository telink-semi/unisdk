...
enum
{
    //FLD_ANA_TX_EN         = TLK_BIT(0),
    FLD_ANA_RX_EN         = TLK_BIT(1),
    FLD_ANA_MASKX_TX_DONE = TLK_BIT(2),
    FLD_ANA_MASKX_RX_DONE = TLK_BIT(3),
    FLD_ANA_CONTIU_ACC    = TLK_BIT(4),
    FLD_ANA_RW            = TLK_BIT(5), /**< 1:write,0:read */
    FLD_ANA_CYC           = TLK_BIT(6),
    FLD_ANA_BUSY          = TLK_BIT(7),
};
...
enum
{
    FLD_ANA_RX_BUFCNT = TLK_BIT_RNG(0, 3),
    FLD_ANA_TX_BUFCNT = TLK_BIT_RNG(4, 7),
};
...
enum
{
    FLD_ANA_TXBUFF_IRQ = TLK_BIT(0),
    FLD_ANA_RXBUFF_IRQ = TLK_BIT(1),
};
...
enum
{
    FLD_ANA_CYC1           = TLK_BIT(0),
    FLD_ANA_DMA_EN         = TLK_BIT(1),
    FLD_ANA_AUTO_RXCLR_EN  = TLK_BIT(2),
    FLD_ANA_NDMA_RXDONE_EN = TLK_BIT(3),
