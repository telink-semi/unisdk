...
typedef struct __attribute__((packed)) {
    ...
    union {
        ...
        uint8_t txfifo_status; // address: 0xa3ffff24, offset: 0x24
    };
    union {
        struct {
        ...
        uint8_t rxfifo_status; // address: 0xa3ffff25, offset: 0x25
    };
    ...
    union {
        ...
        uint8_t xip_rd_fmt; // address: 0xa3ffff90, offset: 0x90
    };
    union {
        struct {
    ...
    union {
        ...
        uint8_t xip_wr_fmt; // address: 0xa3ffff94, offset: 0x94
    };
    union {
        struct {
            unsigned reserved : 4;
