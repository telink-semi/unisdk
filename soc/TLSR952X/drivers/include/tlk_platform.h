...
void tlk_platform_init(enum tlk_power_mode power_mode, enum tlk_power_vbat vbat_v, enum tlk_power_gpio_voltage gpio_v, enum tlk_power_cap cap, unsigned char flash_protect_en);
        ...
        #define TLK_PLATFORM_INIT tlk_platform_init(TLK_POWER_DCDC_DCDC_MODE, TLK_POWER_VBAT_MAX_VALUE_GREATER_THAN_3V6, TLK_POWER_GPIO_VOLTAGE_3V3, TLK_POWER_INTERNAL_CAP_XTAL24M, 1)
    #endif
