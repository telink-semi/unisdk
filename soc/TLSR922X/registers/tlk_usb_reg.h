...
enum
{
    ...
    FLD_CTRL_EP_IRQ_TRANS = TLK_BIT_RNG(4, 7),
...
enum
{
    ...
    FLD_USB_MDEV_SUSP_STA = TLK_BIT(1),
...
enum
{
    ...
    FLD_USB_IRQ_RESET_LVL    = TLK_BIT(3),
    FLD_USB_IRQ_250US_LVL    = TLK_BIT(4),
};
