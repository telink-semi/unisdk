...
enum
{
    FLD_QDEC_DBNTIME  = TLK_BIT_RNG(0, 2),
    FLD_QDEC_POLA     = TLK_BIT(4),
    FLS_QDEC_SHUTTLE0 = TLK_BIT(5),
};
...
enum
{
    FLD_QDEC_CHANNEL_A = TLK_BIT_RNG(0, 2),
};
...
enum
{
    FLD_QDEC_CHANNEL_B = TLK_BIT_RNG(0, 2),
};
...
enum
{
    FLD_QDEC_COUNT0_RELOAD = TLK_BIT(0),
};
