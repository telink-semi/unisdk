 ...
 * TLK_BIT(0):pwm0 out low level first. ~TLK_BIT(0):pwm0 out high level first.
 * TLK_BIT(1):pwm1 out low level first. ~TLK_BIT(1):pwm1 out high level first.
 * TLK_BIT(2):pwm2 out low level first. ~TLK_BIT(2):pwm2 out high level first.
 * TLK_BIT(3):pwm3 out low level first. ~TLK_BIT(3):pwm3 out high level first.
 ...
 *         The user can know whether this interrupt is generated by reading the status of this register.If TLK_BIT(8):1 Indicates that this interrupt has been generated.
 */
