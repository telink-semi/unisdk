...
enum
{
    FLD_AES_START = TLK_BIT(0),
    FLD_AES_MODE  = TLK_BIT(1), /**< 0-cipher  1-decipher */
};
...
enum
{
    FLD_AES_PTR         = TLK_BIT_RNG(0, 15),
    FLD_E0_ADDR_POINTER = TLK_BIT_RNG(16, 31),
};
...
enum
{
    FLD_AES_PRAND       = TLK_BIT_RNG(0, 23),
    FLD_AES_IRK_NUM     = TLK_BIT_RNG(24, 27),
    FLD_AES_GEN_RES     = TLK_BIT(29), /**< W1C */
    FLD_AES_RPASE_START = TLK_BIT(30), /**< 0-idle 1-running 2-finished */
    FLD_AES_RPASE_EN    = TLK_BIT(31), /**< 0-unmatched 1-matched */
};
...
enum
{
    FLD_AES_HASH_STA      = TLK_BIT_RNG(0, 23),
    FLD_AES_IRK_CNT       = TLK_BIT_RNG(24, 27),
    FLD_AES_RPASE_STA_CLR = TLK_BIT(28),         /**< W1C */
    FLD_AES_RPASE_STA     = TLK_BIT_RNG(29, 30), /**< 0-idle 1-running 2-finished */
    FLD_AES_HASH_MATCH    = TLK_BIT(31),         /**< 0-unmatched 1-matched */
};
