...
#define write_reg8(addr, v)                                                                        \
    (*(volatile unsigned char*) (UNISDK_CHIP_MEMORY_REG_STARTADDR | (addr)) = (unsigned char) (v))
#define write_reg16(addr, v)                                                                       \
    (*(volatile unsigned short*) (UNISDK_CHIP_MEMORY_REG_STARTADDR | (addr)) = (unsigned short) (v))
#define write_reg32(addr, v)                                                                       \
    (*(volatile unsigned long*) (UNISDK_CHIP_MEMORY_REG_STARTADDR | (addr)) = (unsigned long) (v))
