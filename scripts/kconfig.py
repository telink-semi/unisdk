...
def main():
    ...
    if args.telink_base:
        os.environ['TELINK_BASE'] = args.telink_base
    ...
    # Load files if any configs_in are provided
    if args.configs_in:
    ...
    # Write the C header if header_out is provided
    if args.header_out:
        print(kconf.write_autoconf(args.header_out))
    
    # Write the list of parsed Kconfig files if kconfig_list_out is provided
    if args.kconfig_list_out:
...
def parse_args():
    ...
    parser.add_argument("--forced-input-configs",
                        ...
                        help="Indicate the input configuration files are "
                             ...
                             " adjustments.")
    parser.add_argument("--telink-base",
                        help="Path to current Telink installation")
    ...
    parser.add_argument("--header-out",
                        dest="header_out",
                        default=None,
                        help="Output header file (optional)")
    parser.add_argument("--kconfig-list-out",
                        dest="kconfig_list_out",
                        default=None,
                        help="Output file for list of parsed Kconfig files (optional)")
