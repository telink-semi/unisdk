...
int main(void)
{
    ...
    PMPDriver pmp_entry0(TLK_PMP_ENTRY0, (void*) (demo_array + 8));
    pmp_entry0.entryDisable();

    PMPDriver pmp_entry1(TLK_PMP_ENTRY1, (void*) (demo_array + 16));
    pmp_entry1.torConfig(&pmp_config);
    ...
    PMPDriver pmp_entry0(TLK_PMP_ENTRY0, (void*) (demo_array + 8));
    pmp_entry0.napotConfig(8, &pmp_config);
#endif
