...
int main(void)
{
    ...
    tlk_pmp_entry_disable(TLK_PMP_ENTRY0, (void*) (demo_array + 8));
    tlk_pmp_tor_config(TLK_PMP_ENTRY1, (void*) (demo_array + 16), &pmp_config);
    ...
    tlk_pmp_napot_config(TLK_PMP_ENTRY0, (void*) (demo_array + 8), 8, &pmp_config);
#endif
