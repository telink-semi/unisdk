...
int main(void)
{
    ...
    tlk_pmp_napot_config(TLK_PMP_ENTRY7, 0x0, MEMORY_SIZE, &pmp_all_memory_config);
    ...
    tlk_pmp_napot_config(TLK_PMP_ENTRY0, UART_START_ADDRESS, UART_MEMORY_SIZE, &pmp_uart_config);
#endif
