...
#define PACKET_PDU_TYPE \
    IF_ENABLED_ELSE(CONFIG_TLK_RF_DEMO_MODE_BLE, (struct tlk_rf_ble_pdu), ( \
        IF_ENABLED_ELSE(CONFIG_TLK_RF_DEMO_MODE_ZIGBEE, (struct tlk_rf_zigbee_pdu), ( \
            IF_ENABLED_ELSE(CONFIG_TLK_RF_DEMO_MODE_PRIVATE, (struct tlk_rf_private_pdu), ( \
                IF_ENABLED(CONFIG_TLK_RF_DEMO_MODE_HYBEE, (struct tlk_rf_hybee_pdu))))))))

#define GET_PDU(packet) ((PACKET_PDU_TYPE *)((packet)->pdu))

#define PACKET_PAYLOAD_SIZE (TX_PAYLOAD_SIZE \
    IF_ENABLED(CONFIG_TLK_RF_DEMO_MODE_ZIGBEE, ( + TLK_RF_ZIGBEE_CRC_SIZE)) \
    IF_ENABLED(CONFIG_TLK_RF_DEMO_MODE_HYBEE, ( + TLK_RF_HYBEE_CRC_SIZE)))
