...
choice
    ...
    bool "64K"
    config TLK_PM_RETENTION_MEMORY_SIZE_128K
    bool "128K"
    config TLK_PM_RETENTION_MEMORY_SIZE_256K
    bool "256K"
...
config TLK_PM_RETENTION_MEMORY_SIZE
    ...
    default 128 if TLK_PM_RETENTION_MEMORY_SIZE_128K
    default 256 if TLK_PM_RETENTION_MEMORY_SIZE_256K
